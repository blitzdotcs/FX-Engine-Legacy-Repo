...
class PsychLua {
	...
	public function new(script:String) {
		...
		Lua_helper.add_callback(lua, "keyJustPressed", function(name:String) {
			var key:Bool = false;
			switch(name) {
				case 'left': key = lePlayState.get_controls('NOTE_LEFT_P');
				case 'down': key = lePlayState.get_controls('NOTE_DOWN_P');
				case 'up': key = lePlayState.get_controls('NOTE_UP_P');
				case 'right': key = lePlayState.get_controls('NOTE_RIGHT_P');
				case 'accept': key = lePlayState.get_controls('ACCEPT');
				case 'back': key = lePlayState.get_controls('BACK');
				case 'pause': key = lePlayState.get_controls('PAUSE');
				case 'reset': key = lePlayState.get_controls('RESET');
			}
			return key;
		});
		Lua_helper.add_callback(lua, "keyPressed", function(name:String) {
			var key:Bool = false;
			switch(name) {
				case 'left': key = lePlayState.get_controls('NOTE_LEFT');
				case 'down': key = lePlayState.get_controls('NOTE_DOWN');
				case 'up': key = lePlayState.get_controls('NOTE_UP');
				case 'right': key = lePlayState.get_controls('NOTE_RIGHT');
				case 'accept': key = lePlayState.get_controls('ACCEPT');
				case 'back': key = lePlayState.get_controls('BACK');
				case 'pause': key = lePlayState.get_controls('PAUSE');
				case 'reset': key = lePlayState.get_controls('RESET');
		...
		Lua_helper.add_callback(lua, "keyReleased", function(name:String) {
			var key:Bool = false;
			switch(name) {
				case 'left': key = lePlayState.get_controls('NOTE_LEFT_R');
				case 'down': key = lePlayState.get_controls('NOTE_DOWN_R');
				case 'up': key = lePlayState.get_controls('NOTE_UP_R');
				case 'right': key = lePlayState.get_controls('NOTE_RIGHT_R');
			}
			return key;
		});
