...
class HXCPP_CLASS_ATTRIBUTES TankmenBG_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		void __construct(Float x,Float y,bool isGoingRight);
		...
		static ::hx::ObjectPtr< TankmenBG_obj > __new(Float x,Float y,bool isGoingRight);
		static ::hx::ObjectPtr< TankmenBG_obj > __alloc(::hx::Ctx *_hx_ctx,Float x,Float y,bool isGoingRight);
		...
		Float tankSpeed;
		Float endingOffset;
		void resetShit(Float x,Float y,bool isGoingRight);
