...
class HXCPP_CLASS_ATTRIBUTES NoteSplash_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		void __construct(Float x,Float y,::hx::Null< int >  __o_noteData);
		...
		static ::hx::ObjectPtr< NoteSplash_obj > __new(Float x,Float y,::hx::Null< int >  __o_noteData);
		static ::hx::ObjectPtr< NoteSplash_obj > __alloc(::hx::Ctx *_hx_ctx,Float x,Float y,::hx::Null< int >  __o_noteData);
		...
		void setupNoteSplash(Float x,Float y,::hx::Null< int >  noteData);
