...
class HXCPP_CLASS_ATTRIBUTES Paths_obj : public ::hx::Object
{
	...
	public:
		...
		static ::String hx(::String key,::String library);
		static ::Dynamic hx_dyn();
		...
		static  ::flixel::graphics::frames::FlxAtlasFrames getAnimateAtlas(::String key);
		static ::Dynamic getAnimateAtlas_dyn();

		static  ::flixel::graphics::FlxGraphic loadImage(::String key);
