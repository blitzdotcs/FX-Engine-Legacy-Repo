...
HX_DECLARE_STACK_FRAME(_hx_pos_1cce971975218b09_42_new)
...
HXLINE(  48)		( ( ::Option)(__this) )->description = HX_("",00,00,00,00);
HXLINE(  46)		( ( ::Option)(__this) )->display = ( ( ::Option)(__this) )->updateDisplay();
            	}
