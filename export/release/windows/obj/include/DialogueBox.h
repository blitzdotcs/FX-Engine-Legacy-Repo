...
class HXCPP_CLASS_ATTRIBUTES DialogueBox_obj : public  ::flixel::group::FlxTypedSpriteGroup_obj
{
	...
	public:
		...
		Dynamic finishThing_dyn() { return finishThing;}
		 ...
		 ::flixel::FlxSprite gfportrait;
		 ::flixel::FlxSprite gf2Portrait;
		 ::flixel::FlxSprite bfportrait;
		 ::flixel::FlxSprite dadPortrait;
		 ::flixel::FlxSprite pumpPortrait;
		 ::flixel::FlxSprite skidPortrait;
		 ::flixel::FlxSprite picoPortrait;
		 ::flixel::FlxSprite pico2Portrait;
		 ::flixel::FlxSprite momPortrait;
		 ::flixel::FlxSprite parentsMomPortrait;
		 ::flixel::FlxSprite parentsDadPortrait;
		 ::flixel::FlxSprite parentsPortrait;
		 ::flixel::FlxSprite monsterPortrait;
