...
HX_DEFINE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_340_new,"SongMetadata","new",0x0585a376,"SongMetadata.new","FreeplayState.hx",340,0x0d86f62d)
...
HXLINE( 344)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 343)		this->week = 0;
HXLINE( 342)		this->songName = HX_("",00,00,00,00);
HXLINE( 348)		this->songName = song;
HXLINE( 349)		this->week = week;
HXLINE( 350)		this->songCharacter = songCharacter;
            	}
