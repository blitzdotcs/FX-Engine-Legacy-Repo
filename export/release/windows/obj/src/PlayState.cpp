...
HXLINE( 296)			::String library = null();
HXDLIN( 296)			this->dialogue = ::CoolUtil_obj::coolTextFile(::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + HX_("bopeebo/bopeebo-dialogue",14,91,4a,45)) + HX_(".txt",02,3f,c0,1e)),HX_("TEXT",ad,94,ba,37),library));
HXDLIN( 296)			goto _hx_goto_7;
            		}
            		if (  (_hx_switch_1==HX_("cocoa",09,9d,55,4a)) ){
HXLINE( 318)			::String library = null();
HXDLIN( 318)			this->dialogue = ::CoolUtil_obj::coolTextFile(::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + HX_("cocoa/cocoa-dialogue",a2,65,97,ee)) + HX_(".txt",02,3f,c0,1e)),HX_("TEXT",ad,94,ba,37),library));
HXDLIN( 318)			goto _hx_goto_7;
            		}
            		if (  (_hx_switch_1==HX_("dadbattle",bf,6a,a9,a6)) ){
HXLINE( 300)			::String library = null();
HXDLIN( 300)			this->dialogue = ::CoolUtil_obj::coolTextFile(::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + HX_("dadbattle/dadbattle-dialogue",36,c8,0a,8b)) + HX_(".txt",02,3f,c0,1e)),HX_("TEXT",ad,94,ba,37),library));
HXDLIN( 300)			goto _hx_goto_7;
            		}
            		if (  (_hx_switch_1==HX_("eggnog",61,04,ba,f4)) ){
HXLINE( 320)			::String library = null();
HXDLIN( 320)			this->dialogue = ::CoolUtil_obj::coolTextFile(::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + HX_("eggnog/eggnog-dialogue",d6,ac,5c,ee)) + HX_(".txt",02,3f,c0,1e)),HX_("TEXT",ad,94,ba,37),library));
HXDLIN( 320)			goto _hx_goto_7;
            		}
            		if (  (_hx_switch_1==HX_("fresh",6e,86,86,06)) ){
HXLINE( 298)			::String library = null();
HXDLIN( 298)			this->dialogue = ::CoolUtil_obj::coolTextFile(::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + HX_("fresh/fresh-dialogue",d8,17,20,b6)) + HX_(".txt",02,3f,c0,1e)),HX_("TEXT",ad,94,ba,37),library));
HXDLIN( 298)			goto _hx_goto_7;
            		}
            		if (  (_hx_switch_1==HX_("high",62,37,0e,45)) ){
HXLINE( 314)			::String library = null();
HXDLIN( 314)			this->dialogue = ::CoolUtil_obj::coolTextFile(::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + HX_("high/high-dialogue",f6,5b,7e,98)) + HX_(".txt",02,3f,c0,1e)),HX_("TEXT",ad,94,ba,37),library));
HXDLIN( 314)			goto _hx_goto_7;
            		}
            		if (  (_hx_switch_1==HX_("milf",d6,4c,5c,48)) ){
HXLINE( 316)			::String library = null();
HXDLIN( 316)			this->dialogue = ::CoolUtil_obj::coolTextFile(::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + HX_("milf/milf-dialogue",76,30,f1,0e)) + HX_(".txt",02,3f,c0,1e)),HX_("TEXT",ad,94,ba,37),library));
HXDLIN( 316)			goto _hx_goto_7;
            		}
            		if (  (_hx_switch_1==HX_("philly",28,77,5e,ef)) ){
HXLINE( 308)			::String library = null();
HXDLIN( 308)			this->dialogue = ::CoolUtil_obj::coolTextFile(::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + HX_("philly/philly-dialogue",f6,d9,2d,04)) + HX_(".txt",02,3f,c0,1e)),HX_("TEXT",ad,94,ba,37),library));
HXDLIN( 308)			goto _hx_goto_7;
            		}
            		if (  (_hx_switch_1==HX_("pico",e5,e8,57,4a)) ){
HXLINE( 306)			::String library = null();
HXDLIN( 306)			this->dialogue = ::CoolUtil_obj::coolTextFile(::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + HX_("pico/pico-dialogue",d6,12,52,8e)) + HX_(".txt",02,3f,c0,1e)),HX_("TEXT",ad,94,ba,37),library));
...
HXDLIN( 312)			this->dialogue = ::CoolUtil_obj::coolTextFile(::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + HX_("satin-panties/satin-panties-dialogue",b8,03,ff,2f)) + HX_(".txt",02,3f,c0,1e)),HX_("TEXT",ad,94,ba,37),library));
...
HXDLIN( 304)			this->dialogue = ::CoolUtil_obj::coolTextFile(::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + HX_("south/south-dialogue",9a,ff,a8,31)) + HX_(".txt",02,3f,c0,1e)),HX_("TEXT",ad,94,ba,37),library));
HXDLIN( 304)			goto _hx_goto_7;
            		}
            		if (  (_hx_switch_1==HX_("spookeez",0c,7a,2b,75)) ){
HXLINE( 302)			::String library = null();
HXDLIN( 302)			this->dialogue = ::CoolUtil_obj::coolTextFile(::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + HX_("spookeez/spookeez-dialogue",b6,4e,9e,3e)) + HX_(".txt",02,3f,c0,1e)),HX_("TEXT",ad,94,ba,37),library));
...
HXDLIN( 294)			this->dialogue = ::CoolUtil_obj::coolTextFile(::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + HX_("tutorial/tutorial-dialogue",f6,d8,4a,22)) + HX_(".txt",02,3f,c0,1e)),HX_("TEXT",ad,94,ba,37),library));
HXDLIN( 294)			goto _hx_goto_7;
            		}
            		if (  (_hx_switch_1==HX_("winter-horrorland",9d,39,f4,1e)) ){
HXLINE( 322)			::String library = null();
HXDLIN( 322)			this->dialogue = ::CoolUtil_obj::coolTextFile(::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + HX_("winter-horrorland/winter-horrorland-dialogue",7a,a3,f3,22)) + HX_(".txt",02,3f,c0,1e)),HX_("TEXT",ad,94,ba,37),library));
...
HXLINE( 407)			::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("limo/bgLimo",b4,c7,45,2c)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("week4",c0,95,be,c7));
HXDLIN( 407)			bgLimo->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("limo/bgLimo",b4,c7,45,2c)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),HX_("week4",c0,95,be,c7))));
...
HXLINE( 441)			 ::flixel::FlxSprite _hx_tmp1 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-300,160,null());
HXDLIN( 441)			this->fastCar = _hx_tmp1->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("limo/fastCarLol",c1,b0,ed,94)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("week4",c0,95,be,c7)),null(),null(),null(),null(),null());
...
HXLINE( 457)			 ::flixel::FlxSprite _hx_tmp = this->upperBoppers;
HXDLIN( 457)			::String _hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("christmas/upperBop",2e,2f,6d,ac)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("week5",c1,95,be,c7));
HXDLIN( 457)			_hx_tmp->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp1,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("christmas/upperBop",2e,2f,6d,ac)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),HX_("week5",c1,95,be,c7))));
...
HXLINE( 461)			 ::flixel::FlxSprite _hx_tmp2 = this->upperBoppers;
HXDLIN( 461)			_hx_tmp2->setGraphicSize(::Std_obj::_hx_int((this->upperBoppers->get_width() * ((Float)0.85))),null());
...
HXLINE( 479)			 ::flixel::FlxSprite _hx_tmp3 = this->bottomBoppers;
HXDLIN( 479)			::String _hx_tmp4 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("christmas/bottomBop",cb,69,c5,59)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("week5",c1,95,be,c7));
HXDLIN( 479)			_hx_tmp3->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp4,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("christmas/bottomBop",cb,69,c5,59)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),HX_("week5",c1,95,be,c7))));
...
HXLINE( 483)			 ::flixel::FlxSprite _hx_tmp5 = this->bottomBoppers;
HXDLIN( 483)			_hx_tmp5->setGraphicSize(::Std_obj::_hx_int(this->bottomBoppers->get_width()),null());
...
HXLINE( 493)			 ::flixel::FlxSprite _hx_tmp6 = this->santa;
HXDLIN( 493)			::String _hx_tmp7 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("christmas/santa",00,86,f4,2d)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("week5",c1,95,be,c7));
HXDLIN( 493)			_hx_tmp6->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp7,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("christmas/santa",00,86,f4,2d)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),HX_("week5",c1,95,be,c7))));
...
HXLINE( 500)			 ::flixel::FlxSprite bg =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-400,-500,null());
HXDLIN( 500)			 ::flixel::FlxSprite bg1 = bg->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("christmas/evilBG",86,9d,17,83)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("week5",c1,95,be,c7)),null(),null(),null(),null(),null());
...
HXLINE( 361)			 ::flixel::FlxSprite bg =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-100,null(),null());
HXDLIN( 361)			 ::flixel::FlxSprite bg1 = bg->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("philly/sky",3a,d3,d5,cc)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("week3",bf,95,be,c7)),null(),null(),null(),null(),null());
HXLINE( 362)			bg1->scrollFactor->set(((Float)0.1),((Float)0.1));
HXLINE( 363)			this->add(bg1);
...
HXLINE( 388)			 ::flixel::FlxSprite _hx_tmp =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,2000,360,null());
HXDLIN( 388)			this->phillyTrain = _hx_tmp->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("philly/train",61,ce,51,a4)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("week3",bf,95,be,c7)),null(),null(),null(),null(),null());
HXLINE( 389)			this->add(this->phillyTrain);
HXLINE( 391)			 ::flixel::_hx_system::FlxSound _hx_tmp1 =  ::flixel::_hx_system::FlxSound_obj::__alloc( HX_CTX );
HXDLIN( 391)			this->trainSound = _hx_tmp1->loadEmbedded(::Paths_obj::sound(HX_("train_passes",56,da,5a,7f),HX_("week3",bf,95,be,c7)),null(),null(),null());
...
HXLINE( 523)			 ::flixel::FlxCamera _hx_tmp = ::flixel::FlxG_obj::camera;
HXDLIN( 523)			 ::openfl::filters::ShaderFilter _hx_tmp1 =  ::openfl::filters::ShaderFilter_obj::__alloc( HX_CTX ,this->scanline);
HXDLIN( 523)			_hx_tmp->setFilters(::Array_obj< ::Dynamic>::__new(2)->init(0,_hx_tmp1)->init(1, ::openfl::filters::ShaderFilter_obj::__alloc( HX_CTX ,::PlayState_obj::chromaticAbberation)));
...
HXLINE( 554)			::String _hx_tmp2 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/petals",8d,ca,2b,c2)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("week6",c2,95,be,c7));
HXDLIN( 554)			treeLeaves->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp2,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/petals",8d,ca,2b,c2)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),HX_("week6",c2,95,be,c7))));
...
HXLINE( 584)			 ::BackgroundGirls _hx_tmp3 = this->bgGirls;
HXDLIN( 584)			Float _hx_tmp4 = this->bgGirls->get_width();
HXDLIN( 584)			_hx_tmp3->setGraphicSize(::Std_obj::_hx_int((_hx_tmp4 * ::PlayState_obj::daPixelZoom)),null());
...
HXLINE( 596)			 ::flixel::FlxCamera _hx_tmp = ::flixel::FlxG_obj::camera;
HXDLIN( 596)			 ::openfl::filters::ShaderFilter _hx_tmp1 =  ::openfl::filters::ShaderFilter_obj::__alloc( HX_CTX ,::PlayState_obj::vhsShader);
HXDLIN( 596)			_hx_tmp->setFilters(::Array_obj< ::Dynamic>::__new(2)->init(0,_hx_tmp1)->init(1, ::openfl::filters::ShaderFilter_obj::__alloc( HX_CTX ,::PlayState_obj::chromaticAbberation)));
...
HXLINE( 604)			 ::flixel::FlxSprite bg =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,posX,posY,null());
HXLINE( 605)			::String _hx_tmp2 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/animatedEvilSchool",8f,dd,53,cd)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("week6",c2,95,be,c7));
HXDLIN( 605)			bg->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp2,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/animatedEvilSchool",8f,dd,53,cd)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),HX_("week6",c2,95,be,c7))));
HXLINE( 606)			bg->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("background 2",80,07,9d,17),24,null(),null(),null());
HXLINE( 607)			bg->animation->play(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 608)			bg->scrollFactor->set(((Float)0.8),((Float)0.9));
HXLINE( 609)			bg->scale->set(6,6);
...
HXLINE( 730)			 ::flixel::FlxSprite bg =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-600,-200,null());
HXDLIN( 730)			::String library = null();
HXDLIN( 730)			 ::flixel::FlxSprite bg1 = bg->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("stageback",e5,7b,3b,06)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),null(),null(),null(),null(),null());
HXLINE( 731)			bg1->set_antialiasing(true);
HXLINE( 732)			bg1->scrollFactor->set(((Float)0.9),((Float)0.9));
HXLINE( 733)			bg1->set_active(false);
HXLINE( 734)			this->add(bg1);
HXLINE( 736)			 ::flixel::FlxSprite stageFront =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-650,600,null());
HXDLIN( 736)			::String library1 = null();
HXDLIN( 736)			 ::flixel::FlxSprite stageFront1 = stageFront->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("stagefront",2b,fd,b0,c6)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1),null(),null(),null(),null(),null());
...
HXDLIN( 744)			::String library2 = null();
HXDLIN( 744)			 ::flixel::FlxSprite stageCurtains1 = stageCurtains->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("stagecurtains",df,ec,1a,4b)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library2),null(),null(),null(),null(),null());
...
HXLINE( 659)			 ::BGSprite bg =  ::BGSprite_obj::__alloc( HX_CTX ,HX_("tankSky",17,cc,64,3d),-400,-400,0,0,null(),null());
HXLINE( 660)			this->add(bg);
...
HXLINE( 755)			 ::flixel::FlxSprite bg =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-600,-200,null());
HXDLIN( 755)			::String library = null();
HXDLIN( 755)			 ::flixel::FlxSprite bg1 = bg->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("stageback",e5,7b,3b,06)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),null(),null(),null(),null(),null());
HXLINE( 756)			bg1->set_antialiasing(true);
HXLINE( 757)			bg1->scrollFactor->set(((Float)0.9),((Float)0.9));
HXLINE( 758)			bg1->set_active(false);
HXLINE( 759)			this->add(bg1);
HXLINE( 761)			 ::flixel::FlxSprite stageFront =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-650,600,null());
HXDLIN( 761)			::String library1 = null();
HXDLIN( 761)			 ::flixel::FlxSprite stageFront1 = stageFront->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("stagefront",2b,fd,b0,c6)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1),null(),null(),null(),null(),null());
HXLINE( 762)			stageFront1->setGraphicSize(::Std_obj::_hx_int((stageFront1->get_width() * ((Float)1.1))),null());
HXLINE( 763)			stageFront1->updateHitbox();
HXLINE( 764)			stageFront1->set_antialiasing(true);
HXLINE( 765)			stageFront1->scrollFactor->set(((Float)0.9),((Float)0.9));
HXLINE( 766)			stageFront1->set_active(false);
HXLINE( 767)			this->add(stageFront1);
HXLINE( 769)			 ::flixel::FlxSprite stageCurtains =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-500,-300,null());
HXDLIN( 769)			::String library2 = null();
HXDLIN( 769)			 ::flixel::FlxSprite stageCurtains1 = stageCurtains->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("stagecurtains",df,ec,1a,4b)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library2),null(),null(),null(),null(),null());
HXLINE( 770)			stageCurtains1->setGraphicSize(::Std_obj::_hx_int((stageCurtains1->get_width() * ((Float)0.9))),null());
HXLINE( 771)			stageCurtains1->updateHitbox();
HXLINE( 772)			stageCurtains1->set_antialiasing(true);
HXLINE( 773)			stageCurtains1->scrollFactor->set(((Float)1.3),((Float)1.3));
HXLINE( 774)			stageCurtains1->set_active(false);
HXLINE( 776)			this->add(stageCurtains1);
            		}
            		_hx_goto_8:;
...
HXLINE( 820)			 ::Character fh = ::PlayState_obj::dad;
HXDLIN( 820)			fh->set_y((fh->y + 130));
HXLINE( 819)			goto _hx_goto_10;
            		}
            		if (  (_hx_switch_4==HX_("parents-christmas",fe,94,c5,32)) ){
HXLINE( 827)			 ::Character fh = ::PlayState_obj::dad;
HXDLIN( 827)			fh->set_x((fh->x - ( (Float)(500) )));
HXLINE( 826)			goto _hx_goto_10;
            		}
            		if (  (_hx_switch_4==HX_("pico",e5,e8,57,4a)) ){
HXLINE( 824)			camPos1->set_x((camPos1->x + 600));
HXLINE( 825)			 ::Character fh = ::PlayState_obj::dad;
HXDLIN( 825)			fh->set_y((fh->y + 300));
HXLINE( 823)			goto _hx_goto_10;
            		}
            		if (  (_hx_switch_4==HX_("senpai",3c,df,8d,6b)) ){
HXLINE( 829)			 ::Character fh = ::PlayState_obj::dad;
HXDLIN( 829)			fh->set_x((fh->x + 150));
HXLINE( 830)			 ::Character fh1 = ::PlayState_obj::dad;
HXDLIN( 830)			fh1->set_y((fh1->y + 360));
...
HXLINE( 833)			 ::Character fh = ::PlayState_obj::dad;
HXDLIN( 833)			fh->set_x((fh->x + 150));
HXLINE( 834)			 ::Character fh1 = ::PlayState_obj::dad;
HXDLIN( 834)			fh1->set_y((fh1->y + 360));
...
HXLINE( 837)			 ::Character fh = ::PlayState_obj::dad;
HXDLIN( 837)			fh->set_x((fh->x - ( (Float)(150) )));
HXLINE( 838)			 ::Character fh1 = ::PlayState_obj::dad;
HXDLIN( 838)			fh1->set_y((fh1->y + 100));
HXLINE( 839)			Float _hx_tmp = (::PlayState_obj::dad->getGraphicMidpoint(null())->x + 300);
HXDLIN( 839)			camPos1->set(_hx_tmp,::PlayState_obj::dad->getGraphicMidpoint(null())->y);
HXLINE( 836)			goto _hx_goto_10;
            		}
            		if (  (_hx_switch_4==HX_("spooky",eb,bd,9e,c1)) ){
HXLINE( 816)			 ::Character fh = ::PlayState_obj::dad;
HXDLIN( 816)			fh->set_y((fh->y + 200));
HXLINE( 815)			goto _hx_goto_10;
            		}
            		if (  (_hx_switch_4==HX_("tankman",f0,7d,78,3d)) ){
HXLINE( 841)			 ::Character fh = ::PlayState_obj::dad;
HXDLIN( 841)			fh->set_y((fh->y + 180));
HXLINE( 840)			goto _hx_goto_10;
            		}
            		_hx_goto_10:;
HXLINE( 844)		::String _hx_tmp2;
HXDLIN( 844)		bool _hx_tmp3;
HXDLIN( 844)		if (!(::PlayState_obj::isStoryMode)) {
HXLINE( 844)			_hx_tmp3 = ::PlayState_obj::freeplayChar;
            		}
            		else {
HXLINE( 844)			_hx_tmp3 = false;
            		}
HXDLIN( 844)		if (_hx_tmp3) {
HXLINE( 844)			_hx_tmp2 = ::PlayState_obj::selectedBF;
            		}
            		else {
HXLINE( 844)			_hx_tmp2 = ( (::String)(::PlayState_obj::SONG->__Field(HX_("player1",b0,09,15,8a),::hx::paccDynamic)) );
            		}
HXDLIN( 844)		::PlayState_obj::boyfriend =  ::Boyfriend_obj::__alloc( HX_CTX ,( (Float)(770) ),( (Float)(450) ),_hx_tmp2);
HXLINE( 847)		::String _hx_switch_5 = ::PlayState_obj::curStage;
            		if (  (_hx_switch_5==HX_("limo",1f,17,b3,47)) ){
HXLINE( 850)			 ::Boyfriend fh = ::PlayState_obj::boyfriend;
HXDLIN( 850)			fh->set_y((fh->y - ( (Float)(220) )));
HXLINE( 851)			 ::Boyfriend fh1 = ::PlayState_obj::boyfriend;
HXDLIN( 851)			fh1->set_x((fh1->x + 260));
...
HXLINE( 857)			 ::Boyfriend fh = ::PlayState_obj::boyfriend;
HXDLIN( 857)			fh->set_x((fh->x + 200));
HXLINE( 856)			goto _hx_goto_11;
            		}
            		if (  (_hx_switch_5==HX_("mallEvil",88,d3,e3,a7)) ){
HXLINE( 860)			 ::Boyfriend fh = ::PlayState_obj::boyfriend;
HXDLIN( 860)			fh->set_x((fh->x + 320));
HXLINE( 861)			 ::Character fh1 = ::PlayState_obj::dad;
HXDLIN( 861)			fh1->set_y((fh1->y - ( (Float)(80) )));
HXLINE( 859)			goto _hx_goto_11;
            		}
            		if (  (_hx_switch_5==HX_("school",74,b8,c8,40)) ){
HXLINE( 863)			 ::Boyfriend fh = ::PlayState_obj::boyfriend;
HXDLIN( 863)			fh->set_x((fh->x + 200));
HXLINE( 864)			 ::Boyfriend fh1 = ::PlayState_obj::boyfriend;
HXDLIN( 864)			fh1->set_y((fh1->y + 220));
HXLINE( 865)			 ::Character fh2 = ::PlayState_obj::gf;
HXDLIN( 865)			fh2->set_x((fh2->x + 180));
HXLINE( 866)			 ::Character fh3 = ::PlayState_obj::gf;
HXDLIN( 866)			fh3->set_y((fh3->y + 300));
...
HXLINE( 876)			 ::Boyfriend fh = ::PlayState_obj::boyfriend;
HXDLIN( 876)			fh->set_x((fh->x + 200));
HXLINE( 877)			 ::Boyfriend fh1 = ::PlayState_obj::boyfriend;
HXDLIN( 877)			fh1->set_y((fh1->y + 220));
HXLINE( 878)			 ::Character fh2 = ::PlayState_obj::gf;
HXDLIN( 878)			fh2->set_x((fh2->x + 180));
HXLINE( 879)			 ::Character fh3 = ::PlayState_obj::gf;
HXDLIN( 879)			fh3->set_y((fh3->y + 300));
...
HXLINE( 934)		{
HXLINE( 934)			 ::flixel::FlxCamera _this = ::flixel::FlxG_obj::camera;
HXDLIN( 934)			 ::flixel::math::FlxPoint point = this->camFollow->getPosition(null());
HXDLIN( 934)			_this->scroll->set((point->x - (( (Float)(_this->width) ) * ((Float)0.5))),(point->y - (( (Float)(_this->height) ) * ((Float)0.5))));
HXDLIN( 934)			if (point->_weak) {
HXLINE( 934)				point->put();
            			}
            		}
HXLINE( 936)		{
HXLINE( 936)			 ::flixel::math::FlxRect _this1 = ::flixel::FlxG_obj::worldBounds;
HXDLIN( 936)			_this1->x = ( (Float)(0) );
HXDLIN( 936)			_this1->y = ( (Float)(0) );
HXDLIN( 936)			_this1->width = ( (Float)(::flixel::FlxG_obj::width) );
HXDLIN( 936)			_this1->height = ( (Float)(::flixel::FlxG_obj::height) );
            		}
HXLINE( 938)		::flixel::FlxG_obj::fixedTimestep = false;
HXLINE( 940)		 ::Dynamic _hx_tmp4;
HXDLIN( 940)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("quaverbar",0d,b0,79,a3),::hx::paccDynamic)) ))) {
HXLINE( 940)			_hx_tmp4 = 0;
            		}
            		else {
HXLINE( 940)			_hx_tmp4 = ::flixel::FlxG_obj::width;
            		}
HXDLIN( 940)		 ::Dynamic _hx_tmp5;
HXDLIN( 940)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("quaverbar",0d,b0,79,a3),::hx::paccDynamic)) ))) {
HXLINE( 940)			_hx_tmp5 = (( (Float)(::flixel::FlxG_obj::height) ) * ((Float)0.88));
            		}
            		else {
HXLINE( 940)			_hx_tmp5 = 0;
            		}
HXDLIN( 940)		 ::flixel::FlxSprite _hx_tmp6 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,_hx_tmp4,_hx_tmp5,null());
HXDLIN( 940)		::String library = null();
HXDLIN( 940)		this->healthBarBG = _hx_tmp6->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("healthBar",97,8a,92,42)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),null(),null(),null(),null(),null());
...
HXLINE( 943)		{
HXLINE( 943)			 ::flixel::FlxSprite _this2 = this->healthBarBG;
...
HXDLIN( 943)			bool _hx_tmp7;
HXDLIN( 943)			switch((int)(axes->_hx_getIndex())){
            				case (int)0: case (int)2: {
HXLINE( 943)					_hx_tmp7 = true;
            				}
            				break;
            				default:{
HXLINE( 943)					_hx_tmp7 = false;
            				}
            			}
HXDLIN( 943)			if (_hx_tmp7) {
HXLINE( 943)				int _hx_tmp = ::flixel::FlxG_obj::width;
HXDLIN( 943)				_this2->set_x(((( (Float)(_hx_tmp) ) - _this2->get_width()) / ( (Float)(2) )));
            			}
HXDLIN( 943)			bool _hx_tmp8;
HXDLIN( 943)			switch((int)(axes->_hx_getIndex())){
            				case (int)1: case (int)2: {
HXLINE( 943)					_hx_tmp8 = true;
            				}
            				break;
            				default:{
HXLINE( 943)					_hx_tmp8 = false;
            				}
            			}
HXDLIN( 943)			if (_hx_tmp8) {
HXLINE( 943)				int _hx_tmp = ::flixel::FlxG_obj::height;
HXDLIN( 943)				_this2->set_y(((( (Float)(_hx_tmp) ) - _this2->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXLINE( 949)		 ::Dynamic _hx_tmp9 = ::haxe::Log_obj::trace;
HXDLIN( 949)		::String _hx_tmp10 = (HX_("QUAVERBAR: ",d3,e7,8b,8f) + ::Std_obj::string( ::Dynamic(::flixel::FlxG_obj::save->data->__Field(HX_("quaverbar",0d,b0,79,a3),::hx::paccDynamic))));
HXDLIN( 949)		_hx_tmp9(_hx_tmp10,::hx::SourceInfo(HX_("source/PlayState.hx",75,24,2b,b8),949,HX_("PlayState",5d,83,c2,46),HX_("create",fc,66,0f,7c)));
...
HXLINE( 955)		Float _hx_tmp11;
HXDLIN( 955)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("quaverbar",0d,b0,79,a3),::hx::paccDynamic)) )) {
HXLINE( 955)			_hx_tmp11 = ( (Float)(5) );
            		}
            		else {
HXLINE( 955)			_hx_tmp11 = (this->healthBarBG->x + 4);
            		}
HXDLIN( 955)		Float _hx_tmp12;
HXDLIN( 955)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("quaverbar",0d,b0,79,a3),::hx::paccDynamic)) ))) {
HXLINE( 955)			_hx_tmp12 = (this->healthBarBG->y + 4);
            		}
            		else {
HXLINE( 955)			_hx_tmp12 = ( (Float)(53) );
            		}
HXDLIN( 955)		 ::flixel::ui::FlxBarFillDirection _hx_tmp13;
HXDLIN( 955)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("quaverbar",0d,b0,79,a3),::hx::paccDynamic)) ))) {
HXLINE( 955)			_hx_tmp13 = ::flixel::ui::FlxBarFillDirection_obj::RIGHT_TO_LEFT_dyn();
            		}
            		else {
HXLINE( 955)			_hx_tmp13 = ::flixel::ui::FlxBarFillDirection_obj::BOTTOM_TO_TOP_dyn();
            		}
HXDLIN( 955)		int _hx_tmp14;
HXDLIN( 955)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("quaverbar",0d,b0,79,a3),::hx::paccDynamic)) ))) {
HXLINE( 955)			_hx_tmp14 = ::Std_obj::_hx_int((this->healthBarBG->get_width() - ( (Float)(8) )));
            		}
            		else {
HXLINE( 955)			_hx_tmp14 = ::Std_obj::_hx_int((this->healthBarBG->get_height() - ( (Float)(8) )));
            		}
HXDLIN( 955)		int _hx_tmp15;
HXDLIN( 955)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("quaverbar",0d,b0,79,a3),::hx::paccDynamic)) ))) {
HXLINE( 955)			_hx_tmp15 = ::Std_obj::_hx_int((this->healthBarBG->get_height() - ( (Float)(8) )));
            		}
            		else {
HXLINE( 955)			_hx_tmp15 = ::Std_obj::_hx_int((this->healthBarBG->get_width() - ( (Float)(8) )));
            		}
HXDLIN( 955)		this->healthBar =  ::flixel::ui::FlxBar_obj::__alloc( HX_CTX ,_hx_tmp11,_hx_tmp12,_hx_tmp13,_hx_tmp14,_hx_tmp15,::hx::ObjectPtr<OBJ_>(this),HX_("health",9c,28,06,fd),0,2,null());
...
HXLINE( 962)		Float _hx_tmp16 = this->healthBarBG->x;
HXDLIN( 962)		Float _hx_tmp17 = ((_hx_tmp16 + this->healthBarBG->get_width()) - ( (Float)(250) ));
HXDLIN( 962)		this->scoreTxt =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,_hx_tmp17,(this->healthBarBG->y + 30),0,HX_("",00,00,00,00),20,null());
...
HXLINE( 975)		 ::HealthIcon _hx_tmp18 = this->iconP1;
HXDLIN( 975)		Float _hx_tmp19 = this->healthBar->y;
HXDLIN( 975)		_hx_tmp18->set_y((_hx_tmp19 - (this->iconP1->get_height() / ( (Float)(2) ))));
...
HXLINE( 979)		 ::HealthIcon _hx_tmp20 = this->iconP2;
HXDLIN( 979)		Float _hx_tmp21 = this->healthBar->y;
HXDLIN( 979)		_hx_tmp20->set_y((_hx_tmp21 - (this->iconP2->get_height() / ( (Float)(2) ))));
...
HXDLIN(1035)				_hx_tmp->play(::Paths_obj::sound(HX_("ANGRY",01,81,d0,a0),null()),null(),null(),null(),null(),null());
...
HXDLIN(1069)				int _hx_tmp = ::flixel::FlxG_obj::width;
HXDLIN(1069)				senpaiEvil1->set_x(((( (Float)(_hx_tmp) ) - senpaiEvil->get_width()) / ( (Float)(2) )));
            			}
HXDLIN(1069)			bool _hx_tmp2;
HXDLIN(1069)			switch((int)(axes->_hx_getIndex())){
            				case (int)1: case (int)2: {
...
HXLINE(1069)				 ::flixel::FlxSprite senpaiEvil1 = senpaiEvil;
HXDLIN(1069)				int _hx_tmp = ::flixel::FlxG_obj::height;
HXDLIN(1069)				senpaiEvil1->set_y(((( (Float)(_hx_tmp) ) - senpaiEvil->get_height()) / ( (Float)(2) )));
            			}
            		}
HXLINE(1071)		bool _hx_tmp3;
HXDLIN(1071)		if ((( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ).toLowerCase() != HX_("roses",04,6c,64,ed))) {
HXLINE(1071)			_hx_tmp3 = (( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ).toLowerCase() == HX_("thorns",9c,bf,c7,8c));
            		}
            		else {
...
HXLINE(1189)						 ::flixel::FlxSprite ready = ready1;
HXDLIN(1189)						Float _hx_tmp = ready1->get_width();
HXDLIN(1189)						ready->setGraphicSize(::Std_obj::_hx_int((_hx_tmp * ::PlayState_obj::daPixelZoom)),null());
            					}
HXLINE(1191)					{
HXLINE(1191)						 ::flixel::util::FlxAxes axes = ::flixel::util::FlxAxes_obj::XY_dyn();
HXDLIN(1191)						bool _hx_tmp;
...
HXLINE(1191)							 ::flixel::FlxSprite ready = ready1;
HXDLIN(1191)							int _hx_tmp = ::flixel::FlxG_obj::width;
HXDLIN(1191)							ready->set_x(((( (Float)(_hx_tmp) ) - ready1->get_width()) / ( (Float)(2) )));
            						}
HXDLIN(1191)						bool _hx_tmp1;
HXDLIN(1191)						switch((int)(axes->_hx_getIndex())){
            							case (int)1: case (int)2: {
HXLINE(1191)								_hx_tmp1 = true;
            							...
            							break;
            							default:{
HXLINE(1191)								_hx_tmp1 = false;
            							}
            						}
HXDLIN(1191)						if (_hx_tmp1) {
HXLINE(1191)							 ::flixel::FlxSprite ready = ready1;
HXDLIN(1191)							int _hx_tmp = ::flixel::FlxG_obj::height;
HXDLIN(1191)							ready->set_y(((( (Float)(_hx_tmp) ) - ready1->get_height()) / ( (Float)(2) )));
            						}
            					}
HXLINE(1192)					_gthis->add(ready1).StaticCast<  ::flixel::FlxBasic >();
HXLINE(1193)					 ::flixel::FlxSprite ready2 = ready1;
HXDLIN(1193)					 ::Dynamic _hx_tmp2 =  ::Dynamic(::hx::Anon_obj::Create(2)
            						->setFixed(0,HX_("y",79,00,00,00),ready1->set_y((ready1->y + 100)))
            						->setFixed(1,HX_("alpha",5e,a7,96,21),0));
HXDLIN(1193)					::flixel::tweens::FlxTween_obj::tween(ready2,_hx_tmp2,(::Conductor_obj::crochet / ( (Float)(1000) )), ::Dynamic(::hx::Anon_obj::Create(2)
...
HXLINE(1200)					 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp3 = ::flixel::FlxG_obj::sound;
HXDLIN(1200)					_hx_tmp3->play(::Paths_obj::sound(HX_("intro2",46,54,90,9e),null()),((Float)0.6),null(),null(),null(),null());
            				}
            				break;
            				case (int)2: {
...
HXDLIN(1202)					 ::flixel::FlxSprite set1 = set->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + introAlts->__get(1)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),null(),null(),null(),null(),null());
...
HXLINE(1206)						 ::flixel::FlxSprite set = set1;
HXDLIN(1206)						Float _hx_tmp = set1->get_width();
HXDLIN(1206)						set->setGraphicSize(::Std_obj::_hx_int((_hx_tmp * ::PlayState_obj::daPixelZoom)),null());
            					}
HXLINE(1208)					{
HXLINE(1208)						 ::flixel::util::FlxAxes axes = ::flixel::util::FlxAxes_obj::XY_dyn();
HXDLIN(1208)						bool _hx_tmp;
HXDLIN(1208)						switch((int)(axes->_hx_getIndex())){
            							case (int)0: case (int)2: {
...
HXLINE(1208)							 ::flixel::FlxSprite set = set1;
HXDLIN(1208)							int _hx_tmp = ::flixel::FlxG_obj::width;
HXDLIN(1208)							set->set_x(((( (Float)(_hx_tmp) ) - set1->get_width()) / ( (Float)(2) )));
            						}
...
HXLINE(1208)							 ::flixel::FlxSprite set = set1;
HXDLIN(1208)							int _hx_tmp = ::flixel::FlxG_obj::height;
HXDLIN(1208)							set->set_y(((( (Float)(_hx_tmp) ) - set1->get_height()) / ( (Float)(2) )));
            						}
            					}
HXLINE(1209)					_gthis->add(set1).StaticCast<  ::flixel::FlxBasic >();
HXLINE(1210)					 ::flixel::FlxSprite set2 = set1;
HXDLIN(1210)					 ::Dynamic _hx_tmp2 =  ::Dynamic(::hx::Anon_obj::Create(2)
            						->setFixed(0,HX_("y",79,00,00,00),set1->set_y((set1->y + 100)))
            						->setFixed(1,HX_("alpha",5e,a7,96,21),0));
HXDLIN(1210)					::flixel::tweens::FlxTween_obj::tween(set2,_hx_tmp2,(::Conductor_obj::crochet / ( (Float)(1000) )), ::Dynamic(::hx::Anon_obj::Create(2)
            						->setFixed(0,HX_("ease",ee,8b,0c,43),::flixel::tweens::FlxEase_obj::cubeInOut_dyn())
            						->setFixed(1,HX_("onComplete",f8,d4,7e,5d), ::Dynamic(new _hx_Closure_1(set1)))));
HXLINE(1217)					 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp3 = ::flixel::FlxG_obj::sound;
HXDLIN(1217)					_hx_tmp3->play(::Paths_obj::sound(HX_("intro1",45,54,90,9e),null()),((Float)0.6),null(),null(),null(),null());
            				}
            				break;
            				case (int)3: {
...
HXDLIN(1219)					 ::flixel::FlxSprite go1 = go->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + introAlts->__get(2)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),null(),null(),null(),null(),null());
...
HXLINE(1223)						 ::flixel::FlxSprite go = go1;
HXDLIN(1223)						Float _hx_tmp = go1->get_width();
HXDLIN(1223)						go->setGraphicSize(::Std_obj::_hx_int((_hx_tmp * ::PlayState_obj::daPixelZoom)),null());
            					}
HXLINE(1225)					go1->updateHitbox();
HXLINE(1227)					{
HXLINE(1227)						 ::flixel::util::FlxAxes axes = ::flixel::util::FlxAxes_obj::XY_dyn();
HXDLIN(1227)						bool _hx_tmp;
HXDLIN(1227)						switch((int)(axes->_hx_getIndex())){
            							case (int)0: case (int)2: {
...
HXLINE(1227)							 ::flixel::FlxSprite go = go1;
HXDLIN(1227)							int _hx_tmp = ::flixel::FlxG_obj::width;
HXDLIN(1227)							go->set_x(((( (Float)(_hx_tmp) ) - go1->get_width()) / ( (Float)(2) )));
            						}
...
HXLINE(1227)							 ::flixel::FlxSprite go = go1;
HXDLIN(1227)							int _hx_tmp = ::flixel::FlxG_obj::height;
HXDLIN(1227)							go->set_y(((( (Float)(_hx_tmp) ) - go1->get_height()) / ( (Float)(2) )));
            						}
            					}
HXLINE(1228)					_gthis->add(go1).StaticCast<  ::flixel::FlxBasic >();
HXLINE(1229)					 ::flixel::FlxSprite go2 = go1;
HXDLIN(1229)					 ::Dynamic _hx_tmp2 =  ::Dynamic(::hx::Anon_obj::Create(2)
            						->setFixed(0,HX_("y",79,00,00,00),go1->set_y((go1->y + 100)))
            						->setFixed(1,HX_("alpha",5e,a7,96,21),0));
HXDLIN(1229)					::flixel::tweens::FlxTween_obj::tween(go2,_hx_tmp2,(::Conductor_obj::crochet / ( (Float)(1000) )), ::Dynamic(::hx::Anon_obj::Create(2)
            						->setFixed(0,HX_("ease",ee,8b,0c,43),::flixel::tweens::FlxEase_obj::cubeInOut_dyn())
            						->setFixed(1,HX_("onComplete",f8,d4,7e,5d), ::Dynamic(new _hx_Closure_2(go1)))));
HXLINE(1236)					 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp3 = ::flixel::FlxG_obj::sound;
HXDLIN(1236)					_hx_tmp3->play(::Paths_obj::sound(HX_("introGo",b4,7b,b9,1f),null()),((Float)0.6),null(),null(),null(),null());
            				}
            				break;
            				case (int)4: {
            				}
...
HXDLIN(1240)			int _hx_tmp = 0;
HXDLIN(1240)			swagCounter1[_hx_tmp] = (swagCounter1->__get(_hx_tmp) + 1);
            		}
            		HX_END_LOCAL_FUNC1((void))
...
HXDLIN(1352)							int _g3 = ::Math_obj::floor(susLength);
HXDLIN(1352)							while((_g < _g3)){
HXLINE(1352)								_g = (_g + 1);
HXDLIN(1352)								int susNote = (_g - 1);
...
HXLINE(1402)				::String library = null();
HXDLIN(1402)				babyArrow->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/pixelUI/arrows-pixels",b7,c3,c7,09)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),true,17,17,null(),null());
...
HXLINE(1408)				Float _hx_tmp = babyArrow->get_width();
HXDLIN(1408)				babyArrow->setGraphicSize(::Std_obj::_hx_int((_hx_tmp * ::PlayState_obj::daPixelZoom)),null());
...
HXLINE(1401)				goto _hx_goto_54;
            			...
            			/* default */{
HXLINE(1471)				::String library = null();
HXDLIN(1471)				::String _hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("NOTE_assets",70,3c,09,f7)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN(1471)				babyArrow->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("NOTE_assets",70,3c,09,f7)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
...
HXLINE(1686)			 ::PlayState _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(1686)			_hx_tmp->botplaySine = (_hx_tmp->botplaySine + (( (Float)(180) ) * elapsed));
...
HXLINE(1692)			_hx_tmp1 = this->startedCountdown;
            		}
            		else {
HXLINE(1692)			_hx_tmp1 = false;
            		}
HXDLIN(1692)		if (_hx_tmp1) {
HXLINE(1692)			_hx_tmp = this->canPause;
            		}
            		else {
...
HXLINE(1722)			{
HXLINE(1722)				 ::flixel::FlxState nextState =  ::CharacterSelectState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN(1722)				if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE(1722)					::flixel::FlxG_obj::game->_requestedState = nextState;
            				}
            			}
...
HXLINE(1731)			{
HXLINE(1731)				 ::flixel::FlxState nextState =  ::ChartingState_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE(1741)		 ::HealthIcon _hx_tmp2 = this->iconP1;
HXDLIN(1741)		_hx_tmp2->setGraphicSize(::Std_obj::_hx_int((150 + (((Float)0.50) * (this->iconP1->get_width() - ( (Float)(150) ))))),null());
HXLINE(1742)		 ::HealthIcon _hx_tmp3 = this->iconP2;
HXDLIN(1742)		_hx_tmp3->setGraphicSize(::Std_obj::_hx_int((150 + (((Float)0.50) * (this->iconP2->get_width() - ( (Float)(150) ))))),null());
HXLINE(1744)		this->iconP1->updateHitbox();
HXLINE(1745)		this->iconP2->updateHitbox();
HXLINE(1747)		int iconOffset = 26;
HXLINE(1749)		 ::HealthIcon _hx_tmp4 = this->iconP1;
HXDLIN(1749)		Float _hx_tmp5 = this->healthBar->x;
HXDLIN(1749)		Float _hx_tmp6 = this->healthBar->get_width();
HXDLIN(1749)		_hx_tmp4->set_x((_hx_tmp5 + ((_hx_tmp6 * (::flixel::math::FlxMath_obj::remapToRange(this->healthBar->get_percent(),( (Float)(0) ),( (Float)(100) ),( (Float)(100) ),( (Float)(0) )) * ((Float)0.01))) - ( (Float)(iconOffset) ))));
HXLINE(1750)		 ::HealthIcon _hx_tmp7 = this->iconP2;
HXDLIN(1750)		Float _hx_tmp8 = this->healthBar->x;
HXDLIN(1750)		Float _hx_tmp9 = this->healthBar->get_width();
HXDLIN(1750)		Float _hx_tmp10 = (_hx_tmp8 + (_hx_tmp9 * (::flixel::math::FlxMath_obj::remapToRange(this->healthBar->get_percent(),( (Float)(0) ),( (Float)(100) ),( (Float)(100) ),( (Float)(0) )) * ((Float)0.01))));
HXDLIN(1750)		_hx_tmp7->set_x((_hx_tmp10 - (this->iconP2->get_width() - ( (Float)(iconOffset) ))));
...
HXLINE(1769)			 ::flixel::FlxState nextState =  ::AnimationDebug_obj::__alloc( HX_CTX ,( (::String)(::PlayState_obj::SONG->__Field(HX_("player2",b1,09,15,8a),::hx::paccDynamic)) ));
HXDLIN(1769)			if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE(1769)				::flixel::FlxG_obj::game->_requestedState = nextState;
            			}
            		}
HXLINE(1771)		if (this->startingSong) {
HXLINE(1773)			if (this->startedCountdown) {
HXLINE(1775)				 ::Dynamic _hx_tmp = ::hx::ClassOf< ::Conductor >();
...
HXLINE(1783)			 ::Dynamic _hx_tmp = ::hx::ClassOf< ::Conductor >();
...
HXLINE(1787)				 ::PlayState _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(1787)				_hx_tmp->songTime = (_hx_tmp->songTime + (::flixel::FlxG_obj::game->ticks - this->previousFrameTime));
...
HXLINE(1803)		bool _hx_tmp11;
HXDLIN(1803)		if (this->generatedMusic) {
HXLINE(1803)			_hx_tmp11 = ::hx::IsNotNull(  ::Dynamic(::PlayState_obj::SONG->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic))->__GetItem(::Std_obj::_hx_int((( (Float)(this->curStep) ) / ( (Float)(16) )))) );
            		}
            		else {
HXLINE(1803)			_hx_tmp11 = false;
            		}
HXDLIN(1803)		if (_hx_tmp11) {
HXLINE(1805)			bool _hx_tmp = (::hx::Mod(this->curBeat,4) == 0);
HXLINE(1810)			bool _hx_tmp1;
HXDLIN(1810)			Float _hx_tmp2 = this->camFollow->x;
HXDLIN(1810)			if ((_hx_tmp2 != (::PlayState_obj::dad->getMidpoint(null())->x + 150))) {
HXLINE(1810)				_hx_tmp1 = !(( (bool)( ::Dynamic(::PlayState_obj::SONG->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic))->__GetItem(::Std_obj::_hx_int((( (Float)(this->curStep) ) / ( (Float)(16) ))))->__Field(HX_("mustHitSection",3b,5f,87,62),::hx::paccDynamic)) ));
            			}
            			else {
HXLINE(1810)				_hx_tmp1 = false;
            			}
HXDLIN(1810)			if (_hx_tmp1) {
HXLINE(1812)				 ::flixel::FlxObject _hx_tmp = this->camFollow;
HXDLIN(1812)				Float _hx_tmp1 = (::PlayState_obj::dad->getMidpoint(null())->x + 150);
HXDLIN(1812)				_hx_tmp->setPosition(_hx_tmp1,(::PlayState_obj::dad->getMidpoint(null())->y - ( (Float)(100) )));
HXLINE(1815)				::String _hx_switch_1 = ::PlayState_obj::dad->curCharacter;
            				if (  (_hx_switch_1==HX_("mom",cb,16,53,00)) ){
HXLINE(1818)					 ::flixel::FlxObject _hx_tmp = this->camFollow;
HXDLIN(1818)					_hx_tmp->set_y(::PlayState_obj::dad->getMidpoint(null())->y);
HXDLIN(1818)					goto _hx_goto_81;
            				}
            				if (  (_hx_switch_1==HX_("senpai",3c,df,8d,6b)) ){
HXLINE(1820)					 ::flixel::FlxObject _hx_tmp = this->camFollow;
HXDLIN(1820)					_hx_tmp->set_y((::PlayState_obj::dad->getMidpoint(null())->y - ( (Float)(430) )));
HXLINE(1821)					 ::flixel::FlxObject _hx_tmp1 = this->camFollow;
HXDLIN(1821)					_hx_tmp1->set_x((::PlayState_obj::dad->getMidpoint(null())->x - ( (Float)(100) )));
HXLINE(1819)					goto _hx_goto_81;
            				}
            				if (  (_hx_switch_1==HX_("senpai-angry",10,7a,b8,25)) ){
HXLINE(1823)					 ::flixel::FlxObject _hx_tmp = this->camFollow;
HXDLIN(1823)					_hx_tmp->set_y((::PlayState_obj::dad->getMidpoint(null())->y - ( (Float)(430) )));
HXLINE(1824)					 ::flixel::FlxObject _hx_tmp1 = this->camFollow;
HXDLIN(1824)					_hx_tmp1->set_x((::PlayState_obj::dad->getMidpoint(null())->x - ( (Float)(100) )));
...
HXLINE(1836)				Float _hx_tmp = this->camFollow->x;
HXDLIN(1836)				_hx_tmp3 = (_hx_tmp != (::PlayState_obj::boyfriend->getMidpoint(null())->x - ( (Float)(100) )));
            			}
            			else {
HXLINE(1836)				_hx_tmp3 = false;
            			}
HXDLIN(1836)			if (_hx_tmp3) {
HXLINE(1838)				 ::flixel::FlxObject _hx_tmp = this->camFollow;
HXDLIN(1838)				Float _hx_tmp1 = (::PlayState_obj::boyfriend->getMidpoint(null())->x - ( (Float)(100) ));
HXDLIN(1838)				_hx_tmp->setPosition(_hx_tmp1,(::PlayState_obj::boyfriend->getMidpoint(null())->y - ( (Float)(100) )));
HXLINE(1840)				::String _hx_switch_2 = ::PlayState_obj::curStage;
            				if (  (_hx_switch_2==HX_("limo",1f,17,b3,47)) ){
HXLINE(1843)					 ::flixel::FlxObject _hx_tmp = this->camFollow;
HXDLIN(1843)					_hx_tmp->set_x((::PlayState_obj::boyfriend->getMidpoint(null())->x - ( (Float)(300) )));
HXDLIN(1843)					goto _hx_goto_82;
            				}
            				if (  (_hx_switch_2==HX_("mall",d4,3a,56,48)) ){
HXLINE(1845)					 ::flixel::FlxObject _hx_tmp = this->camFollow;
HXDLIN(1845)					_hx_tmp->set_y((::PlayState_obj::boyfriend->getMidpoint(null())->y - ( (Float)(200) )));
HXDLIN(1845)					goto _hx_goto_82;
            				}
            				if (  (_hx_switch_2==HX_("school",74,b8,c8,40)) ){
HXLINE(1847)					 ::flixel::FlxObject _hx_tmp = this->camFollow;
HXDLIN(1847)					_hx_tmp->set_x((::PlayState_obj::boyfriend->getMidpoint(null())->x - ( (Float)(200) )));
HXLINE(1848)					 ::flixel::FlxObject _hx_tmp1 = this->camFollow;
HXDLIN(1848)					_hx_tmp1->set_y((::PlayState_obj::boyfriend->getMidpoint(null())->y - ( (Float)(200) )));
HXLINE(1846)					goto _hx_goto_82;
            				}
            				if (  (_hx_switch_2==HX_("schoolEvil",28,a1,f5,f7)) ){
HXLINE(1850)					 ::flixel::FlxObject _hx_tmp = this->camFollow;
HXDLIN(1850)					_hx_tmp->set_x((::PlayState_obj::boyfriend->getMidpoint(null())->x - ( (Float)(200) )));
HXLINE(1851)					 ::flixel::FlxObject _hx_tmp1 = this->camFollow;
HXDLIN(1851)					_hx_tmp1->set_y((::PlayState_obj::boyfriend->getMidpoint(null())->y - ( (Float)(200) )));
...
HXLINE(1911)			 ::PlayState _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(1911)			_hx_tmp->health = (_hx_tmp->health + 1);
...
HXLINE(1915)		bool _hx_tmp12;
HXDLIN(1915)		bool _hx_tmp13;
HXDLIN(1915)		if ((this->health <= 0)) {
HXLINE(1915)			_hx_tmp13 = !(::PlayState_obj::practiceMode);
            		}
            		else {
HXLINE(1915)			_hx_tmp13 = false;
            		}
HXDLIN(1915)		if (_hx_tmp13) {
HXLINE(1915)			_hx_tmp12 = this->canDie;
            		}
            		else {
HXLINE(1915)			_hx_tmp12 = false;
            		}
HXDLIN(1915)		if (_hx_tmp12) {
...
HXLINE(1925)			{
HXLINE(1925)				 ::flixel::_hx_system::FlxSound _this = this->vocals;
HXDLIN(1925)				_this->cleanup(_this->autoDestroy,true);
            			}
HXLINE(1926)			{
HXLINE(1926)				 ::flixel::_hx_system::FlxSound _this1 = ::flixel::FlxG_obj::sound->music;
HXDLIN(1926)				_this1->cleanup(_this1->autoDestroy,true);
            			}
HXLINE(1928)			 ::Dynamic _hx_tmp = ::hx::ClassOf< ::PlayState >();
HXDLIN(1928)			::PlayState_obj::deathCounter = (::PlayState_obj::deathCounter + 1);
HXLINE(1930)			Float _hx_tmp1 = ::PlayState_obj::boyfriend->getScreenPosition(null(),null())->x;
HXDLIN(1930)			this->openSubState( ::GameOverSubstate_obj::__alloc( HX_CTX ,_hx_tmp1,::PlayState_obj::boyfriend->getScreenPosition(null(),null())->y));
...
HXLINE(2031)					 ::Note daNote1 = daNote;
HXDLIN(2031)					Float _gthis1 = _gthis->strumLine->y;
HXDLIN(2031)					Float _hx_tmp = (::Conductor_obj::songPosition - daNote->strumTime);
HXDLIN(2031)					daNote1->set_y((_gthis1 - (_hx_tmp * (((Float)-0.45) * ::flixel::math::FlxMath_obj::roundDecimal(( (Float)(::PlayState_obj::SONG->__Field(HX_("speed",87,97,69,81),::hx::paccDynamic)) ),2)))));
            				}
            				else {
HXLINE(2033)					 ::Note daNote1 = daNote;
HXDLIN(2033)					Float _gthis1 = _gthis->strumLine->y;
HXDLIN(2033)					Float _hx_tmp = (::Conductor_obj::songPosition - daNote->strumTime);
HXDLIN(2033)					daNote1->set_y((_gthis1 - (_hx_tmp * (((Float)0.45) * ::flixel::math::FlxMath_obj::roundDecimal(( (Float)(::PlayState_obj::SONG->__Field(HX_("speed",87,97,69,81),::hx::paccDynamic)) ),2)))));
            				}
HXLINE(2037)				bool _hx_tmp4;
HXDLIN(2037)				bool _hx_tmp5;
HXDLIN(2037)				Float daNote2 = daNote->y;
HXDLIN(2037)				if ((daNote2 < -(daNote->get_height()))) {
HXLINE(2037)					_hx_tmp5 = !(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("downscroll",ef,45,d4,4f),::hx::paccDynamic)) ));
            				}
            				else {
HXLINE(2037)					_hx_tmp5 = false;
            				}
HXDLIN(2037)				if (!(_hx_tmp5)) {
HXLINE(2037)					if ((daNote->y >= (_gthis->strumLine->y + 106))) {
HXLINE(2037)						_hx_tmp4 = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("downscroll",ef,45,d4,4f),::hx::paccDynamic)) );
            					}
            					else {
HXLINE(2037)						_hx_tmp4 = false;
            					}
            				}
            				else {
HXLINE(2037)					_hx_tmp4 = true;
            				}
HXDLIN(2037)				if (_hx_tmp4) {
HXLINE(2039)					bool _hx_tmp;
HXDLIN(2039)					if (daNote->isSustainNote) {
HXLINE(2039)						_hx_tmp = daNote->wasGoodHit;
            					}
            					else {
...
HXLINE(2047)						bool daNote1 = daNote->isSustainNote;
HXLINE(2051)						if ((_gthis->health < 0)) {
HXLINE(2052)							_gthis->health = ( (Float)(0) );
            						}
HXLINE(2054)						if ((_gthis->health > 0)) {
HXLINE(2055)							 ::PlayState _gthis1 = _gthis;
HXDLIN(2055)							_gthis1->health = (_gthis1->health - ((Float)0.075));
            						}
...
HXLINE(2147)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN(2147)				::String library = null();
HXDLIN(2147)				_hx_tmp->playMusic(::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + HX_("freakyMenu",15,c9,93,86)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library),null(),null(),null());
...
HXLINE(2168)				 ::Dynamic _hx_tmp = ::haxe::Log_obj::trace;
HXDLIN(2168)				::String _hx_tmp1 = (::PlayState_obj::storyPlaylist->__get(0).toLowerCase() + difficulty);
HXDLIN(2168)				_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("source/PlayState.hx",75,24,2b,b8),2168,HX_("PlayState",5d,83,c2,46),HX_("endSong",50,dd,7c,2e)));
...
HXLINE(2178)					 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN(2178)					_hx_tmp->play(::Paths_obj::sound(HX_("Lights_Shut_off",86,a9,43,29),null()),null(),null(),null(),null(),null());
            				}
...
HXLINE(2185)				::String _hx_tmp2 = (::PlayState_obj::storyPlaylist->__get(0).toLowerCase() + difficulty);
HXDLIN(2185)				::PlayState_obj::SONG = ::Song_obj::loadFromJson(_hx_tmp2,::PlayState_obj::storyPlaylist->__get(0));
HXLINE(2186)				{
...
HXLINE(2192)			{
HXLINE(2192)				 ::flixel::FlxState nextState =  ::FreeplayState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN(2192)				if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE(2192)					::flixel::FlxG_obj::game->_requestedState = nextState;
            				}
            			}
...
HXDLIN(2208)				int _hx_tmp = ::flixel::FlxG_obj::width;
HXDLIN(2208)				coolText1->set_x(((( (Float)(_hx_tmp) ) - coolText->get_width()) / ( (Float)(2) )));
            			}
HXDLIN(2208)			bool _hx_tmp1;
HXDLIN(2208)			switch((int)(axes->_hx_getIndex())){
            				case (int)1: case (int)2: {
HXLINE(2208)					_hx_tmp1 = true;
            				}
            				break;
            				default:{
...
HXLINE(2208)				 ::flixel::text::FlxText coolText1 = coolText;
HXDLIN(2208)				int _hx_tmp = ::flixel::FlxG_obj::height;
HXDLIN(2208)				coolText1->set_y(((( (Float)(_hx_tmp) ) - coolText->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXLINE(2246)		 ::PlayState _hx_tmp2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(2246)		_hx_tmp2->songScore = (_hx_tmp2->songScore + score);
...
HXLINE(2266)				 ::flixel::FlxSprite rating1 = rating;
HXDLIN(2266)				int _hx_tmp = ::flixel::FlxG_obj::width;
HXDLIN(2266)				rating1->set_x(((( (Float)(_hx_tmp) ) - rating->get_width()) / ( (Float)(2) )));
            			}
HXDLIN(2266)			bool _hx_tmp4;
HXDLIN(2266)			switch((int)(axes1->_hx_getIndex())){
            				case (int)1: case (int)2: {
HXLINE(2266)					_hx_tmp4 = true;
            				}
            				break;
            				default:{
HXLINE(2266)					_hx_tmp4 = false;
            				}
            			}
HXDLIN(2266)			if (_hx_tmp4) {
HXLINE(2266)				 ::flixel::FlxSprite rating1 = rating;
HXDLIN(2266)				int _hx_tmp = ::flixel::FlxG_obj::height;
HXDLIN(2266)				rating1->set_y(((( (Float)(_hx_tmp) ) - rating->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXDLIN(2274)			bool _hx_tmp5;
HXDLIN(2274)			switch((int)(axes2->_hx_getIndex())){
            				case (int)0: case (int)2: {
HXLINE(2274)					_hx_tmp5 = true;
            				}
            				break;
            				default:{
HXLINE(2274)					_hx_tmp5 = false;
            				}
            			}
HXDLIN(2274)			if (_hx_tmp5) {
HXLINE(2274)				 ::flixel::FlxSprite comboSpr = comboSpr1;
HXDLIN(2274)				int _hx_tmp = ::flixel::FlxG_obj::width;
HXDLIN(2274)				comboSpr->set_x(((( (Float)(_hx_tmp) ) - comboSpr1->get_width()) / ( (Float)(2) )));
            			}
HXDLIN(2274)			bool _hx_tmp6;
HXDLIN(2274)			switch((int)(axes2->_hx_getIndex())){
            				case (int)1: case (int)2: {
HXLINE(2274)					_hx_tmp6 = true;
            				}
            				break;
            				default:{
HXLINE(2274)					_hx_tmp6 = false;
            				}
            			}
HXDLIN(2274)			if (_hx_tmp6) {
HXLINE(2274)				 ::flixel::FlxSprite comboSpr = comboSpr1;
HXDLIN(2274)				int _hx_tmp = ::flixel::FlxG_obj::height;
HXDLIN(2274)				comboSpr->set_y(((( (Float)(_hx_tmp) ) - comboSpr1->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXLINE(2285)			 ::flixel::FlxSprite rating1 = rating;
HXDLIN(2285)			rating1->setGraphicSize(::Std_obj::_hx_int((rating->get_width() * ((Float)0.7))),null());
HXLINE(2286)			rating->set_antialiasing(true);
HXLINE(2287)			 ::flixel::FlxSprite comboSpr = comboSpr1;
HXDLIN(2287)			comboSpr->setGraphicSize(::Std_obj::_hx_int((comboSpr1->get_width() * ((Float)0.7))),null());
HXLINE(2288)			comboSpr1->set_antialiasing(true);
            		}
            		else {
HXLINE(2292)			 ::flixel::FlxSprite rating1 = rating;
HXDLIN(2292)			Float _hx_tmp = rating->get_width();
HXDLIN(2292)			rating1->setGraphicSize(::Std_obj::_hx_int(((_hx_tmp * ::PlayState_obj::daPixelZoom) * ((Float)0.7))),null());
HXLINE(2293)			 ::flixel::FlxSprite comboSpr = comboSpr1;
HXDLIN(2293)			Float _hx_tmp1 = comboSpr1->get_width();
HXDLIN(2293)			comboSpr->setGraphicSize(::Std_obj::_hx_int(((_hx_tmp1 * ::PlayState_obj::daPixelZoom) * ((Float)0.7))),null());
            		}
...
HXDLIN(2308)				::String library = null();
HXDLIN(2308)				 ::flixel::FlxSprite numScore1 = numScore->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + (((pixelShitPart1 + HX_("num",46,de,53,00)) + ::Std_obj::_hx_int(( (Float)(i) ))) + pixelShitPart2)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),null(),null(),null(),null(),null());
HXLINE(2309)				{
HXLINE(2309)					 ::flixel::util::FlxAxes axes = ::flixel::util::FlxAxes_obj::XY_dyn();
HXDLIN(2309)					bool _hx_tmp;
...
HXLINE(2309)						 ::flixel::FlxSprite numScore = numScore1;
HXDLIN(2309)						int _hx_tmp = ::flixel::FlxG_obj::width;
HXDLIN(2309)						numScore->set_x(((( (Float)(_hx_tmp) ) - numScore1->get_width()) / ( (Float)(2) )));
            					}
...
HXLINE(2309)						 ::flixel::FlxSprite numScore = numScore1;
HXDLIN(2309)						int _hx_tmp = ::flixel::FlxG_obj::height;
HXDLIN(2309)						numScore->set_y(((( (Float)(_hx_tmp) ) - numScore1->get_height()) / ( (Float)(2) )));
            					}
            				}
...
HXLINE(2316)					 ::flixel::FlxSprite numScore = numScore1;
HXDLIN(2316)					numScore->setGraphicSize(::Std_obj::_hx_int((numScore1->get_width() * ((Float)0.5))),null());
            				}
            				else {
HXLINE(2320)					 ::flixel::FlxSprite numScore = numScore1;
HXDLIN(2320)					Float _hx_tmp = numScore1->get_width();
HXDLIN(2320)					numScore->setGraphicSize(::Std_obj::_hx_int((_hx_tmp * ::PlayState_obj::daPixelZoom)),null());
            				}
HXLINE(2322)				numScore1->updateHitbox();
HXLINE(2324)				 ::flixel::math::FlxPoint numScore2 = numScore1->acceleration;
HXDLIN(2324)				numScore2->set_y(( (Float)(::flixel::FlxG_obj::random->_hx_int(200,300,null())) ));
HXLINE(2325)				 ::flixel::math::FlxPoint fh = numScore1->velocity;
HXDLIN(2325)				Float fh1 = fh->y;
HXDLIN(2325)				fh->set_y((fh1 - ( (Float)(::flixel::FlxG_obj::random->_hx_int(140,160,null())) )));
HXLINE(2326)				 ::flixel::math::FlxPoint numScore3 = numScore1->velocity;
HXDLIN(2326)				numScore3->set_x(::flixel::FlxG_obj::random->_hx_float(-5,5,null()));
HXLINE(2328)				bool _hx_tmp2;
HXDLIN(2328)				if ((this->combo < 10)) {
HXLINE(2328)					_hx_tmp2 = (this->combo == 0);
            				}
            				else {
HXLINE(2328)					_hx_tmp2 = true;
            				}
...
HXLINE(2346)		 ::flixel::text::FlxText coolText1 = coolText;
HXDLIN(2346)		coolText1->set_text(::Std_obj::string(seperatedScore));
...
HXLINE(2364)		 ::PlayState _hx_tmp7 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(2364)		_hx_tmp7->curSection = (_hx_tmp7->curSection + 1);
            	}
...
HXLINE(2433)										_hx_tmp = (::Math_obj::abs((daNote->strumTime - coolNote->strumTime)) < 10);
            									}
            									else {
...
HXLINE(2439)											_hx_tmp = (daNote->strumTime < coolNote->strumTime);
            										}
            										else {
...
HXLINE(2469)						_hx_tmp = !(directionList->contains(i));
            					}
            					else {
HXLINE(2469)						_hx_tmp = false;
            					}
...
HXLINE(2475)					_hx_tmp = !(dontCheck);
            				}
            				else {
HXLINE(2475)					_hx_tmp = false;
            				}
HXDLIN(2475)				if (_hx_tmp) {
HXLINE(2477)					{
HXLINE(2477)						int _g = 0;
HXDLIN(2477)						int _g1 = pressArray3->length;
HXDLIN(2477)						while((_g < _g1)){
HXLINE(2477)							_g = (_g + 1);
HXDLIN(2477)							int shit = (_g - 1);
HXLINE(2479)							bool _hx_tmp;
HXDLIN(2479)							if (pressArray3->__get(shit)) {
HXLINE(2479)								_hx_tmp = !(directionList->contains(shit));
            							}
            							else {
...
HXLINE(2483)					{
HXLINE(2483)						int _g2 = 0;
HXDLIN(2483)						while((_g2 < possibleNotes->length)){
HXLINE(2483)							 ::Note coolNote = possibleNotes->__get(_g2).StaticCast<  ::Note >();
HXDLIN(2483)							_g2 = (_g2 + 1);
...
HXLINE(2541)		bool _hx_tmp2;
HXDLIN(2541)		if ((::PlayState_obj::boyfriend->holdTimer > ((::Conductor_obj::stepCrochet * ( (Float)(4) )) * ((Float)0.001)))) {
HXLINE(2541)			_hx_tmp2 = !(holdArray3->contains(true));
            		}
            		else {
HXLINE(2541)			_hx_tmp2 = false;
            		}
HXDLIN(2541)		if (_hx_tmp2) {
...
HXLINE(2543)				_hx_tmp = !(::StringTools_obj::endsWith(::PlayState_obj::boyfriend->animation->_curAnim->name,HX_("miss",fc,52,5c,48)));
            			}
            			else {
...
HXLINE(2580)				_hx_tmp = ::PlayState_obj::gf->animOffsets->exists(HX_("sad",16,98,57,00));
            			}
            			else {
...
HXDLIN(2586)				_hx_tmp->songScore = (_hx_tmp->songScore - 10);
            			}
HXLINE(2588)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp1 = ::flixel::FlxG_obj::sound;
HXDLIN(2588)			::String library = null();
HXDLIN(2588)			::String _hx_tmp2 = ::Paths_obj::sound((HX_("missnote",ee,98,f1,e3) + ::flixel::FlxG_obj::random->_hx_int(1,3,null())),library);
HXDLIN(2588)			_hx_tmp1->play(_hx_tmp2,::flixel::FlxG_obj::random->_hx_float(((Float)0.1),((Float)0.2),null()),null(),null(),null(),null());
...
HXDLIN(2659)				_hx_tmp->health = (_hx_tmp->health + ((Float)0.023));
            			}
            			else {
HXLINE(2661)				 ::PlayState _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(2661)				_hx_tmp->health = (_hx_tmp->health + ((Float)0.004));
            			}
...
HXLINE(2767)				 ::PlayState _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(2767)				_hx_tmp->trainCars = (_hx_tmp->trainCars - 1);
...
HXLINE(2773)				_hx_tmp1 = this->trainFinishing;
            			}
            			else {
...
HXDLIN(2824)			 ::Dynamic _hx_tmp =  ::Dynamic(new _hx_Closure_0(a1,_g));
HXDLIN(2824)			this->notes->members->sort(_hx_tmp);
            		}
...
HXLINE(2851)		bool _hx_tmp5;
HXDLIN(2851)		bool _hx_tmp6;
HXDLIN(2851)		if (this->camZooming) {
HXLINE(2851)			_hx_tmp6 = (::flixel::FlxG_obj::camera->zoom < ((Float)1.35));
            		}
            		else {
HXLINE(2851)			_hx_tmp6 = false;
            		}
HXDLIN(2851)		if (_hx_tmp6) {
HXLINE(2851)			_hx_tmp5 = (::hx::Mod(this->curBeat,4) == 0);
            		}
            		else {
HXLINE(2851)			_hx_tmp5 = false;
            		}
HXDLIN(2851)		if (_hx_tmp5) {
HXLINE(2853)			 ::flixel::FlxCamera fh = ::flixel::FlxG_obj::camera;
HXDLIN(2853)			fh->set_zoom((fh->zoom + ((Float)0.015)));
HXLINE(2854)			 ::flixel::FlxCamera fh1 = this->camHUD;
HXDLIN(2854)			fh1->set_zoom((fh1->zoom + ((Float)0.03)));
            		}
HXLINE(2857)		 ::HealthIcon _hx_tmp7 = this->iconP1;
HXDLIN(2857)		_hx_tmp7->setGraphicSize(::Std_obj::_hx_int((this->iconP1->get_width() + 30)),null());
HXLINE(2858)		 ::HealthIcon _hx_tmp8 = this->iconP2;
HXDLIN(2858)		_hx_tmp8->setGraphicSize(::Std_obj::_hx_int((this->iconP2->get_width() + 30)),null());
...
HXLINE(2885)		bool _hx_tmp9;
HXDLIN(2885)		if ((::hx::Mod(this->curBeat,8) == 7)) {
HXLINE(2885)			_hx_tmp9 = (this->curSong == HX_("Bopeebo",90,29,16,da));
            		}
            		else {
HXLINE(2885)			_hx_tmp9 = false;
            		}
HXDLIN(2885)		if (_hx_tmp9) {
HXLINE(2887)			::PlayState_obj::boyfriend->playAnim(HX_("hey",dc,42,4f,00),true,null(),null());
            		}
HXLINE(2890)		bool _hx_tmp10;
HXDLIN(2890)		bool _hx_tmp11;
HXDLIN(2890)		bool _hx_tmp12;
HXDLIN(2890)		bool _hx_tmp13;
HXDLIN(2890)		if ((::hx::Mod(this->curBeat,16) == 15)) {
HXLINE(2890)			_hx_tmp13 = ::hx::IsEq( ::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic),HX_("Tutorial",be,4b,67,5c) );
            		}
            		else {
HXLINE(2890)			_hx_tmp13 = false;
            		}
HXDLIN(2890)		if (_hx_tmp13) {
HXLINE(2890)			_hx_tmp12 = (::PlayState_obj::dad->curCharacter == HX_("gf",1f,5a,00,00));
            		}
            		else {
HXLINE(2890)			_hx_tmp12 = false;
            		}
HXDLIN(2890)		if (_hx_tmp12) {
HXLINE(2890)			_hx_tmp11 = (this->curBeat > 16);
            		}
            		else {
HXLINE(2890)			_hx_tmp11 = false;
            		}
HXDLIN(2890)		if (_hx_tmp11) {
HXLINE(2890)			_hx_tmp10 = (this->curBeat < 48);
            		}
            		else {
HXLINE(2890)			_hx_tmp10 = false;
            		}
HXDLIN(2890)		if (_hx_tmp10) {
...
HXLINE(2912)				_hx_tmp = this->fastCarCanDrive;
            			}
            			else {
...
HXLINE(2916)				 ::PlayState _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(2916)				_hx_tmp->trainCooldown = (_hx_tmp->trainCooldown + 1);
            			}
...
HXDLIN(2931)			bool _hx_tmp1;
HXDLIN(2931)			bool _hx_tmp2;
HXDLIN(2931)			if ((::hx::Mod(this->curBeat,8) == 4)) {
HXLINE(2931)				_hx_tmp2 = (::flixel::FlxG_obj::random->_hx_float(0,100,null()) < 30);
            			}
            			else {
HXLINE(2931)				_hx_tmp2 = false;
            			}
HXDLIN(2931)			if (_hx_tmp2) {
HXLINE(2931)				_hx_tmp1 = !(this->trainMoving);
            			}
            			else {
HXLINE(2931)				_hx_tmp1 = false;
            			}
HXDLIN(2931)			if (_hx_tmp1) {
HXLINE(2931)				_hx_tmp = (this->trainCooldown > 8);
            			}
            			else {
...
HXDLIN(2899)			goto _hx_goto_121;
            		...
            		_hx_goto_121:;
HXLINE(2938)		bool _hx_tmp14;
HXDLIN(2938)		bool _hx_tmp15;
HXDLIN(2938)		if (this->isHalloween) {
HXLINE(2938)			_hx_tmp15 = (::flixel::FlxG_obj::random->_hx_float(0,100,null()) < 10);
            		}
            		else {
HXLINE(2938)			_hx_tmp15 = false;
            		}
HXDLIN(2938)		if (_hx_tmp15) {
HXLINE(2938)			_hx_tmp14 = (this->curBeat > (this->lightningStrikeBeat + this->lightningOffset));
            		}
            		else {
HXLINE(2938)			_hx_tmp14 = false;
            		}
HXDLIN(2938)		if (_hx_tmp14) {
