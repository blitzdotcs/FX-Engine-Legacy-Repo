...
HXLINE(  43)			::String library2 = null();
HXDLIN(  43)			initCreditlist = ::StringTools_obj::trim(::openfl::utils::Assets_obj::getText(::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + HX_("creditsList",98,6b,74,e1)) + HX_(".txt",02,3f,c0,1e)),HX_("TEXT",ad,94,ba,37),library2))).split(HX_("\n",0a,00,00,00));
HXLINE(  45)			{
HXLINE(  45)				int _g = 0;
...
HXLINE(  61)			{
HXLINE(  61)				int _g2 = 0;
HXDLIN(  61)				int _g3 = initCreditlist->length;
HXDLIN(  61)				while((_g2 < _g3)){
HXLINE(  61)					_g2 = (_g2 + 1);
HXDLIN(  61)					int i1 = (_g2 - 1);
HXLINE(  63)					initCreditlist[i1] = ::StringTools_obj::trim(initCreditlist->__get(i1));
            				}
            			}
            		}
HXLINE(  69)		{
HXLINE(  69)			int _g4 = 0;
HXDLIN(  69)			int _g5 = initCreditlist->length;
HXDLIN(  69)			while((_g4 < _g5)){
HXLINE(  69)				_g4 = (_g4 + 1);
HXDLIN(  69)				int i2 = (_g4 - 1);
HXLINE(  71)				::Array< ::String > data = initCreditlist->__get(i2).split(HX_(":",3a,00,00,00));
...
HXLINE(  80)		 ::flixel::FlxSprite _hx_tmp1 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null());
HXDLIN(  80)		::String library3 = null();
HXDLIN(  80)		this->bg = _hx_tmp1->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("menuDesat",26,91,04,72)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library3),null(),null(),null(),null(),null());
...
HXLINE(  94)		{
HXLINE(  94)			int _g6 = 0;
HXDLIN(  94)			int _g7 = this->credits->length;
HXDLIN(  94)			while((_g6 < _g7)){
HXLINE(  94)				_g6 = (_g6 + 1);
HXDLIN(  94)				int i3 = (_g6 - 1);
HXLINE(  96)				 ::Alphabet creditText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(((70 * i3) + 30)) ),this->credits->__get(i3).StaticCast<  ::CreditsMetadata >()->modderName,true,false);
HXLINE(  97)				creditText->isMenuItem = true;
HXLINE(  98)				creditText->targetY = ( (Float)(i3) );
...
HXDLIN( 139)			_hx_tmp1->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),((Float)0.4),null(),null(),null(),null());
HXLINE( 140)			this->changeSelection(shiftMult);
            		}
HXLINE( 143)		if ((::flixel::FlxG_obj::mouse->wheel != 0)) {
HXLINE( 145)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp2 = ::flixel::FlxG_obj::sound;
HXDLIN( 145)			_hx_tmp2->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),((Float)0.4),null(),null(),null(),null());
