...
HXLINE(  31)				 ::flixel::FlxSprite bg2 = bg1;
HXDLIN(  31)				int _hx_tmp1 = ::flixel::FlxG_obj::width;
HXDLIN(  31)				bg2->set_x(((( (Float)(_hx_tmp1) ) - bg1->get_width()) / ( (Float)(2) )));
            			}
...
HXLINE(  31)				 ::flixel::FlxSprite bg3 = bg1;
HXDLIN(  31)				int _hx_tmp3 = ::flixel::FlxG_obj::height;
HXDLIN(  31)				bg3->set_y(((( (Float)(_hx_tmp3) ) - bg1->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXLINE(  48)				int _hx_tmp5 = ::flixel::FlxG_obj::width;
HXDLIN(  48)				txt->set_x(((( (Float)(_hx_tmp5) ) - txt->get_width()) / ( (Float)(2) )));
            			}
...
HXLINE(  48)				int _hx_tmp7 = ::flixel::FlxG_obj::height;
HXDLIN(  48)				txt->set_y(((( (Float)(_hx_tmp7) ) - txt->get_height()) / ( (Float)(2) )));
            			}
            		}
HXLINE(  49)		this->add(txt);
HXLINE(  51)		 ::flixel::FlxSprite bg4 = bg1;
HXDLIN(  51)		int bg5 = bg1->color;
HXDLIN(  51)		::flixel::tweens::FlxTween_obj::color(bg4,2,bg5,( (int)(::flixel::util::_FlxColor::FlxColor_Impl__obj::fromString(this->bgColors->__get(this->colorRotation))) ),null());
...
HXLINE(  77)			{
HXLINE(  77)				 ::flixel::FlxState nextState1 =  ::MainMenuState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN(  77)				if (::flixel::FlxG_obj::game->_state->switchTo(nextState1)) {
HXLINE(  77)					::flixel::FlxG_obj::game->_requestedState = nextState1;
            				}
            			}
            		}
