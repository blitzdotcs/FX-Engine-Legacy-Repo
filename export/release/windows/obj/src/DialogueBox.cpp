...
HXDLIN(  62)			_hx_tmp1->playMusic(::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + HX_("LunchboxScary",57,33,01,24)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library1),0,null(),null());
HXLINE(  63)			{
HXLINE(  63)				 ::flixel::_hx_system::FlxSound _this1 = ::flixel::FlxG_obj::sound->music;
HXDLIN(  63)				 ::Dynamic onComplete1 = null();
HXDLIN(  63)				if (::hx::IsNull( _this1->_channel )) {
HXLINE(  63)					_this1->play(null(),null(),null());
            				}
HXDLIN(  63)				if (::hx::IsNotNull( _this1->fadeTween )) {
HXLINE(  63)					_this1->fadeTween->cancel();
            				}
HXDLIN(  63)				_this1->fadeTween = ::flixel::tweens::FlxTween_obj::num(( (Float)(0) ),((Float)0.8),1, ::Dynamic(::hx::Anon_obj::Create(1)
            					->setFixed(0,HX_("onComplete",f8,d4,7e,5d),onComplete1)),_this1->volumeTween_dyn());
            			}
HXLINE(  61)			goto _hx_goto_0;
            		}
            		_hx_goto_0:;
HXLINE(  66)		 ::flixel::FlxSprite _hx_tmp2 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-200,-200,null());
HXDLIN(  66)		int _hx_tmp3 = ::Std_obj::_hx_int((( (Float)(::flixel::FlxG_obj::width) ) * ((Float)1.3)));
HXDLIN(  66)		this->bgFade = _hx_tmp2->makeGraphic(_hx_tmp3,::Std_obj::_hx_int((( (Float)(::flixel::FlxG_obj::height) ) * ((Float)1.3))),-4988968,null(),null());
...
HXLINE(  90)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp4 = ::flixel::FlxG_obj::sound;
HXDLIN(  90)			_hx_tmp4->play(::Paths_obj::sound(HX_("ANGRY_TEXT_BOX",57,5c,5c,19),null()),null(),null(),null(),null(),null());
HXLINE(  92)			 ::flixel::FlxSprite _hx_tmp5 = this->box;
HXDLIN(  92)			::String library2 = null();
HXDLIN(  92)			::String _hx_tmp6 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/pixelUI/dialogueBox-senpaiMad",61,55,ee,84)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library2);
HXDLIN(  92)			_hx_tmp5->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp6,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/pixelUI/dialogueBox-senpaiMad",61,55,ee,84)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library2)));
...
HXLINE(  85)			 ::flixel::FlxSprite _hx_tmp7 = this->box;
HXDLIN(  85)			::String library3 = null();
HXDLIN(  85)			::String _hx_tmp8 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/pixelUI/dialogueBox-pixel",b3,f0,21,da)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library3);
HXDLIN(  85)			_hx_tmp7->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp8,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/pixelUI/dialogueBox-pixel",b3,f0,21,da)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library3)));
...
HXLINE(  98)			 ::flixel::FlxSprite _hx_tmp9 = this->box;
HXDLIN(  98)			::String library4 = null();
HXDLIN(  98)			::String _hx_tmp10 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/pixelUI/dialogueBox-evil",07,6d,f9,cc)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library4);
HXDLIN(  98)			_hx_tmp9->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp10,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/pixelUI/dialogueBox-evil",07,6d,f9,cc)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library4)));
...
HXDLIN( 102)			::String library5 = null();
HXDLIN( 102)			 ::flixel::FlxSprite face1 = face->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/spiritFaceForward",93,1c,29,2a)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library5),null(),null(),null(),null(),null());
...
HXLINE( 108)			 ::flixel::FlxSprite _hx_tmp11 = this->box;
HXDLIN( 108)			::String _hx_tmp12 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("speech_bubble_talking",00,7d,a2,c5)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("shared",a5,5e,2b,1d));
HXDLIN( 108)			_hx_tmp11->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp12,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("speech_bubble_talking",00,7d,a2,c5)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),HX_("shared",a5,5e,2b,1d))));
...
HXLINE( 124)		 ::flixel::FlxSprite _hx_tmp13 = this->portraitLeft;
HXDLIN( 124)		::String library6 = null();
HXDLIN( 124)		::String _hx_tmp14 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/senpaiPortrait",9b,ed,4f,6d)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library6);
HXDLIN( 124)		_hx_tmp13->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp14,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/senpaiPortrait",9b,ed,4f,6d)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library6)));
...
HXLINE( 126)		 ::flixel::FlxSprite _hx_tmp15 = this->portraitLeft;
HXDLIN( 126)		Float _hx_tmp16 = this->portraitLeft->get_width();
...
HXLINE( 133)		 ::flixel::FlxSprite _hx_tmp17 = this->portraitRight;
HXDLIN( 133)		::String library7 = null();
HXDLIN( 133)		::String _hx_tmp18 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/bfPortrait",23,ea,7a,a3)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library7);
HXDLIN( 133)		_hx_tmp17->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp18,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/bfPortrait",23,ea,7a,a3)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library7)));
...
HXLINE( 135)		 ::flixel::FlxSprite _hx_tmp19 = this->portraitRight;
HXDLIN( 135)		Float _hx_tmp20 = this->portraitRight->get_width();
HXDLIN( 135)		_hx_tmp19->setGraphicSize(::Std_obj::_hx_int(((_hx_tmp20 * ::PlayState_obj::daPixelZoom) * ((Float)0.9))),null());
...
HXLINE( 142)		 ::flixel::FlxSprite _hx_tmp21 = this->gfportrait;
HXDLIN( 142)		::String _hx_tmp22 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Portraits/gfPortrait",f1,87,8f,80)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("shared",a5,5e,2b,1d));
HXDLIN( 142)		_hx_tmp21->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp22,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Portraits/gfPortrait",f1,87,8f,80)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),HX_("shared",a5,5e,2b,1d))));
...
HXLINE( 151)		 ::flixel::FlxSprite _hx_tmp23 = this->bfportrait;
HXDLIN( 151)		::String _hx_tmp24 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Portraits/boyfriendPortrait",6e,d0,30,16)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("shared",a5,5e,2b,1d));
HXDLIN( 151)		_hx_tmp23->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp24,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Portraits/boyfriendPortrait",6e,d0,30,16)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),HX_("shared",a5,5e,2b,1d))));
...
HXLINE( 160)		 ::flixel::FlxSprite _hx_tmp25 = this->dadPortrait;
HXDLIN( 160)		::String _hx_tmp26 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Portraits/dadPortrait",8b,c5,44,2f)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("shared",a5,5e,2b,1d));
HXDLIN( 160)		_hx_tmp25->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp26,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Portraits/dadPortrait",8b,c5,44,2f)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),HX_("shared",a5,5e,2b,1d))));
...
HXLINE( 169)		 ::flixel::FlxSprite _hx_tmp27 = this->pumpPortrait;
HXDLIN( 169)		::String _hx_tmp28 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Portraits/pumpPortrait",3a,af,7d,6f)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("shared",a5,5e,2b,1d));
HXDLIN( 169)		_hx_tmp27->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp28,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Portraits/pumpPortrait",3a,af,7d,6f)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),HX_("shared",a5,5e,2b,1d))));
...
HXLINE( 178)		 ::flixel::FlxSprite _hx_tmp29 = this->skidPortrait;
HXDLIN( 178)		::String _hx_tmp30 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Portraits/skidPortrait",05,fc,90,47)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("shared",a5,5e,2b,1d));
HXDLIN( 178)		_hx_tmp29->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp30,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Portraits/skidPortrait",05,fc,90,47)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),HX_("shared",a5,5e,2b,1d))));
...
HXLINE( 187)		 ::flixel::FlxSprite _hx_tmp31 = this->picoPortrait;
HXDLIN( 187)		::String _hx_tmp32 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Portraits/picoPortrait",77,90,36,0f)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("shared",a5,5e,2b,1d));
HXDLIN( 187)		_hx_tmp31->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp32,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Portraits/picoPortrait",77,90,36,0f)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),HX_("shared",a5,5e,2b,1d))));
...
HXLINE( 196)		 ::flixel::FlxSprite _hx_tmp33 = this->pico2Portrait;
HXDLIN( 196)		::String _hx_tmp34 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Portraits/picoAngryPortrait",00,fb,76,de)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("shared",a5,5e,2b,1d));
HXDLIN( 196)		_hx_tmp33->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp34,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Portraits/picoAngryPortrait",00,fb,76,de)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),HX_("shared",a5,5e,2b,1d))));
...
HXLINE( 205)		 ::flixel::FlxSprite _hx_tmp35 = this->gf2Portrait;
HXDLIN( 205)		::String _hx_tmp36 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Portraits/gfCheerPortrait",b2,46,ae,f2)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("shared",a5,5e,2b,1d));
HXDLIN( 205)		_hx_tmp35->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp36,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Portraits/gfCheerPortrait",b2,46,ae,f2)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),HX_("shared",a5,5e,2b,1d))));
...
HXLINE( 214)		 ::flixel::FlxSprite _hx_tmp37 = this->momPortrait;
HXDLIN( 214)		::String _hx_tmp38 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Portraits/momPortrait",0f,ca,a5,a5)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("shared",a5,5e,2b,1d));
HXDLIN( 214)		_hx_tmp37->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp38,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Portraits/momPortrait",0f,ca,a5,a5)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),HX_("shared",a5,5e,2b,1d))));
...
HXLINE( 223)		 ::flixel::FlxSprite _hx_tmp39 = this->parentsMomPortrait;
HXDLIN( 223)		::String _hx_tmp40 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Portraits/parentsMomPortrait",14,72,b3,39)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("shared",a5,5e,2b,1d));
HXDLIN( 223)		_hx_tmp39->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp40,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Portraits/parentsMomPortrait",14,72,b3,39)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),HX_("shared",a5,5e,2b,1d))));
...
HXLINE( 232)		 ::flixel::FlxSprite _hx_tmp41 = this->parentsDadPortrait;
HXDLIN( 232)		::String _hx_tmp42 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Portraits/parentsDadPortrait",90,6d,52,c3)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("shared",a5,5e,2b,1d));
HXDLIN( 232)		_hx_tmp41->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp42,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Portraits/parentsDadPortrait",90,6d,52,c3)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),HX_("shared",a5,5e,2b,1d))));
...
HXLINE( 241)		 ::flixel::FlxSprite _hx_tmp43 = this->parentsPortrait;
HXDLIN( 241)		::String _hx_tmp44 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Portraits/parentsPortrait",cd,39,5d,0a)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("shared",a5,5e,2b,1d));
HXDLIN( 241)		_hx_tmp43->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp44,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Portraits/parentsPortrait",cd,39,5d,0a)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),HX_("shared",a5,5e,2b,1d))));
...
HXLINE( 250)		 ::flixel::FlxSprite _hx_tmp45 = this->monsterPortrait;
HXDLIN( 250)		::String _hx_tmp46 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Portraits/christmasLemonPortrait",63,db,65,dd)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),HX_("shared",a5,5e,2b,1d));
HXDLIN( 250)		_hx_tmp45->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp46,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("Portraits/christmasLemonPortrait",63,db,65,dd)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),HX_("shared",a5,5e,2b,1d))));
...
HXLINE( 260)		 ::flixel::FlxSprite _hx_tmp47 = this->box;
HXDLIN( 260)		Float _hx_tmp48 = this->box->get_width();
HXDLIN( 260)		_hx_tmp47->setGraphicSize(::Std_obj::_hx_int(((_hx_tmp48 * ::PlayState_obj::daPixelZoom) * ((Float)0.9))),null());
HXLINE( 261)		this->box->updateHitbox();
HXLINE( 262)		this->add(this->box);
HXLINE( 264)		{
HXLINE( 264)			 ::flixel::FlxSprite _this2 = this->box;
...
HXDLIN( 264)			bool _hx_tmp49;
HXDLIN( 264)			switch((int)(axes->_hx_getIndex())){
            				case (int)0: case (int)2: {
HXLINE( 264)					_hx_tmp49 = true;
            				}
            				break;
            				default:{
HXLINE( 264)					_hx_tmp49 = false;
            				}
            			}
HXDLIN( 264)			if (_hx_tmp49) {
HXLINE( 264)				int _hx_tmp50 = ::flixel::FlxG_obj::width;
HXDLIN( 264)				_this2->set_x(((( (Float)(_hx_tmp50) ) - _this2->get_width()) / ( (Float)(2) )));
            			}
HXDLIN( 264)			bool _hx_tmp51;
HXDLIN( 264)			switch((int)(axes->_hx_getIndex())){
            				case (int)1: case (int)2: {
HXLINE( 264)					_hx_tmp51 = true;
            				}
            				break;
            				default:{
HXLINE( 264)					_hx_tmp51 = false;
            				}
            			}
HXDLIN( 264)			if (_hx_tmp51) {
HXLINE( 264)				int _hx_tmp52 = ::flixel::FlxG_obj::height;
HXDLIN( 264)				_this2->set_y(((( (Float)(_hx_tmp52) ) - _this2->get_height()) / ( (Float)(2) )));
            			}
            		}
HXLINE( 265)		{
HXLINE( 265)			 ::flixel::FlxSprite _this3 = this->portraitLeft;
...
HXDLIN( 265)			bool _hx_tmp53;
HXDLIN( 265)			switch((int)(axes1->_hx_getIndex())){
            				case (int)0: case (int)2: {
HXLINE( 265)					_hx_tmp53 = true;
            				}
            				break;
            				default:{
HXLINE( 265)					_hx_tmp53 = false;
            				}
            			}
HXDLIN( 265)			if (_hx_tmp53) {
HXLINE( 265)				int _hx_tmp54 = ::flixel::FlxG_obj::width;
HXDLIN( 265)				_this3->set_x(((( (Float)(_hx_tmp54) ) - _this3->get_width()) / ( (Float)(2) )));
            			}
HXDLIN( 265)			bool _hx_tmp55;
HXDLIN( 265)			switch((int)(axes1->_hx_getIndex())){
            				case (int)1: case (int)2: {
HXLINE( 265)					_hx_tmp55 = true;
            				}
            				break;
            				default:{
HXLINE( 265)					_hx_tmp55 = false;
            				}
            			}
HXDLIN( 265)			if (_hx_tmp55) {
HXLINE( 265)				int _hx_tmp56 = ::flixel::FlxG_obj::height;
HXDLIN( 265)				_this3->set_y(((( (Float)(_hx_tmp56) ) - _this3->get_height()) / ( (Float)(2) )));
            			}
            		}
HXLINE( 267)		 ::flixel::FlxSprite _hx_tmp57 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,(( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.9)),(( (Float)(::flixel::FlxG_obj::height) ) * ((Float)0.9)),null());
HXDLIN( 267)		::String library8 = null();
HXDLIN( 267)		this->handSelect = _hx_tmp57->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("weeb/pixelUI/hand_textbox",67,1b,cd,60)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library8),null(),null(),null(),null(),null());
HXLINE( 268)		this->add(this->handSelect);
HXLINE( 271)		bool _hx_tmp58 = !(talkingRight);
...
HXLINE( 284)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp59 = ::flixel::FlxG_obj::sound;
HXDLIN( 284)		 ::flixel::_hx_system::FlxSound _hx_tmp60 = _hx_tmp59->load(::Paths_obj::sound(HX_("pixelText",53,7a,83,06),null()),((Float)0.6),null(),null(),null(),null(),null(),null(),null());
HXDLIN( 284)		this->swagDialogue->sounds = ::Array_obj< ::Dynamic>::__new(1)->init(0,_hx_tmp60);
...
HXLINE( 318)			_hx_tmp1 = !(this->dialogueStarted);
            		}
            		else {
...
HXLINE( 324)			_hx_tmp2 = (this->dialogueStarted == true);
            		}
            		else {
...
HXLINE( 328)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp3 = ::flixel::FlxG_obj::sound;
HXDLIN( 328)			_hx_tmp3->play(::Paths_obj::sound(HX_("clickText",15,39,f9,2b),null()),((Float)0.8),null(),null(),null(),null());
HXLINE( 330)			bool _hx_tmp4;
HXDLIN( 330)			if (::hx::IsNull( this->dialogueList->__get(1) )) {
HXLINE( 330)				_hx_tmp4 = ::hx::IsNotNull( this->dialogueList->__get(0) );
            			}
            			else {
HXLINE( 330)				_hx_tmp4 = false;
            			}
...
HXLINE( 336)						_hx_tmp5 = (( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ).toLowerCase() == HX_("thorns",9c,bf,c7,8c));
            					}
            					else {
