...
HXLINE(  56)		this->animation->addByPrefix(HX_("tankman",f0,7d,78,3d),HX_("Tankman Menu BLACK",ce,58,c1,d3),24,null(),null(),null());
...
HXDLIN(  24)			_g->set(HX_("tankman",f0,7d,78,3d), ::CharacterSetting_obj::__alloc( HX_CTX ,0,0,((Float)1.0),true));
HXDLIN(  24)			return _g;
            		}
