...
HXLINE(  42)			 ::flixel::input::keyboard::FlxKeyList _this1 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN(  42)			_hx_tmp1 = _this1->keyManager->checkStatusUnsafe(32,_this1->status);
            		}
            		else {
...
HXDLIN(  81)		HX_STACK_DO_THROW(HX_("VLC caught an error!",bb,69,0d,c2));
            	}
