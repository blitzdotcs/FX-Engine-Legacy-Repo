...
HXLINE( 357)							 ::openfl::display::BitmapData _hx_tmp1 = this->get_bitmapData();
HXDLIN( 357)							 ::openfl::geom::Rectangle _hx_tmp2 = this->frameRect;
HXDLIN( 357)							_hx_tmp1->setPixels(_hx_tmp2,::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytes(::haxe::io::Bytes_obj::ofData(this->bufferMem)));
            						}
            					}
            				} catch( ::Dynamic _hx_e) {
...
HXLINE( 368)						 ::Dynamic _hx_tmp3 = ::haxe::Log_obj::trace;
HXDLIN( 368)						::String _hx_tmp4 = (HX_("error: ",6e,80,0a,ea) + ::Std_obj::string(e));
HXDLIN( 368)						_hx_tmp3(_hx_tmp4,::hx::SourceInfo(HX_("vlc/bitmap/VlcBitmap.hx",a0,17,39,31),368,HX_("vlc.bitmap.VlcBitmap",fe,df,88,4e),HX_("render",56,6b,29,05)));
