...
HXLINE(  80)					 ::GameOverSubstate _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  80)					_hx_tmp->daNoise = (_hx_tmp->daNoise - 2);
HXLINE(  81)					 ::GameOverSubstate _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  81)					_hx_tmp1->daChrome = (_hx_tmp1->daChrome + ((Float)0.0001));
...
HXLINE( 110)				 ::flixel::FlxState nextState =  ::FreeplayState_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE( 113)			_hx_tmp = (this->bf->animation->_curAnim->curFrame == 12);
            		}
            		else {
...
HXLINE( 121)				_hx_tmp = this->bf->animation->_curAnim->finished;
            			}
            			else {
...
HXDLIN( 123)				_hx_tmp->play(::Paths_obj::sound((HX_("jeffGameover/jeffGameover-",3e,03,48,86) + this->randomGameover),null()),null(),null(),null(),null(),null());
...
HXLINE( 129)				_hx_tmp = this->bf->animation->_curAnim->finished;
            			}
            			else {
...
HXDLIN( 131)				_hx_tmp->playMusic(::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + (HX_("gameOver",66,92,de,b5) + this->stageSuffix)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library),null(),null(),null());
