...
HX_DEFINE_STACK_FRAME(_hx_pos_524d86a494ed656f_97_new,"DownscrollOption","new",0xc6fce9d6,"DownscrollOption.new","Options.hx",97,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_524d86a494ed656f_103_press,"DownscrollOption","press",0x5ec33679,"DownscrollOption.press","Options.hx",103,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_524d86a494ed656f_111_updateDisplay,"DownscrollOption","updateDisplay",0xb9a0582f,"DownscrollOption.updateDisplay","Options.hx",111,0x9d9a0240)

void DownscrollOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_524d86a494ed656f_97_new)
HXLINE(  98)		super::__construct();
HXLINE(  99)		this->description = desc;
            	}
...
bool DownscrollOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_524d86a494ed656f_103_press)
HXLINE( 104)		::flixel::FlxG_obj::save->data->__SetField(HX_("downscroll",ef,45,d4,4f),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("downscroll",ef,45,d4,4f),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 105)		this->display = this->updateDisplay();
HXLINE( 106)		return true;
            	}


::String DownscrollOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_524d86a494ed656f_111_updateDisplay)
HXDLIN( 111)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("downscroll",ef,45,d4,4f),::hx::paccDynamic)) )) {
HXDLIN( 111)			return HX_("Downscroll",0f,4a,85,46);
            		}
            		else {
HXDLIN( 111)			return HX_("Upscroll",c8,b0,88,76);
            		}
