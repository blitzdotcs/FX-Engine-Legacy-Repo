...
HXLINE( 210)				::cpp::VirtualArray output = ::Debug_obj::formatOutput(input1,::hx::SourceInfo(HX_("source/Debug.hx",5f,c5,90,56),210,HX_("Debug",33,c2,4c,6a),HX_("onInitProgram",75,d6,4d,0f)));
...
HXLINE( 212)				::cpp::VirtualArray output = ::Debug_obj::formatOutput(input2,::hx::SourceInfo(HX_("source/Debug.hx",5f,c5,90,56),212,HX_("Debug",33,c2,4c,6a),HX_("onInitProgram",75,d6,4d,0f)));
...
HXLINE( 213)				::cpp::VirtualArray output = ::Debug_obj::formatOutput(input3,::hx::SourceInfo(HX_("source/Debug.hx",5f,c5,90,56),213,HX_("Debug",33,c2,4c,6a),HX_("onInitProgram",75,d6,4d,0f)));
HXDLIN( 213)				::Debug_obj::writeToFlxGLog(output,::Debug_obj::LOG_STYLE_INFO);
HXDLIN( 213)				::Debug_obj::writeToLogFile(output,HX_("INFO",6e,00,7c,30));
            			}
            		}
HXLINE( 214)		{
HXLINE( 214)			 ::Dynamic input4 = HX_("FX Engine version: 1.1.4",ac,34,29,05);
HXDLIN( 214)			if (::hx::IsNotNull( input4 )) {
HXLINE( 214)				::cpp::VirtualArray output = ::Debug_obj::formatOutput(input4,::hx::SourceInfo(HX_("source/Debug.hx",5f,c5,90,56),214,HX_("Debug",33,c2,4c,6a),HX_("onInitProgram",75,d6,4d,0f)));
HXDLIN( 214)				::Debug_obj::writeToFlxGLog(output,::Debug_obj::LOG_STYLE_INFO);
HXDLIN( 214)				::Debug_obj::writeToLogFile(output,HX_("INFO",6e,00,7c,30));
            			}
            		}
            	}
