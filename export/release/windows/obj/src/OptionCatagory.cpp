...
HX_LOCAL_STACK_FRAME(_hx_pos_41f5673017f13987_11_boot,"OptionCatagory","boot",0x9ec3bf51,"OptionCatagory.boot","Options.hx",11,0x9d9a0240)
...
::String OptionCatagory_obj::iconbops;
...
bool OptionCatagory_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 8:
		if (HX_FIELD_EQ(inName,"iconbops") ) { outValue = ( iconbops ); return true; }
	}
	return false;
}
...
bool OptionCatagory_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 8:
		if (HX_FIELD_EQ(inName,"iconbops") ) { iconbops=ioValue.Cast< ::String >(); return true; }
	}
	return false;
}
...
static ::hx::StaticInfo OptionCatagory_obj_sStaticStorageInfo[] = {
	{::hx::fsString,(void *) &OptionCatagory_obj::iconbops,HX_("iconbops",09,1d,4a,83)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
static void OptionCatagory_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(OptionCatagory_obj::iconbops,"iconbops");
};

#ifdef HXCPP_VISIT_ALLOCS
static void OptionCatagory_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(OptionCatagory_obj::iconbops,"iconbops");
};
...
static ::String OptionCatagory_obj_sStaticFields[] = {
	HX_("iconbops",09,1d,4a,83),
	::String(null())
};
...
void OptionCatagory_obj::__register()
{
	...
	__mClass->mGetStaticField = &OptionCatagory_obj::__GetStatic;
	__mClass->mSetStaticField = &OptionCatagory_obj::__SetStatic;
	__mClass->mMarkFunc = OptionCatagory_obj_sMarkStatics;
	__mClass->mStatics = ::hx::Class_obj::dupFunctions(OptionCatagory_obj_sStaticFields);
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = OptionCatagory_obj_sVisitStatics;
#endif
#ifdef HXCPP_SCRIPTABLE
...
void OptionCatagory_obj::__boot()
{
{
            	HX_STACKFRAME(&_hx_pos_41f5673017f13987_11_boot)
HXDLIN(  11)		iconbops = HX_("BOP",e3,59,32,00);
            	}
}
