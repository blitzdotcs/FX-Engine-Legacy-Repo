...
HXLINE( 346)			::Dynamic _hx_tmp2 = this->p->fileSystem;
HXDLIN( 346)			return ::lime::media::AudioBuffer_obj::fromBytes(::polymod::fs::IFileSystem_obj::getFileBytes(_hx_tmp2,this->p->file(symbol_modId,null())));
            		}
            		else {
...
HXLINE( 357)			::Dynamic _hx_tmp2 = this->p->fileSystem;
HXDLIN( 357)			return ::polymod::fs::IFileSystem_obj::getFileBytes(_hx_tmp2,this->p->file(symbol_modId,null()));
            		}
            		else {
...
HXLINE( 367)			::Dynamic _hx_tmp2 = this->p->fileSystem;
HXDLIN( 367)			return ::lime::text::Font_obj::fromBytes(::polymod::fs::IFileSystem_obj::getFileBytes(_hx_tmp2,this->p->file(symbol_modId,null())));
            		}
            		else {
...
HXLINE( 383)				::Dynamic _hx_tmp2 = this->p->fileSystem;
HXDLIN( 383)				return ::lime::graphics::Image_obj::fromBytes(::polymod::fs::IFileSystem_obj::getFileBytes(_hx_tmp2,this->p->file(symbol_modId,null())));
            			}
            			else {
...
HXLINE( 484)				::Dynamic this2 = this->pathGroups;
HXDLIN( 484)				return ::lime::media::AudioBuffer_obj::loadFromFiles(( (::Array< ::String >)(( ( ::haxe::ds::StringMap)(this2) )->get(this->p->file(symbol_modId,null()))) ));
            			}
            			else {
HXLINE( 488)				::Dynamic this3 = this->paths;
HXDLIN( 488)				return ::lime::media::AudioBuffer_obj::loadFromFile(( ( ::haxe::ds::StringMap)(this3) )->get_string(this->p->file(symbol_modId,null())));
            			}
            		}
            		else {
...
HXLINE( 511)		 ::lime::net::_HTTPRequest_String request1 =  ::lime::net::_HTTPRequest_String_obj::__alloc( HX_CTX ,null());
HXLINE( 512)		return request1->load(HX_("",00,00,00,00));
            	}
...
HXLINE( 546)						_hx_tmp2 = this->fallback->exists(otherId,type);
            					}
            					else {
HXLINE( 546)						_hx_tmp2 = true;
            					}
