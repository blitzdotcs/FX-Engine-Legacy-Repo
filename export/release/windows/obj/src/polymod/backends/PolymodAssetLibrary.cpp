...
HXDLIN( 261)				_g = (_g + 1);
HXLINE( 263)				::Dynamic _hx_tmp1 = this->fileSystem;
HXDLIN( 263)				if (::polymod::fs::IFileSystem_obj::exists(_hx_tmp1,::polymod::util::Util_obj::pathJoin(d,id))) {
...
HXLINE( 352)				HX_STACK_DO_THROW((((HX_("ModAssetLibrary._initMod(",b4,86,f3,80) + d) + HX_(") failed : ",72,52,be,0b)) + ::Std_obj::string(msg)));
            			}
            			else {
...
HXDLIN( 354)			while((_g1 < all->length)){
HXLINE( 354)				::String f = all->__get(_g1);
HXDLIN( 354)				_g1 = (_g1 + 1);
