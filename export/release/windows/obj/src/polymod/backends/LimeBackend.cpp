...
HXLINE( 139)		{
HXLINE( 139)			 ::Dynamic key2 = defaultLibraries->keys();
HXDLIN( 139)			while(( (bool)(key2->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 139)				::String key3 = ( (::String)(key2->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 141)				::String pathPrefix = HX_("",00,00,00,00);
HXLINE( 142)				if (hasMoreThanDefault) {
HXLINE( 144)					bool _hx_tmp1;
HXDLIN( 144)					if (!(( ( ::haxe::ds::StringMap)( ::Dynamic(params->__Field(HX_("assetLibraryPaths",43,04,19,3e),::hx::paccDynamic))) )->exists(key3))) {
HXLINE( 144)						_hx_tmp1 = (key3 != HX_("default",c1,d8,c3,9b));
            					}
            					else {
HXLINE( 144)						_hx_tmp1 = false;
            					}
HXDLIN( 144)					if (_hx_tmp1) {
HXLINE( 146)						::polymod::Polymod_obj::error(HX_("lime_missing_asset_library_reference",75,a9,dc,e7),((HX_("Your Lime/OpenFL configuration is using custom asset libraries, and you provided frameworkParams in Polymod.init(), but we couldn't find a match for this asset library: (",d0,a8,8f,c6) + key3) + HX_(")",29,00,00,00)),HX_("init",10,3b,bb,45));
HXLINE( 150)						return false;
            					}
            					else {
HXLINE( 154)						if ((key3 == HX_("default",c1,d8,c3,9b))) {
HXLINE( 156)							pathPrefix = HX_("",00,00,00,00);
            						}
            						else {
HXLINE( 160)							pathPrefix = ( ( ::haxe::ds::StringMap)( ::Dynamic(params->__Field(HX_("assetLibraryPaths",43,04,19,3e),::hx::paccDynamic))) )->get_string(key3);
            						}
            					}
            				}
HXLINE( 164)				 ::lime::utils::AssetLibrary fallbackLibrary = ( ( ::lime::utils::AssetLibrary)(defaultLibraries->get(key3)) );
...
HXLINE( 166)				this->modLibraries->set(key3,modLibrary);
            			}
            		}
HXLINE( 169)		{
HXLINE( 169)			 ::Dynamic key4 = this->modLibraries->keys();
HXDLIN( 169)			while(( (bool)(key4->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 169)				::String key5 = ( (::String)(key4->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 171)				::lime::utils::Assets_obj::registerLibrary(key5,( ( ::lime::utils::AssetLibrary)(this->modLibraries->get(key5)) ));
            			}
            		}
...
HXLINE( 192)			_hx_tmp2 = ::hx::IsNotNull( symbol_library->pathPrefix );
            		}
            		else {
HXLINE( 192)			_hx_tmp2 = false;
            		}
HXDLIN( 192)		if (_hx_tmp2) {
HXLINE( 192)			_hx_tmp1 = (symbol_library->pathPrefix != HX_("",00,00,00,00));
            		}
            		else {
...
HXLINE( 199)			_hx_tmp2 = ::hx::IsNotNull( symbol_library->pathPrefix );
            		}
            		else {
HXLINE( 199)			_hx_tmp2 = false;
            		}
HXDLIN( 199)		if (_hx_tmp2) {
HXLINE( 199)			_hx_tmp1 = (symbol_library->pathPrefix != HX_("",00,00,00,00));
            		}
            		else {
...
HXLINE( 206)			_hx_tmp2 = ::hx::IsNotNull( symbol_library->pathPrefix );
            		}
            		else {
HXLINE( 206)			_hx_tmp2 = false;
            		}
HXDLIN( 206)		if (_hx_tmp2) {
HXLINE( 206)			_hx_tmp1 = (symbol_library->pathPrefix != HX_("",00,00,00,00));
            		}
            		else {
...
HXLINE( 213)			_hx_tmp2 = ::hx::IsNotNull( symbol_library->pathPrefix );
            		}
            		else {
HXLINE( 213)			_hx_tmp2 = false;
            		}
HXDLIN( 213)		if (_hx_tmp2) {
HXLINE( 213)			_hx_tmp1 = (symbol_library->pathPrefix != HX_("",00,00,00,00));
            		}
            		else {
...
HXLINE( 236)			{
HXLINE( 236)				 ::Dynamic key2 = ::lime::utils::Assets_obj::cache->font->keys();
HXDLIN( 236)				while(( (bool)(key2->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 236)					::String key3 = ( (::String)(key2->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 238)					::lime::utils::Assets_obj::cache->font->remove(key3);
            				}
            			}
HXLINE( 240)			{
HXLINE( 240)				 ::Dynamic key4 = ::lime::utils::Assets_obj::cache->image->keys();
HXDLIN( 240)				while(( (bool)(key4->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 240)					::String key5 = ( (::String)(key4->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 242)					::lime::utils::Assets_obj::cache->image->remove(key5);
            				}
            			}
            		}
            	}
