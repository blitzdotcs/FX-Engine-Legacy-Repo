...
HXDLIN( 170)			::Array< ::String > _g2 = ( (::Array< ::String >)(params->__Field(HX_("modVersions",3d,b3,b4,55),::hx::paccDynamic)) );
HXDLIN( 170)			while((_g1 < _g2->length)){
HXLINE( 170)				::String str = _g2->__get(_g1);
...
HXDLIN( 177)						 ::Dynamic msg1 = _g3;
HXLINE( 178)						{
HXLINE( 179)							::polymod::Polymod_obj::error(HX_("param_mod_version",69,37,99,54),(HX_("There was an error with one of the mod version patterns you provided: ",a5,c6,14,8b) + ::Std_obj::string(msg1)),HX_("init",10,3b,bb,45));
...
HXDLIN( 186)			int _g5 = dirs->length;
...
HXLINE( 201)							::String _hx_tmp1 = ((((HX_("Mod \"",24,57,85,9f) + origDir) + HX_("\" was built for incompatible API version ",c7,84,bf,95)) + meta->apiVersion->toString()) + HX_(", current API version is ",6d,fd,69,3f));
HXLINE( 200)							::polymod::Polymod_obj::error(HX_("version_conflict_api",b4,79,7a,d1),(_hx_tmp1 + ( (::String)(params->__Field(HX_("apiVersion",9e,39,c9,e5),::hx::paccDynamic)) ).toString()),HX_("init",10,3b,bb,45));
            						}
            						else {
HXLINE( 211)							if ((apiVersion->major == 0)) {
HXLINE( 214)								if ((apiVersion->minor != meta->apiVersion->minor)) {
HXLINE( 217)									::String _hx_tmp2 = (((((HX_("Modding API is in pre-release, some things might have changed!\n",23,df,36,3a) + HX_("Mod \"",24,57,85,9f)) + origDir) + HX_("\" was built for API version ",5c,9c,7b,4e)) + meta->apiVersion->toString()) + HX_(", current API version is ",6d,fd,69,3f));
HXLINE( 216)									::polymod::Polymod_obj::warning(HX_("version_prerelease_api",26,70,a7,43),(_hx_tmp2 + apiVersion->toString()),HX_("init",10,3b,bb,45));
            								}
            							}
            						}
...
HXLINE( 235)								::String _hx_tmp3 = ((HX_("Mod pack wants version ",0e,47,1b,3b) + modVer->toString()) + HX_(" of mod(",af,f2,b6,ab));
HXDLIN( 235)								::String _hx_tmp4 = ((_hx_tmp3 + meta->id) + HX_("), found incompatible version ",74,75,29,24));
HXLINE( 234)								::polymod::Polymod_obj::error(HX_("version_conflict_mod",dc,93,83,d1),((_hx_tmp4 + meta->modVersion->toString()) + HX_(" instead",62,18,ec,b3)),HX_("init",10,3b,bb,45));
            							}
            						}
...
HXLINE( 328)					_hx_tmp1 = !(::polymod::fs::IFileSystem_obj::exists(fileSystem,testDir));
            				}
            				else {
...
HXLINE( 334)		{
HXLINE( 334)			int _g3 = 0;
HXDLIN( 334)			int _g4 = dirs->length;
HXDLIN( 334)			while((_g3 < _g4)){
HXLINE( 334)				_g3 = (_g3 + 1);
HXDLIN( 334)				int i1 = (_g3 - 1);
HXLINE( 336)				if (::hx::IsNotNull( dirs->__get(i1) )) {
HXLINE( 338)					::String origDir = dirs->__get(i1);
HXLINE( 339)					dirs[i1] = ((modRoot + HX_("/",2f,00,00,00)) + dirs->__get(i1));
HXLINE( 340)					 ::polymod::ModMetadata meta = ::polymod::fs::IFileSystem_obj::getMetadata(fileSystem,dirs->__get(i1));
...
HXLINE( 349)							::String _hx_tmp2 = ((((HX_("Mod \"",24,57,85,9f) + origDir) + HX_("\" was built for incompatible API version ",c7,84,bf,95)) + meta->apiVersion->toString()) + HX_(", current API version is ",6d,fd,69,3f));
HXLINE( 348)							::polymod::Polymod_obj::error(HX_("version_conflict_api",b4,79,7a,d1),(_hx_tmp2 + apiVersion->toString()),HX_("scan",7d,fd,4e,4c));
            						}
            						else {
HXLINE( 359)							if ((apiVersion->major == 0)) {
HXLINE( 362)								if ((apiVersion->minor != meta->apiVersion->minor)) {
HXLINE( 365)									::String _hx_tmp3 = (((((HX_("Modding API is in pre-release, some things might have changed!\n",23,df,36,3a) + HX_("Mod \"",24,57,85,9f)) + origDir) + HX_("\" was built for API version ",5c,9c,7b,4e)) + meta->apiVersion->toString()) + HX_(", current API version is ",6d,fd,69,3f));
HXLINE( 364)									::polymod::Polymod_obj::warning(HX_("version_prerelease_api",26,70,a7,43),(_hx_tmp3 + apiVersion->toString()),HX_("scan",7d,fd,4e,4c));
            								}
            							}
            						}
...
HXLINE( 454)							_hx_tmp1 = (arr->length == 2);
            						}
            						else {
