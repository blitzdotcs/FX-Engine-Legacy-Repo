...
HXDLIN( 559)				 ::Dynamic msg = _g;
HXLINE( 561)				HX_STACK_DO_THROW((((HX_("Error parsing XML files during merge (",5b,0b,12,8a) + id) + HX_(") ",d7,23,00,00)) + ::Std_obj::string(msg)));
            			}
            			else {
...
HXDLIN( 568)				 ::Dynamic msg1 = _g1;
HXLINE( 570)				HX_STACK_DO_THROW((((HX_("Error combining XML files during merge (",8f,b2,77,22) + id) + HX_(") ",d7,23,00,00)) + ::Std_obj::string(msg1)));
            			}
            			else {
            				HX_STACK_DO_THROW(_hx_e);
            			}
