...
HXDLIN( 161)				int _g2 = baseCSV->fields->length;
...
HXLINE( 179)			{
HXLINE( 179)				int _g3 = 0;
HXDLIN( 179)				int _g4 = appendCSV->grid->length;
HXDLIN( 179)				while((_g3 < _g4)){
HXLINE( 179)					_g3 = (_g3 + 1);
HXDLIN( 179)					int r = (_g3 - 1);
HXLINE( 181)					::String line = HX_("",00,00,00,00);
HXLINE( 182)					{
HXLINE( 182)						int _g5 = 0;
HXDLIN( 182)						int _g6 = baseCSV->fields->length;
HXDLIN( 182)						while((_g5 < _g6)){
HXLINE( 182)							_g5 = (_g5 + 1);
HXDLIN( 182)							int bi = (_g5 - 1);
HXLINE( 184)							::String baseField1 = baseCSV->fields->__get(bi);
HXLINE( 185)							int appendField = appendCSV->fields->indexOf(baseField1,null());
...
HXLINE( 197)								if ((missingFields->indexOf(baseField1,null()) == -1)) {
HXLINE( 199)									missingFields->push(baseField1);
            								}
            							}
...
HXDLIN( 215)				while((_g7 < missingFields->length)){
HXLINE( 215)					::String baseField2 = missingFields->__get(_g7);
HXDLIN( 215)					_g7 = (_g7 + 1);
HXLINE( 217)					::polymod::Polymod_obj::warning(HX_("append_error",63,d4,ca,e5),((((HX_("Mod file(",2e,de,e2,49) + id) + HX_(") missing expected field \"",65,fc,56,c0)) + baseField2) + HX_("\", values will default to empty string.",aa,16,7f,ae)),HX_("init",10,3b,bb,45));
            				}
            			}
...
HXDLIN( 245)			::Array< ::Dynamic> _g2 = mergeCSV->grid;
HXDLIN( 245)			while((_g1 < _g2->length)){
HXLINE( 245)				::Array< ::String > row = _g2->__get(_g1).StaticCast< ::Array< ::String > >();
...
HXLINE( 250)					int _g3 = 0;
HXDLIN( 250)					int _g4 = baseCSV->grid->length;
HXDLIN( 250)					while((_g3 < _g4)){
HXLINE( 250)						_g3 = (_g3 + 1);
HXDLIN( 250)						int i = (_g3 - 1);
...
HXLINE( 256)							int _g5 = 0;
HXDLIN( 256)							int _g6 = row->length;
HXDLIN( 256)							while((_g5 < _g6)){
HXLINE( 256)								_g5 = (_g5 + 1);
HXDLIN( 256)								int j = (_g5 - 1);
...
HXLINE( 283)					::String x1 = this->delimeter;
HXDLIN( 283)					if (::hx::IsNotNull( buf->charBuf )) {
HXLINE( 283)						buf->flush();
            					}
HXDLIN( 283)					if (::hx::IsNull( buf->b )) {
HXLINE( 283)						buf->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x1));
            					}
            					else {
HXLINE( 283)						::Array< ::String > buf2 = buf->b;
HXDLIN( 283)						buf2->push(::Std_obj::string(x1));
            					}
            				}
            			}
            		}
...
HXLINE( 306)								::Array< ::String > buf4 = buf->b;
HXDLIN( 306)								buf4->push(::Std_obj::string(cell));
            							}
            						}
HXLINE( 307)						if (this->quotedCells) {
HXLINE( 309)							if ((dq >= 127)) {
HXLINE( 309)								::String x3 = ::String::fromCharCode(dq);
HXDLIN( 309)								if (::hx::IsNotNull( buf->charBuf )) {
HXLINE( 309)									buf->flush();
            								}
HXDLIN( 309)								if (::hx::IsNull( buf->b )) {
HXLINE( 309)									buf->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x3));
            								}
            								else {
HXLINE( 309)									::Array< ::String > buf5 = buf->b;
HXDLIN( 309)									buf5->push(::Std_obj::string(x3));
            								}
            							}
            							else {
...
HXLINE( 313)							::String x4 = this->delimeter;
HXDLIN( 313)							if (::hx::IsNotNull( buf->charBuf )) {
HXLINE( 313)								buf->flush();
            							}
HXDLIN( 313)							if (::hx::IsNull( buf->b )) {
HXLINE( 313)								buf->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x4));
            							}
            							else {
HXLINE( 313)								::Array< ::String > buf6 = buf->b;
HXDLIN( 313)								buf6->push(::Std_obj::string(x4));
            							}
            						}
            					}
            				}
