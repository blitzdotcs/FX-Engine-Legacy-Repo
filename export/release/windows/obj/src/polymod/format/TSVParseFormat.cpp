...
HXDLIN( 354)					int _g3 = baseTSV->grid->length;
HXDLIN( 354)					while((_g2 < _g3)){
HXLINE( 354)						_g2 = (_g2 + 1);
HXDLIN( 354)						int i = (_g2 - 1);
...
HXDLIN( 360)							int _g5 = row->length;
HXDLIN( 360)							while((_g4 < _g5)){
HXLINE( 360)								_g4 = (_g4 + 1);
HXDLIN( 360)								int j = (_g4 - 1);
...
HXLINE( 387)						::String x1 = ::String::fromCharCode(tab);
HXDLIN( 387)						if (::hx::IsNotNull( buf->charBuf )) {
HXLINE( 387)							buf->flush();
            						}
HXDLIN( 387)						if (::hx::IsNull( buf->b )) {
HXLINE( 387)							buf->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x1));
            						}
            						else {
HXLINE( 387)							::Array< ::String > buf2 = buf->b;
HXDLIN( 387)							buf2->push(::Std_obj::string(x1));
            						}
            					}
            					else {
...
HXDLIN( 403)					int _g5 = row->length;
HXDLIN( 403)					while((_g4 < _g5)){
HXLINE( 403)						_g4 = (_g4 + 1);
HXDLIN( 403)						int ix = (_g4 - 1);
...
HXLINE( 406)								::Array< ::String > buf3 = buf->b;
HXDLIN( 406)								buf3->push(::Std_obj::string(cell));
            							}
            						}
HXLINE( 407)						if ((ix != (row->length - 1))) {
HXLINE( 409)							if ((tab >= 127)) {
HXLINE( 409)								::String x2 = ::String::fromCharCode(tab);
HXDLIN( 409)								if (::hx::IsNotNull( buf->charBuf )) {
HXLINE( 409)									buf->flush();
            								}
HXDLIN( 409)								if (::hx::IsNull( buf->b )) {
HXLINE( 409)									buf->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x2));
            								}
            								else {
HXLINE( 409)									::Array< ::String > buf4 = buf->b;
HXDLIN( 409)									buf4->push(::Std_obj::string(x2));
            								}
            							}
            							else {
