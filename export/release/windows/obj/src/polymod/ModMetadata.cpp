...
HXDLIN( 527)				 ::Dynamic msg1 = _g1;
HXLINE( 529)				::polymod::Polymod_obj::error(HX_("parse_mod_version",0f,28,c5,d6),(((HX_("Error parsing mod version: (",b0,ae,ce,3c) + ::Std_obj::string(msg1)) + HX_(") _polymod_meta.json was : ",5d,6f,2f,34)) + str),null());
