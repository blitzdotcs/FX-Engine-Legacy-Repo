...
HX_LOCAL_STACK_FRAME(_hx_pos_d6b1695b4ccb37a6_18_difficultyFromInt,"CoolUtil","difficultyFromInt",0xd0410307,"CoolUtil.difficultyFromInt","CoolUtil.hx",18,0x9f143813)
HX_LOCAL_STACK_FRAME(_hx_pos_d6b1695b4ccb37a6_22_coolTextFile,"CoolUtil","coolTextFile",0xa6086875,"CoolUtil.coolTextFile","CoolUtil.hx",22,0x9f143813)
HX_LOCAL_STACK_FRAME(_hx_pos_d6b1695b4ccb37a6_34_coolStringFile,"CoolUtil","coolStringFile",0xc0e9a999,"CoolUtil.coolStringFile","CoolUtil.hx",34,0x9f143813)
HX_LOCAL_STACK_FRAME(_hx_pos_d6b1695b4ccb37a6_46_numberArray,"CoolUtil","numberArray",0x9e0008ad,"CoolUtil.numberArray","CoolUtil.hx",46,0x9f143813)
...
::String CoolUtil_obj::difficultyFromInt(int difficulty){
            	HX_STACKFRAME(&_hx_pos_d6b1695b4ccb37a6_18_difficultyFromInt)
HXDLIN(  18)		return ::CoolUtil_obj::difficultyArray->__get(difficulty);
            	}
...
::Array< ::String > CoolUtil_obj::coolTextFile(::String path){
            	HX_STACKFRAME(&_hx_pos_d6b1695b4ccb37a6_22_coolTextFile)
HXLINE(  23)		::Array< ::String > daList = ::StringTools_obj::trim(::lime::utils::Assets_obj::getText(path)).split(HX_("\n",0a,00,00,00));
HXLINE(  25)		{
HXLINE(  25)			int _g = 0;
HXDLIN(  25)			int _g1 = daList->length;
HXDLIN(  25)			while((_g < _g1)){
HXLINE(  25)				_g = (_g + 1);
HXDLIN(  25)				int i = (_g - 1);
HXLINE(  27)				daList[i] = ::StringTools_obj::trim(daList->__get(i));
            			}
            		}
HXLINE(  30)		return daList;
            	}
...
::Array< ::String > CoolUtil_obj::coolStringFile(::String path){
            	HX_STACKFRAME(&_hx_pos_d6b1695b4ccb37a6_34_coolStringFile)
HXLINE(  35)		::Array< ::String > daList = ::StringTools_obj::trim(path).split(HX_("\n",0a,00,00,00));
HXLINE(  37)		{
HXLINE(  37)			int _g = 0;
HXDLIN(  37)			int _g1 = daList->length;
HXDLIN(  37)			while((_g < _g1)){
HXLINE(  37)				_g = (_g + 1);
HXDLIN(  37)				int i = (_g - 1);
HXLINE(  39)				daList[i] = ::StringTools_obj::trim(daList->__get(i));
            			}
            		}
HXLINE(  42)		return daList;
            	}
...
::Array< int > CoolUtil_obj::numberArray(int max, ::Dynamic __o_min){
            	...
            	HX_STACKFRAME(&_hx_pos_d6b1695b4ccb37a6_46_numberArray)
HXLINE(  47)		::Array< int > dumbArray = ::Array_obj< int >::__new(0);
HXLINE(  48)		{
HXLINE(  48)			int _g = ( (int)(min) );
HXDLIN(  48)			int _g1 = max;
HXDLIN(  48)			while((_g < _g1)){
HXLINE(  48)				_g = (_g + 1);
HXDLIN(  48)				int i = (_g - 1);
HXLINE(  50)				dumbArray->push(i);
            			}
            		}
HXLINE(  52)		return dumbArray;
            	}
