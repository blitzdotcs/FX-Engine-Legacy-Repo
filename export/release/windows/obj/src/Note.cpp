...
HXLINE( 141)			_hx_tmp1 = ::hx::IsNotNull( prevNote );
            		}
            		else {
...
HXLINE( 146)			Float _hx_tmp = this->x;
HXDLIN( 146)			this->set_x((_hx_tmp + (this->get_width() / ( (Float)(2) ))));
...
HXLINE( 162)			Float _hx_tmp1 = this->x;
HXDLIN( 162)			this->set_x((_hx_tmp1 - (this->get_width() / ( (Float)(2) ))));
