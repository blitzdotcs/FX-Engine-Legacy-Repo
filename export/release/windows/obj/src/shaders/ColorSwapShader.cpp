...
HX_DEFINE_STACK_FRAME(_hx_pos_6be2b32b2c3860ea_95_new,"shaders.ColorSwapShader","new",0x3cfee0ed,"shaders.ColorSwapShader.new","shaders/ColorSwapShader.hx",95,0x46c26f64)
namespace shaders{

void ColorSwapShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_6be2b32b2c3860ea_95_new)
...
::hx::Val ColorSwapShader_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 5:
		...
		if (HX_FIELD_EQ(inName,"money") ) { money=inValue.Cast<  ::openfl::display::ShaderParameter_Float >(); return inValue; }
		break;
	case 14:
...
static ::hx::StorageInfo ColorSwapShader_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::openfl::display::ShaderParameter_Float */ ,(int)offsetof(ColorSwapShader_obj,money),HX_("money",40,ba,5f,0c)},
