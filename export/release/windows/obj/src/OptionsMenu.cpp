...
HXLINE(  49)				int _hx_tmp1 = ::flixel::FlxG_obj::width;
HXDLIN(  49)				menuBG1->set_x(((( (Float)(_hx_tmp1) ) - menuBG1->get_width()) / ( (Float)(2) )));
            			}
...
HXLINE(  49)				int _hx_tmp3 = ::flixel::FlxG_obj::height;
HXDLIN(  49)				menuBG1->set_y(((( (Float)(_hx_tmp3) ) - menuBG1->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXLINE(  67)		int _hx_tmp4 = (::flixel::FlxG_obj::height - 18);
HXDLIN(  67)		::String _hx_tmp5 = ((HX_("Offset (Left, Right): ",e9,11,cb,c4) + ::Std_obj::string( ::Dynamic(::flixel::FlxG_obj::save->data->__Field(HX_("offset",93,97,3f,60),::hx::paccDynamic)))) + HX_(" - Description - ",ca,32,1d,cd));
HXDLIN(  67)		this->versionShit =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,5,_hx_tmp4,0,(_hx_tmp5 + this->currentDescription),12,null());
...
HXDLIN( 118)					int _g3 = this->currentSelectedCat->getOptions()->length;
HXDLIN( 118)					while((_g2 < _g3)){
HXLINE( 118)						_g2 = (_g2 + 1);
HXDLIN( 118)						int i1 = (_g2 - 1);
HXLINE( 120)						 ::Alphabet controlLabel1 =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(((70 * i1) + 30)) ),this->currentSelectedCat->getOptions()->__get(i1).StaticCast<  ::Option >()->getDisplay(),true,false);
HXLINE( 121)						controlLabel1->isMenuItem = true;
HXLINE( 122)						controlLabel1->targetY = ( (Float)(i1) );
HXLINE( 123)						this->grpControls->add(controlLabel1).StaticCast<  ::Alphabet >();
            					}
            				}
