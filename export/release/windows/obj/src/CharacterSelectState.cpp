...
HXDLIN( 104)				charSelHeaderText->set_x(((( (Float)(_hx_tmp) ) - charSelHeaderText->get_width()) / ( (Float)(2) )));
            			}
HXDLIN( 104)			bool _hx_tmp5;
HXDLIN( 104)			switch((int)(axes1->_hx_getIndex())){
            				case (int)1: case (int)2: {
HXLINE( 104)					_hx_tmp5 = true;
            				}
            				break;
            				default:{
...
HXDLIN( 104)				charSelHeaderText->set_y(((( (Float)(_hx_tmp) ) - charSelHeaderText->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXLINE( 167)					 ::flixel::FlxState nextState =  ::FreeplayState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 167)					if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 167)						::flixel::FlxG_obj::game->_requestedState = nextState;
            					}
            				}
            			}
            		}
...
HXLINE( 200)				bool _hx_tmp = (item->targetY == 0);
            			}
            		}
...
HXLINE( 235)				int _hx_tmp = ::flixel::FlxG_obj::width;
HXDLIN( 235)				healthBarBG->set_x(((( (Float)(_hx_tmp) ) - healthBarBG->get_width()) / ( (Float)(2) )));
            			}
...
HXLINE( 235)				int _hx_tmp = ::flixel::FlxG_obj::height;
HXDLIN( 235)				healthBarBG->set_y(((( (Float)(_hx_tmp) ) - healthBarBG->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXLINE( 248)		 ::HealthIcon _hx_tmp2 = this->icon;
HXDLIN( 248)		Float healthBar4 = healthBar3->y;
HXDLIN( 248)		_hx_tmp2->set_y((healthBar4 - (this->icon->get_height() / ( (Float)(2) ))));
HXLINE( 249)		{
