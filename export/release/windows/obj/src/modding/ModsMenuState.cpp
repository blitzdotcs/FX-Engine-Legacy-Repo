...
HXDLIN(  68)				menuBG1->set_x(((( (Float)(_hx_tmp) ) - menuBG1->get_width()) / ( (Float)(2) )));
            			}
...
HXDLIN(  68)				menuBG1->set_y(((( (Float)(_hx_tmp) ) - menuBG1->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXLINE(  85)				int _hx_tmp = ::flixel::FlxG_obj::width;
HXDLIN(  85)				_this1->set_x(((( (Float)(_hx_tmp) ) - _this1->get_width()) / ( (Float)(2) )));
            			}
HXDLIN(  85)			bool _hx_tmp5;
HXDLIN(  85)			switch((int)(axes2->_hx_getIndex())){
            				case (int)1: case (int)2: {
...
HXLINE(  85)				int _hx_tmp = ::flixel::FlxG_obj::height;
HXDLIN(  85)				_this1->set_y(((( (Float)(_hx_tmp) ) - _this1->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXDLIN( 188)				_hx_tmp->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),((Float)0.4),null(),null(),null(),null());
            			}
            		}
...
HXLINE( 199)			 ::flixel::FlxState nextState =  ::MainMenuState_obj::__alloc( HX_CTX ,null(),null());
