...
HXLINE(  29)				int _hx_tmp1 = ::flixel::FlxG_obj::width;
HXDLIN(  29)				menuBG->set_x(((( (Float)(_hx_tmp1) ) - menuBG->get_width()) / ( (Float)(2) )));
            			}
...
HXLINE(  29)				int _hx_tmp3 = ::flixel::FlxG_obj::height;
HXDLIN(  29)				menuBG->set_y(((( (Float)(_hx_tmp3) ) - menuBG->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXLINE(  39)						int _hx_tmp5 = ::flixel::FlxG_obj::width;
HXDLIN(  39)						controlLabel->set_x(((( (Float)(_hx_tmp5) ) - controlLabel->get_width()) / ( (Float)(2) )));
            					}
HXDLIN(  39)					bool _hx_tmp6;
HXDLIN(  39)					switch((int)(axes1->_hx_getIndex())){
            						case (int)1: case (int)2: {
...
HXLINE(  39)						int _hx_tmp7 = ::flixel::FlxG_obj::height;
HXDLIN(  39)						controlLabel->set_y(((( (Float)(_hx_tmp7) ) - controlLabel->get_height()) / ( (Float)(2) )));
            					}
            				}
...
HXLINE(  64)				 ::flixel::FlxState nextState1 =  ::MainMenuState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN(  64)				if (::flixel::FlxG_obj::game->_state->switchTo(nextState1)) {
HXLINE(  64)					::flixel::FlxG_obj::game->_requestedState = nextState1;
            				}
...
HXLINE(  69)			 ::flixel::FlxState nextState2 =  ::MainMenuState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN(  69)			if (::flixel::FlxG_obj::game->_state->switchTo(nextState2)) {
HXLINE(  69)				::flixel::FlxG_obj::game->_requestedState = nextState2;
            			}
            		}
