...
HX_LOCAL_STACK_FRAME(_hx_pos_59d01746e3baf250_35_saveWeekScore,"Highscore","saveWeekScore",0x4660a363,"Highscore.saveWeekScore","Highscore.hx",35,0x77c0e42e)
HX_LOCAL_STACK_FRAME(_hx_pos_59d01746e3baf250_58_setScore,"Highscore","setScore",0x2adf0fee,"Highscore.setScore","Highscore.hx",58,0x77c0e42e)
HX_LOCAL_STACK_FRAME(_hx_pos_59d01746e3baf250_66_formatSong,"Highscore","formatSong",0x2cf91dca,"Highscore.formatSong","Highscore.hx",66,0x77c0e42e)
...
void Highscore_obj::saveWeekScore(::hx::Null< int >  __o_week,::hx::Null< int >  __o_score, ::Dynamic __o_diff){
            		...
            		int score = __o_score.Default(0);
            		 ::Dynamic diff = __o_diff;
            		if (::hx::IsNull(__o_diff)) diff = 0;
            	HX_STACKFRAME(&_hx_pos_59d01746e3baf250_35_saveWeekScore)
HXLINE(  43)		::String daWeek = ::Highscore_obj::formatSong((HX_("week",f4,5f,f5,4e) + week),( (int)(diff) ));
HXLINE(  45)		if (::Highscore_obj::songScores->exists(daWeek)) {
HXLINE(  47)			if (::hx::IsLess( ::Highscore_obj::songScores->get(daWeek),score )) {
HXLINE(  48)				::Highscore_obj::setScore(daWeek,score);
            			}
            		}
            		else {
HXLINE(  51)			::Highscore_obj::setScore(daWeek,score);
            		}
            	}
...
void Highscore_obj::setScore(::String song,int score){
            	HX_STACKFRAME(&_hx_pos_59d01746e3baf250_58_setScore)
HXLINE(  60)		::Highscore_obj::songScores->set(song,score);
HXLINE(  61)		::flixel::FlxG_obj::save->data->__SetField(HX_("songScores",96,1a,f0,a0),::Highscore_obj::songScores,::hx::paccDynamic);
HXLINE(  62)		::flixel::FlxG_obj::save->flush(null(),null());
            	}
...
::String Highscore_obj::formatSong(::String song,int diff){
            	HX_STACKFRAME(&_hx_pos_59d01746e3baf250_66_formatSong)
HXLINE(  67)		::String daSong = song;
HXLINE(  69)		if ((diff == 0)) {
HXLINE(  70)			daSong = (daSong + HX_("-easy",af,a6,14,2c));
            		}
            		else {
HXLINE(  71)			if ((diff == 2)) {
HXLINE(  72)				daSong = (daSong + HX_("-hard",98,49,10,2e));
            			}
            		}
