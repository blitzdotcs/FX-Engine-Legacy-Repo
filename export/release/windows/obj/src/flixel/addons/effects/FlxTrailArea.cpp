...
HXLINE( 153)			int _hx_tmp1 = ::Std_obj::_hx_int(this->_width);
HXDLIN( 153)			this->_areaPixels =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,_hx_tmp1,::Std_obj::_hx_int(this->_height),true,0);
            		}
            	}
...
HXLINE( 194)							 ::openfl::display::BitmapData _hx_tmp1 = this->_areaPixels;
HXDLIN( 194)							 ::openfl::display::BitmapData _hx_tmp2 = member->updateFramePixels();
HXDLIN( 194)							 ::openfl::geom::Rectangle _hx_tmp3 =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,0,0,member->frameWidth,member->frameHeight);
HXDLIN( 194)							_hx_tmp1->copyPixels(_hx_tmp2,_hx_tmp3, ::openfl::geom::Point_obj::__alloc( HX_CTX ,finalX,finalY),null(),null(),true);
            						}
            						else {
...
HXLINE( 202)								_hx_tmp4 = scaled;
            							}
            							else {
HXLINE( 202)								_hx_tmp4 = true;
            							}
...
HXLINE( 216)							 ::openfl::display::BitmapData _hx_tmp5 = this->_areaPixels;
HXDLIN( 216)							 ::openfl::display::BitmapData _hx_tmp6 = member->updateFramePixels();
HXDLIN( 216)							_hx_tmp5->draw(_hx_tmp6,this->_matrix,member->colorTransform,this->blendMode,null(),this->antialiasing);
            						}
            					}
            				}
            			}
