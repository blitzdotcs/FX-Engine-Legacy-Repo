...
HXLINE( 186)					 ::flixel::math::FlxPoint point1 = ::flixel::math::FlxPoint_obj::_pool->get()->set(( (Float)(0) ),( (Float)(0) ));
...
HXLINE( 300)				 ::flixel::addons::effects::FlxTrail _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 300)				_hx_tmp1->_transp = (_hx_tmp1->_transp - this->_difference);
