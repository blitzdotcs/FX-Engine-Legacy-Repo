...
HXDLIN(  89)			this->tweenValStart = _hx_tmp1;
HXLINE(  90)			Float _hx_tmp2;
HXDLIN(  90)			if ((NewStatus == 0)) {
HXLINE(  90)				_hx_tmp2 = ((Float)1.0);
            			}
            			else {
HXLINE(  90)				_hx_tmp2 = ((Float)0.0);
            			}
HXDLIN(  90)			this->tweenValEnd = _hx_tmp2;
            		}
            		else {
HXLINE(  92)			bool _hx_tmp3;
HXDLIN(  92)			if ((::Math_obj::abs(DirX) > 0)) {
HXLINE(  92)				_hx_tmp3 = (DirY == 0);
            			}
            			else {
...
HXLINE(  96)				if ((DirX > 0)) {
HXLINE(  98)					Float _hx_tmp4;
HXDLIN(  98)					if ((NewStatus == 0)) {
HXLINE(  98)						_hx_tmp4 = -(this->back->get_width());
            					}
            					else {
HXLINE(  98)						_hx_tmp4 = ( (Float)(0) );
            					}
HXDLIN(  98)					this->tweenValStart = _hx_tmp4;
HXLINE(  99)					Float _hx_tmp5;
HXDLIN(  99)					if ((NewStatus == 0)) {
HXLINE(  99)						_hx_tmp5 = ( (Float)(0) );
            					}
            					else {
HXLINE(  99)						_hx_tmp5 = -(this->back->get_width());
            					}
HXDLIN(  99)					this->tweenValEnd = _hx_tmp5;
            				}
            				else {
HXLINE( 103)					Float _hx_tmp6;
HXDLIN( 103)					if ((NewStatus == 0)) {
HXLINE( 103)						_hx_tmp6 = ( (Float)(::flixel::FlxG_obj::width) );
            					}
            					else {
HXLINE( 103)						_hx_tmp6 = (-(this->back->get_width()) / ( (Float)(2) ));
            					}
HXDLIN( 103)					this->tweenValStart = _hx_tmp6;
HXLINE( 104)					Float _hx_tmp7;
HXDLIN( 104)					if ((NewStatus == 0)) {
HXLINE( 104)						_hx_tmp7 = (-(this->back->get_width()) / ( (Float)(2) ));
            					}
            					else {
HXLINE( 104)						_hx_tmp7 = ( (Float)(::flixel::FlxG_obj::width) );
            					}
HXDLIN( 104)					this->tweenValEnd = _hx_tmp7;
            				}
            			}
            			else {
HXLINE( 107)				bool _hx_tmp8;
HXDLIN( 107)				if ((DirX == 0)) {
HXLINE( 107)					_hx_tmp8 = (::Math_obj::abs(DirY) > 0);
            				}
            				else {
...
HXLINE( 113)						Float _hx_tmp9;
HXDLIN( 113)						if ((NewStatus == 0)) {
HXLINE( 113)							_hx_tmp9 = -(this->back->get_height());
            						}
            						else {
HXLINE( 113)							_hx_tmp9 = ( (Float)(0) );
            						}
HXDLIN( 113)						this->tweenValStart = _hx_tmp9;
HXLINE( 114)						Float _hx_tmp10;
HXDLIN( 114)						if ((NewStatus == 0)) {
HXLINE( 114)							_hx_tmp10 = ( (Float)(0) );
            						}
            						else {
HXLINE( 114)							_hx_tmp10 = -(this->back->get_height());
            						}
HXDLIN( 114)						this->tweenValEnd = _hx_tmp10;
            					}
            					else {
HXLINE( 118)						Float _hx_tmp11;
HXDLIN( 118)						if ((NewStatus == 0)) {
HXLINE( 118)							_hx_tmp11 = ( (Float)(::flixel::FlxG_obj::height) );
            						}
            						else {
HXLINE( 118)							_hx_tmp11 = (-(this->back->get_height()) / ( (Float)(2) ));
            						}
HXDLIN( 118)						this->tweenValStart = _hx_tmp11;
HXLINE( 119)						Float _hx_tmp12;
HXDLIN( 119)						if ((NewStatus == 0)) {
HXLINE( 119)							_hx_tmp12 = (-(this->back->get_height()) / ( (Float)(2) ));
            						}
            						else {
HXLINE( 119)							_hx_tmp12 = ( (Float)(::flixel::FlxG_obj::height) );
            						}
HXDLIN( 119)						this->tweenValEnd = _hx_tmp12;
            					}
            				}
            				else {
HXLINE( 122)					bool _hx_tmp13;
HXDLIN( 122)					if ((::Math_obj::abs(DirX) > 0)) {
HXLINE( 122)						_hx_tmp13 = (::Math_obj::abs(DirY) > 0);
            					}
            					else {
...
HXLINE( 129)							Float _hx_tmp14;
HXDLIN( 129)							if ((NewStatus == 0)) {
HXLINE( 129)								_hx_tmp14 = -(this->back->get_width());
            							}
            							else {
HXLINE( 129)								_hx_tmp14 = ( (Float)(0) );
            							}
HXDLIN( 129)							this->tweenValStart = _hx_tmp14;
HXLINE( 130)							Float _hx_tmp15;
HXDLIN( 130)							if ((NewStatus == 0)) {
HXLINE( 130)								_hx_tmp15 = ( (Float)(0) );
            							}
            							else {
HXLINE( 130)								_hx_tmp15 = -(this->back->get_width());
            							}
HXDLIN( 130)							this->tweenValEnd = _hx_tmp15;
            						}
            						else {
HXLINE( 134)							Float _hx_tmp16;
HXDLIN( 134)							if ((NewStatus == 0)) {
HXLINE( 134)								_hx_tmp16 = ( (Float)(::flixel::FlxG_obj::width) );
            							}
            							else {
HXLINE( 134)								_hx_tmp16 = (-(this->back->get_width()) * ((Float)0.66666666666666663));
            							}
HXDLIN( 134)							this->tweenValStart = _hx_tmp16;
HXLINE( 135)							Float _hx_tmp17;
HXDLIN( 135)							if ((NewStatus == 0)) {
HXLINE( 135)								_hx_tmp17 = (-(this->back->get_width()) * ((Float)0.66666666666666663));
            							}
            							else {
HXLINE( 135)								_hx_tmp17 = ( (Float)(::flixel::FlxG_obj::width) );
            							}
HXDLIN( 135)							this->tweenValEnd = _hx_tmp17;
            						}
HXLINE( 137)						if ((DirY > 0)) {
HXLINE( 139)							Float _hx_tmp18;
HXDLIN( 139)							if ((NewStatus == 0)) {
HXLINE( 139)								_hx_tmp18 = -(this->back->get_height());
            							}
            							else {
HXLINE( 139)								_hx_tmp18 = ( (Float)(0) );
            							}
HXDLIN( 139)							this->tweenValStart2 = _hx_tmp18;
HXLINE( 140)							Float _hx_tmp19;
HXDLIN( 140)							if ((NewStatus == 0)) {
HXLINE( 140)								_hx_tmp19 = ( (Float)(0) );
            							}
            							else {
HXLINE( 140)								_hx_tmp19 = -(this->back->get_height());
            							}
HXDLIN( 140)							this->tweenValEnd2 = _hx_tmp19;
            						}
            						else {
HXLINE( 144)							Float _hx_tmp20;
HXDLIN( 144)							if ((NewStatus == 0)) {
HXLINE( 144)								_hx_tmp20 = ( (Float)(::flixel::FlxG_obj::height) );
            							}
            							else {
HXLINE( 144)								_hx_tmp20 = (-(this->back->get_height()) * ((Float)0.66666666666666663));
            							}
HXDLIN( 144)							this->tweenValStart2 = _hx_tmp20;
HXLINE( 145)							Float _hx_tmp21;
HXDLIN( 145)							if ((NewStatus == 0)) {
HXLINE( 145)								_hx_tmp21 = (-(this->back->get_height()) * ((Float)0.66666666666666663));
            							}
            							else {
HXLINE( 145)								_hx_tmp21 = ( (Float)(::flixel::FlxG_obj::height) );
            							}
HXDLIN( 145)							this->tweenValEnd2 = _hx_tmp21;
            						}
            					}
            				}
            			}
...
HXLINE( 160)			int _hx_tmp1 = ::Std_obj::_hx_int(region->width);
HXDLIN( 160)			int _hx_tmp2 = ::Std_obj::_hx_int(region->height);
HXDLIN( 160)			s->makeGraphic(_hx_tmp1,_hx_tmp2,this->_data->color,null(),null());
            		}
            		else {
HXLINE( 162)			bool _hx_tmp3;
HXDLIN( 162)			if ((DirX == 0)) {
HXLINE( 162)				_hx_tmp3 = (::Math_obj::abs(DirY) > 0);
            			}
            			else {
...
HXLINE( 167)				int _hx_tmp4 = ::Std_obj::_hx_int((region->height * ( (Float)(2) )));
HXDLIN( 167)				s->makeGraphic(1,_hx_tmp4,this->_data->color,null(),null());
...
HXLINE( 180)					int _hx_tmp6 = ::Std_obj::_hx_int((region->width * ( (Float)(2) )));
HXDLIN( 180)					s->makeGraphic(_hx_tmp6,1,this->_data->color,null(),null());
...
HXLINE( 188)						_hx_tmp7 = (::Math_obj::abs(DirY) > 0);
            					}
            					else {
