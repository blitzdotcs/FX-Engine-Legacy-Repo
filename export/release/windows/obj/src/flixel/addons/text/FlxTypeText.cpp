...
HXLINE( 401)			 ::flixel::addons::text::FlxTypeText _hx_tmp3 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 401)			_hx_tmp3->_waitTimer = (_hx_tmp3->_waitTimer - elapsed);
...
HXLINE( 411)			_hx_tmp4 = !(this->paused);
            		}
            		else {
...
HXLINE( 413)				_hx_tmp5 = this->_typing;
            			}
            			else {
HXLINE( 413)				_hx_tmp5 = false;
            			}
HXDLIN( 413)			if (_hx_tmp5) {
HXLINE( 415)				 ::flixel::addons::text::FlxTypeText _hx_tmp6 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 415)				_hx_tmp6->_timer = (_hx_tmp6->_timer + elapsed);
            			}
HXLINE( 418)			bool _hx_tmp7;
HXDLIN( 418)			if ((this->_length > 0)) {
HXLINE( 418)				_hx_tmp7 = this->_erasing;
            			}
            			else {
HXLINE( 418)				_hx_tmp7 = false;
            			}
HXDLIN( 418)			if (_hx_tmp7) {
HXLINE( 420)				 ::flixel::addons::text::FlxTypeText _hx_tmp8 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 420)				_hx_tmp8->_timer = (_hx_tmp8->_timer + elapsed);
            			}
            		}
HXLINE( 426)		bool _hx_tmp9;
HXDLIN( 426)		if (!(this->_typing)) {
HXLINE( 426)			_hx_tmp9 = this->_erasing;
            		}
            		else {
...
HXLINE( 428)				_hx_tmp10 = (this->_timer >= this->delay);
            			}
            			else {
HXLINE( 428)				_hx_tmp10 = false;
            			}
HXDLIN( 428)			if (_hx_tmp10) {
HXLINE( 430)				 ::flixel::addons::text::FlxTypeText _hx_tmp11 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 430)				int _hx_tmp12 = _hx_tmp11->_length;
HXDLIN( 430)				_hx_tmp11->_length = (_hx_tmp12 + ::Std_obj::_hx_int((this->_timer / this->delay)));
HXLINE( 431)				if ((this->_length > this->_finalText.length)) {
HXLINE( 432)					this->_length = this->_finalText.length;
            				}
            			}
HXLINE( 435)			bool _hx_tmp13;
HXDLIN( 435)			if (this->_erasing) {
HXLINE( 435)				_hx_tmp13 = (this->_timer >= this->eraseDelay);
            			}
            			else {
HXLINE( 435)				_hx_tmp13 = false;
            			}
HXDLIN( 435)			if (_hx_tmp13) {
HXLINE( 437)				 ::flixel::addons::text::FlxTypeText _hx_tmp14 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 437)				int _hx_tmp15 = _hx_tmp14->_length;
HXDLIN( 437)				_hx_tmp14->_length = (_hx_tmp15 - ::Std_obj::_hx_int((this->_timer / this->eraseDelay)));
HXLINE( 438)				if ((this->_length < 0)) {
HXLINE( 439)					this->_length = 0;
            				}
            			}
HXLINE( 442)			bool _hx_tmp16;
HXDLIN( 442)			bool _hx_tmp17;
HXDLIN( 442)			if (this->_typing) {
HXLINE( 442)				_hx_tmp17 = (this->_timer >= this->delay);
            			}
            			else {
...
HXLINE( 442)					_hx_tmp16 = (this->_timer >= this->eraseDelay);
            				}
            				else {
...
HXLINE( 457)					 ::flixel::addons::text::FlxTypeText _hx_tmp18 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 457)					_hx_tmp18->_timer = ::hx::Mod(_hx_tmp18->_timer,this->delay);
            				}
HXLINE( 460)				bool _hx_tmp19;
HXDLIN( 460)				if (::hx::IsNotNull( this->sounds )) {
HXLINE( 460)					_hx_tmp19 = !(this->useDefaultSound);
            				}
            				else {
HXLINE( 460)					_hx_tmp19 = false;
            				}
HXDLIN( 460)				if (_hx_tmp19) {
...
HXLINE( 480)		::String _hx_tmp20 = this->prefix;
HXDLIN( 480)		::flixel::addons::text::FlxTypeText_obj::helperString = (_hx_tmp20 + this->_finalText.substr(0,this->_length));
HXLINE( 483)		if (this->showCursor) {
HXLINE( 485)			 ::flixel::addons::text::FlxTypeText _hx_tmp21 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 485)			_hx_tmp21->_cursorTimer = (_hx_tmp21->_cursorTimer + elapsed);
...
HXLINE( 490)			bool _hx_tmp22;
HXDLIN( 490)			if ((this->_cursorTimer > (this->cursorBlinkSpeed / ( (Float)(2) )))) {
HXLINE( 490)				_hx_tmp22 = !(isBreakLine);
            			}
            			else {
HXLINE( 490)				_hx_tmp22 = false;
            			}
HXDLIN( 490)			if (_hx_tmp22) {
HXLINE( 492)				 ::Dynamic _hx_tmp23 = ::hx::ClassOf< ::flixel::addons::text::FlxTypeText >();
HXDLIN( 492)				::String _hx_tmp24 = ::flixel::addons::text::FlxTypeText_obj::helperString;
HXDLIN( 492)				::flixel::addons::text::FlxTypeText_obj::helperString = (_hx_tmp24 + this->cursorCharacter.charAt(0));
            			}
...
HXLINE( 507)			bool _hx_tmp25;
HXDLIN( 507)			bool _hx_tmp26;
HXDLIN( 507)			bool _hx_tmp27;
HXDLIN( 507)			if ((this->_length >= this->_finalText.length)) {
HXLINE( 507)				_hx_tmp27 = this->_typing;
            			}
            			else {
HXLINE( 507)				_hx_tmp27 = false;
            			}
HXDLIN( 507)			if (_hx_tmp27) {
HXLINE( 507)				_hx_tmp26 = !(this->_waiting);
            			}
            			else {
HXLINE( 507)				_hx_tmp26 = false;
            			}
HXDLIN( 507)			if (_hx_tmp26) {
HXLINE( 507)				_hx_tmp25 = !(this->_erasing);
            			}
            			else {
HXLINE( 507)				_hx_tmp25 = false;
            			}
HXDLIN( 507)			if (_hx_tmp25) {
HXLINE( 509)				this->onComplete();
            			}
HXLINE( 513)			bool _hx_tmp28;
HXDLIN( 513)			bool _hx_tmp29;
HXDLIN( 513)			bool _hx_tmp30;
HXDLIN( 513)			if ((this->_length == 0)) {
HXLINE( 513)				_hx_tmp30 = this->_erasing;
            			}
            			else {
HXLINE( 513)				_hx_tmp30 = false;
            			}
HXDLIN( 513)			if (_hx_tmp30) {
HXLINE( 513)				_hx_tmp29 = !(this->_typing);
            			}
            			else {
HXLINE( 513)				_hx_tmp29 = false;
            			}
HXDLIN( 513)			if (_hx_tmp29) {
HXLINE( 513)				_hx_tmp28 = !(this->_waiting);
            			}
            			else {
HXLINE( 513)				_hx_tmp28 = false;
            			}
