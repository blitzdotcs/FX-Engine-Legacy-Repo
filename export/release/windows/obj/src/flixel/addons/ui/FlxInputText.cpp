...
HXLINE( 318)					_hx_tmp1 = ::hx::IsNotNull( this->focusLost );
            				}
            				else {
...
HXLINE( 375)										::String _hx_tmp3 = this->text.substring(0,this->caretIndex);
HXDLIN( 375)										this->set_text((_hx_tmp3 + this->text.substring((this->caretIndex + 1),null())));
...
HXLINE( 382)											_hx_tmp4 = (this->caretIndex < this->text.length);
            										}
            										else {
HXLINE( 382)											_hx_tmp4 = false;
            										}
HXDLIN( 382)										if (_hx_tmp4) {
HXLINE( 384)											::String _hx_tmp5 = this->text.substring(0,this->caretIndex);
HXDLIN( 384)											this->set_text((_hx_tmp5 + this->text.substring((this->caretIndex + 1),null())));
...
HXLINE( 402)											bool _hx_tmp6;
HXDLIN( 402)											if ((newText.length > 0)) {
HXLINE( 402)												if ((this->maxLength != 0)) {
HXLINE( 402)													_hx_tmp6 = ((this->text.length + newText.length) < this->maxLength);
            												}
            												else {
...
HXLINE( 467)				 ::flixel::math::FlxRect _this1 = this->_charBoundaries->__get(charIndex).StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 467)				 ::openfl::geom::Rectangle FlashRect1 = r;
HXDLIN( 467)				if (::hx::IsNull( FlashRect1 )) {
HXLINE( 467)					FlashRect1 =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
            				}
HXDLIN( 467)				FlashRect1->x = _this1->x;
HXDLIN( 467)				FlashRect1->y = _this1->y;
HXDLIN( 467)				FlashRect1->width = _this1->width;
HXDLIN( 467)				FlashRect1->height = _this1->height;
            			}
HXLINE( 469)			return r;
            		}
...
HXLINE( 531)			Float _hx_tmp1 = this->textField->get_textWidth();
HXDLIN( 531)			if ((_hx_tmp1 <= this->textField->get_width())) {
...
HXLINE( 536)					Float X2 = (X - this->textField->get_width());
HXDLIN( 536)					X = (X2 + this->textField->get_textWidth());
...
HXDLIN( 551)				if ((X >= r->x)) {
HXLINE( 551)					_hx_tmp2 = (X <= (r->x + r->width));
            				}
            				else {
...
HXLINE( 560)			_hx_tmp3 = (this->_charBoundaries->length > 0);
            		}
            		else {
...
HXLINE( 588)		{
HXLINE( 588)			int _g2 = 0;
HXDLIN( 588)			int _g3 = numChars;
HXDLIN( 588)			while((_g2 < _g3)){
HXLINE( 588)				_g2 = (_g2 + 1);
HXDLIN( 588)				int i1 = (_g2 - 1);
HXLINE( 590)				if (((this->_charBoundaries->length - 1) < i1)) {
...
HXLINE( 622)				Float _hx_tmp2 = boundary->get_left();
HXDLIN( 622)				if ((_hx_tmp2 < this->lastScroll)) {
...
HXLINE( 666)				 ::flixel::FlxSprite _hx_tmp5 = this->backgroundSprite;
HXDLIN( 666)				int _hx_tmp6 = ::Std_obj::_hx_int(this->get_width());
HXDLIN( 666)				int _hx_tmp7 = ::Std_obj::_hx_int(this->get_height());
HXDLIN( 666)				_hx_tmp5->makeGraphic(_hx_tmp6,_hx_tmp7,this->backgroundColor,null(),null());
...
HXLINE( 695)					 ::flixel::math::FlxPoint _hx_tmp8 = this->caret->offset;
HXDLIN( 695)					_hx_tmp8->set_x(this->caret->offset->set_y(( (Float)(0) )));
            				}
            				break;
            				case (int)1: {
...
HXLINE( 706)					 ::flixel::math::FlxPoint _hx_tmp9 = this->caret->offset;
HXDLIN( 706)					_hx_tmp9->set_x(this->caret->offset->set_y(( (Float)(0) )));
            				}
            				break;
...
HXLINE( 713)					Float r4 = this->borderSize;
HXDLIN( 713)					Float r5 = this->borderSize;
HXDLIN( 713)					int r6 = this->caretWidth;
HXDLIN( 713)					 ::openfl::geom::Rectangle r7 =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,r4,r5,r6,::Std_obj::_hx_int(( (Float)((::Std_obj::_hx_int(( (Float)(this->_defaultFormat->size) )) + 2)) )));
HXLINE( 714)					this->caret->get_pixels()->fillRect(r7,caretC);
HXLINE( 716)					 ::flixel::math::FlxPoint _hx_tmp10 = this->caret->offset;
HXDLIN( 716)					_hx_tmp10->set_x(this->caret->offset->set_y(this->borderSize));
            				}
            				break;
            			}
...
HXLINE( 859)			goto _hx_goto_31;
            		...
            		if (  (_hx_switch_0==HX_("right",dc,0b,64,e9)) ){
HXLINE( 855)			Float offx3 = (this->textField->get_width() - ( (Float)(2) ));
HXDLIN( 855)			offx = ((offx3 - this->textField->get_textWidth()) - ( (Float)(2) ));
...
HXLINE( 899)					 ::flixel::FlxSprite _hx_tmp4 = this->caret;
HXDLIN( 899)					Float _hx_tmp5 = (offx + boundaries->get_right());
HXDLIN( 899)					_hx_tmp4->set_x((_hx_tmp5 + this->x));
HXLINE( 900)					 ::flixel::FlxSprite _hx_tmp6 = this->caret;
HXDLIN( 900)					Float _hx_tmp7 = boundaries->get_top();
HXDLIN( 900)					_hx_tmp6->set_y((_hx_tmp7 + this->y));
            				}
            				else {
...
HXLINE( 917)		bool _hx_tmp8;
HXDLIN( 917)		if ((this->lines == 1)) {
HXLINE( 917)			Float _hx_tmp9 = this->caret->x;
HXDLIN( 917)			Float _hx_tmp10 = (_hx_tmp9 + this->caret->get_width());
HXDLIN( 917)			Float _hx_tmp11 = this->x;
HXDLIN( 917)			_hx_tmp8 = (_hx_tmp10 > (_hx_tmp11 + this->get_width()));
            		}
            		else {
HXLINE( 917)			_hx_tmp8 = false;
            		}
HXDLIN( 917)		if (_hx_tmp8) {
HXLINE( 919)			 ::flixel::FlxSprite _hx_tmp12 = this->caret;
HXDLIN( 919)			Float _hx_tmp13 = this->x;
HXDLIN( 919)			_hx_tmp12->set_x(((_hx_tmp13 + this->get_width()) - ( (Float)(2) )));
            		}
