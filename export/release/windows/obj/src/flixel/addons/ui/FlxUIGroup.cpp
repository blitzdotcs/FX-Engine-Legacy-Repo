...
HXLINE( 104)								Float flui2 = flui->x;
HXDLIN( 104)								right = (flui2 + flui->get_width());
            							}
HXLINE( 106)							if ((flui->y < top)) {
HXLINE( 108)								top = flui->y;
            							}
HXLINE( 110)							Float flui3 = flui->y;
HXDLIN( 110)							if (((flui3 + flui->get_height()) > bottom)) {
HXLINE( 112)								Float flui4 = flui->y;
HXDLIN( 112)								bottom = (flui4 + flui->get_height());
            							}
            						}
            						else {
