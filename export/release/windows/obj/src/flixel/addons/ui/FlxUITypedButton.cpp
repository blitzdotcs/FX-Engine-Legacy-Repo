...
HXDLIN( 217)			int _hx_tmp1 = ( (int)(other->get_width()) );
HXDLIN( 217)			this->loadGraphic(other1,true,_hx_tmp1,( (int)(other->get_height()) ),null(),null());
            		}
            		else {
HXLINE( 221)			Float _hx_tmp2 = other->get_width();
HXDLIN( 221)			this->resize(_hx_tmp2,other->get_height());
            		}
            	}
...
HXLINE( 327)			 ::flixel::FlxSprite _hx_tmp3 = this->toggle_label;
HXDLIN( 327)			_hx_tmp3->set_cameras(this->get_cameras());
...
HXLINE( 376)						int upB2 = ::Std_obj::_hx_int(W);
HXDLIN( 376)						upB =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,upB2,::Std_obj::_hx_int((H * ( (Float)(6) ))),true,0);
            					}
HXLINE( 378)					this->loadGraphicsUpOverDown(upB,null(),null());
            				}
            				else {
HXLINE( 383)					int _hx_tmp3 = ::Std_obj::_hx_int(W);
HXDLIN( 383)					int _hx_tmp4 = ::Std_obj::_hx_int(H);
HXDLIN( 383)					this->loadGraphicSlice9(null(),_hx_tmp3,_hx_tmp4,null(),this->tile,null(),null(),null(),null(),null());
            				}
            			}
            		}
HXLINE( 388)		bool _hx_tmp5;
HXDLIN( 388)		if (::hx::IsNotNull( this->label )) {
HXLINE( 388)			_hx_tmp5 = this->autoResizeLabel;
            		}
            		else {
...
HXLINE( 489)					 ::openfl::display::BitmapData pixels3 = this->combineToggleBitmaps(pixels_normal2,pixels_toggle2);
HXLINE( 490)					this->loadGraphicsUpOverDown(pixels3,true,key);
...
HXLINE( 716)				_hx_tmp1 = (this->_src_h == 0);
            			}
            			else {
...
HXDLIN( 742)					int _g3 = arr_bmpData->length;
HXDLIN( 742)					while((_g2 < _g3)){
HXLINE( 742)						_g2 = (_g2 + 1);
HXDLIN( 742)						int i1 = (_g2 - 1);
HXLINE( 744)						arr_bmpData[i1] = this->grabButtonFrame(all,i1,this->has_toggle,this->_src_w,this->_src_h,midKey);
            					}
            				}
HXLINE( 747)				bool _hx_tmp2;
HXDLIN( 747)				if (::hx::IsNotNull( slice9 )) {
HXLINE( 747)					_hx_tmp2 = ::hx::IsPointerNotEq( slice9->__get(0).StaticCast< ::Array< int > >(),::Array_obj< int >::__new(0) );
            				}
            				else {
...
HXLINE( 752)					{
HXLINE( 752)						int _g4 = 0;
HXDLIN( 752)						int _g5 = arr_bmpData->length;
HXDLIN( 752)						while((_g4 < _g5)){
HXLINE( 752)							_g4 = (_g4 + 1);
HXDLIN( 752)							int i2 = (_g4 - 1);
HXLINE( 754)							arr_flx9[i2] =  ::flixel::addons::ui::FlxUI9SliceSprite_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),arr_bmpData->__get(i2).StaticCast<  ::openfl::display::BitmapData >(),this->_flashRect2,slice9->__get(0).StaticCast< ::Array< int > >(),this->tile,false,((assets->__get(0) + HX_(":",3a,00,00,00)) + i2),this->resize_ratio,null(),null(),null(),null());
HXLINE( 755)							arr_flx9->__get(i2).StaticCast<  ::flixel::addons::ui::FlxUISprite >()->set_resize_point(this->resize_point);
            						}
            					}
HXLINE( 759)					{
HXLINE( 759)						int _g6 = 0;
HXDLIN( 759)						int _g7 = arr_bmpData->length;
HXDLIN( 759)						while((_g6 < _g7)){
HXLINE( 759)							_g6 = (_g6 + 1);
HXDLIN( 759)							int i3 = (_g6 - 1);
HXLINE( 761)							arr_bmpData[i3] = arr_flx9->__get(i3).StaticCast<  ::flixel::addons::ui::FlxUISprite >()->get_pixels();
            						}
            					}
...
HXDLIN( 808)				bool _hx_tmp4;
HXDLIN( 808)				bool _hx_tmp5;
HXDLIN( 808)				if (::hx::IsNotNull( slice9 )) {
HXLINE( 808)					_hx_tmp5 = (slice9->length > 0);
            				}
            				else {
HXLINE( 808)					_hx_tmp5 = false;
            				}
HXDLIN( 808)				if (_hx_tmp5) {
HXLINE( 808)					_hx_tmp4 = ::hx::IsNotNull( slice9->__get(0).StaticCast< ::Array< int > >() );
            				}
            				else {
HXLINE( 808)					_hx_tmp4 = false;
            				}
HXDLIN( 808)				if (_hx_tmp4) {
HXLINE( 808)					_hx_tmp3 = (slice9->__get(0).StaticCast< ::Array< int > >()->length > 0);
            				}
            				else {
...
HXLINE( 828)					{
HXLINE( 828)						int _g8 = 1;
HXDLIN( 828)						int _g9 = assets->get_length();
HXDLIN( 828)						while((_g8 < _g9)){
HXLINE( 828)							_g8 = (_g8 + 1);
HXDLIN( 828)							int i4 = (_g8 - 1);
HXLINE( 830)							if (::hx::IsNotEq( assets->__get(i4),HX_("",00,00,00,00) )) {
HXLINE( 832)								if (::hx::IsNotNull( slice9->__get(i4).StaticCast< ::Array< int > >() )) {
HXLINE( 834)									arr_flx9[i4] =  ::flixel::addons::ui::FlxUI9SliceSprite_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),assets->__get(i4),this->_flashRect2,slice9->__get(i4).StaticCast< ::Array< int > >(),this->tile,false,HX_("",00,00,00,00),this->resize_ratio,null(),null(),null(),null());
            								}
            								else {
HXLINE( 838)									arr_flx9[i4] =  ::flixel::addons::ui::FlxUISprite_obj::__alloc( HX_CTX ,0,0,assets->__get(i4));
            								}
HXLINE( 840)								arr_bmpData[i4] = arr_flx9->__get(i4).StaticCast<  ::flixel::addons::ui::FlxUISprite >()->get_pixels();
            							}
            						}
            					}
...
HXLINE( 851)					{
HXLINE( 851)						int _g10 = 0;
HXDLIN( 851)						int _g11 = assets->get_length();
HXDLIN( 851)						while((_g10 < _g11)){
HXLINE( 851)							_g10 = (_g10 + 1);
HXDLIN( 851)							int i5 = (_g10 - 1);
HXLINE( 853)							arr_bmpData[i5] = this->getBmp(assets->__get(i5));
            						}
            					}
...
HXLINE( 888)			 ::openfl::display::BitmapData normalPixels1 = this->assembleButtonFrames(arr_bmpData->__get(frame_indeces->__get(0)).StaticCast<  ::openfl::display::BitmapData >(),arr_bmpData->__get(frame_indeces->__get(1)).StaticCast<  ::openfl::display::BitmapData >(),arr_bmpData->__get(frame_indeces->__get(2)).StaticCast<  ::openfl::display::BitmapData >());
...
HXLINE( 892)			 ::openfl::display::BitmapData combinedPixels = this->combineToggleBitmaps(normalPixels1,togglePixels);
HXLINE( 895)			normalPixels1 = ::flixel::util::FlxDestroyUtil_obj::dispose(normalPixels1);
...
HXLINE( 903)		{
HXLINE( 903)			int _g12 = 0;
HXDLIN( 903)			int _g13 = arr_flx9->length;
HXDLIN( 903)			while((_g12 < _g13)){
HXLINE( 903)				_g12 = (_g12 + 1);
HXDLIN( 903)				int i6 = (_g12 - 1);
HXLINE( 905)				if (::hx::IsNotNull( arr_flx9->__get(i6).StaticCast<  ::flixel::addons::ui::FlxUISprite >() )) {
HXLINE( 907)					arr_flx9->__get(i6).StaticCast<  ::flixel::addons::ui::FlxUISprite >()->destroy();
HXLINE( 908)					arr_flx9[i6] = null();
            				}
            			}
            		}
...
HXLINE( 938)				Float offX2 = this->get_width();
HXDLIN( 938)				offX = ((offX2 - tlabel->get_fieldWidth()) / ( (Float)(2) ));
HXLINE( 939)				Float offY1 = this->get_height();
HXDLIN( 939)				offY = ((offY1 - tlabel->get_height()) / ( (Float)(2) ));
            			}
            			else {
HXLINE( 943)				Float offX3 = this->get_width();
HXDLIN( 943)				offX = ((offX3 - this->_spriteLabel->get_width()) / ( (Float)(2) ));
HXLINE( 944)				Float offY2 = this->get_height();
HXDLIN( 944)				offY = ((offY2 - this->_spriteLabel->get_height()) / ( (Float)(2) ));
            			}
...
HXLINE(1260)			bool _hx_tmp1;
HXDLIN(1260)			if (this->has_toggle) {
HXLINE(1260)				_hx_tmp1 = ::hx::IsNotNull( this->toggle_label );
            			}
            			else {
...
HXLINE(1281)				_hx_tmp1 = ::hx::IsNotNull( this->toggle_label );
            			}
            			else {
