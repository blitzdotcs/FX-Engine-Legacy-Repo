...
HXLINE( 102)				_g1->onClick(i);
            			}
            			HX_END_LOCAL_FUNC0((void))

HXLINE( 102)			 ::flixel::addons::ui::FlxUIList _g1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 102)			int i = -1;
HXDLIN( 102)			 ::flixel::addons::ui::FlxUIButton pButton =  ::flixel::addons::ui::FlxUIButton_obj::__alloc( HX_CTX ,0,0,HX_(" ",20,00,00,00), ::Dynamic(new _hx_Closure_0(_g1,i)),null(),null(),null());
...
HXLINE( 115)				 ::flixel::addons::ui::FlxUIText pButton3 = ( ( ::flixel::addons::ui::FlxUIText)(pButton->label) );
HXDLIN( 115)				pButton3->set_width(( ( ::flixel::text::FlxText)(pButton->label) )->set_fieldWidth(( (Float)(100) )));
HXLINE( 116)				 ::flixel::addons::ui::FlxUIText pButton4 = ( ( ::flixel::addons::ui::FlxUIText)(pButton->label) );
HXDLIN( 116)				pButton4->set_text(this->getMoreString(0));
HXLINE( 117)				pButton->setAllLabelOffsets(( (Float)(0) ),( (Float)(0) ));
HXLINE( 118)				Float _hx_tmp2 = (pButton->get_width() + 2);
HXDLIN( 118)				Float _hx_tmp3 = pButton->get_height();
HXDLIN( 118)				pButton->setCenterLabelOffset(_hx_tmp2,(_hx_tmp3 - ( ( ::flixel::text::FlxText)(pButton->label) )->get_height()));
...
HXLINE( 128)					_g2->onClick(i1);
            				}
            				HX_END_LOCAL_FUNC0((void))

HXLINE( 127)				 ::flixel::addons::ui::FlxUIButton fuib = ( ( ::flixel::addons::ui::FlxUIButton)(this->prevButton) );
HXLINE( 128)				 ::flixel::addons::ui::FlxUIList _g2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 128)				int i1 = -1;
HXDLIN( 128)				 ::Dynamic _hx_tmp4 =  ::Dynamic(new _hx_Closure_1(_g2,i1));
HXDLIN( 128)				fuib->onUp->callback = _hx_tmp4;
            			}
...
HXLINE( 133)					_g3->onClick(i2);
            				}
            				HX_END_LOCAL_FUNC0((void))

HXLINE( 132)				 ::flixel::addons::ui::FlxUISpriteButton fusb = ( ( ::flixel::addons::ui::FlxUISpriteButton)(this->prevButton) );
HXLINE( 133)				 ::flixel::addons::ui::FlxUIList _g3 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 133)				int i2 = -1;
HXDLIN( 133)				 ::Dynamic _hx_tmp5 =  ::Dynamic(new _hx_Closure_2(_g3,i2));
HXDLIN( 133)				fusb->onUp->callback = _hx_tmp5;
            			}
            		}
...
HXLINE( 139)				_g4->onClick(i3);
            			}
            			HX_END_LOCAL_FUNC0((void))

HXLINE( 139)			 ::flixel::addons::ui::FlxUIList _g4 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 139)			int i3 = 1;
HXDLIN( 139)			 ::flixel::addons::ui::FlxUIButton nButton =  ::flixel::addons::ui::FlxUIButton_obj::__alloc( HX_CTX ,0,0,HX_(" ",20,00,00,00), ::Dynamic(new _hx_Closure_3(_g4,i3)),null(),null(),null());
...
HXLINE( 151)				 ::flixel::addons::ui::FlxUIText nButton3 = ( ( ::flixel::addons::ui::FlxUIText)(nButton->label) );
HXDLIN( 151)				nButton3->set_width(( ( ::flixel::text::FlxText)(nButton->label) )->set_fieldWidth(( (Float)(100) )));
HXLINE( 152)				 ::flixel::addons::ui::FlxUIText nButton4 = ( ( ::flixel::addons::ui::FlxUIText)(nButton->label) );
HXDLIN( 152)				nButton4->set_text(this->getMoreString(0));
...
HXLINE( 164)					_g5->onClick(i4);
            				}
            				HX_END_LOCAL_FUNC0((void))

HXLINE( 163)				 ::flixel::addons::ui::FlxUIButton fuib1 = ( ( ::flixel::addons::ui::FlxUIButton)(this->nextButton) );
HXLINE( 164)				 ::flixel::addons::ui::FlxUIList _g5 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 164)				int i4 = 1;
HXDLIN( 164)				 ::Dynamic _hx_tmp6 =  ::Dynamic(new _hx_Closure_4(i4,_g5));
HXDLIN( 164)				fuib1->onUp->callback = _hx_tmp6;
            			}
...
HXLINE( 169)					_g6->onClick(i5);
            				}
            				HX_END_LOCAL_FUNC0((void))

HXLINE( 168)				 ::flixel::addons::ui::FlxUISpriteButton fusb1 = ( ( ::flixel::addons::ui::FlxUISpriteButton)(this->nextButton) );
HXLINE( 169)				 ::flixel::addons::ui::FlxUIList _g6 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 169)				int i5 = 1;
HXDLIN( 169)				 ::Dynamic _hx_tmp7 =  ::Dynamic(new _hx_Closure_5(_g6,i5));
HXDLIN( 169)				fusb1->onUp->callback = _hx_tmp7;
            			}
            		}
...
HXLINE( 179)			 ::flixel::math::FlxPoint point1 = ::flixel::math::FlxPoint_obj::_pool->get()->set(0,0);
HXDLIN( 179)			point1->_inPool = false;
HXDLIN( 179)			this->nextButtonOffset = point1;
            		}
...
HXLINE( 285)			::Dynamic _hx_tmp4 = this->prevButton;
HXDLIN( 285)			Float _hx_tmp5 = this->prevButtonOffset->y;
HXDLIN( 285)			::flixel::IFlxSprite_obj::set_y(_hx_tmp4,((_hx_tmp5 - ::flixel::addons::ui::interfaces::IFlxUIWidget_obj::get_height(this->prevButton)) - ( (Float)(2) )));
HXLINE( 286)			::flixel::IFlxSprite_obj::set_x(this->nextButton,this->nextButtonOffset->x);
HXLINE( 287)			::Dynamic _hx_tmp6 = this->nextButton;
HXDLIN( 287)			Float _hx_tmp7 = this->nextButtonOffset->y;
HXDLIN( 287)			::flixel::IFlxSprite_obj::set_y(_hx_tmp6,((_hx_tmp7 + this->get_height()) + 2));
            		}
HXLINE( 290)		::Dynamic _hx_tmp8 = this->prevButton;
HXDLIN( 290)		::flixel::IFlxSprite_obj::set_x(_hx_tmp8,::Std_obj::_hx_int(( (Float)(this->prevButton->__Field(HX_("x",78,00,00,00),::hx::paccDynamic)) )));
HXLINE( 291)		::Dynamic _hx_tmp9 = this->prevButton;
HXDLIN( 291)		::flixel::IFlxSprite_obj::set_y(_hx_tmp9,::Std_obj::_hx_int(( (Float)(this->prevButton->__Field(HX_("y",79,00,00,00),::hx::paccDynamic)) )));
HXLINE( 292)		::Dynamic _hx_tmp10 = this->nextButton;
HXDLIN( 292)		::flixel::IFlxSprite_obj::set_x(_hx_tmp10,::Std_obj::_hx_int(( (Float)(this->nextButton->__Field(HX_("x",78,00,00,00),::hx::paccDynamic)) )));
HXLINE( 293)		::Dynamic _hx_tmp11 = this->nextButton;
HXDLIN( 293)		::flixel::IFlxSprite_obj::set_y(_hx_tmp11,::Std_obj::_hx_int(( (Float)(this->nextButton->__Field(HX_("y",79,00,00,00),::hx::paccDynamic)) )));
...
HXLINE( 308)						Float inBounds2 = (XX + widget->get_width());
HXDLIN( 308)						if (!((inBounds2 <= this->get_width()))) {
...
HXLINE( 354)				 ::flixel::addons::ui::FlxUIText fuibutton2 = ( ( ::flixel::addons::ui::FlxUIText)(fuibutton->label) );
HXDLIN( 354)				fuibutton2->set_text(this->getMoreString(this->amountNext));
            			}
            		}
            	}
