...
HXDLIN( 100)			_hx_tmp3->set_x(( (Float)(::Std_obj::_hx_int(( ( ::flixel::math::FlxPoint)(this->style->__Field(HX_("titleOffset",4b,63,cb,f6),::hx::paccDynamic)) )->x)) ));
HXLINE( 101)			 ::flixel::addons::ui::FlxUIText _hx_tmp4 = this->_titleText;
HXDLIN( 101)			_hx_tmp4->set_y(( (Float)(::Std_obj::_hx_int(( ( ::flixel::math::FlxPoint)(this->style->__Field(HX_("titleOffset",4b,63,cb,f6),::hx::paccDynamic)) )->y)) ));
            		}
...
HXDLIN( 105)			_hx_tmp5->set_x(( (Float)(::Std_obj::_hx_int(( ( ::flixel::math::FlxPoint)(this->style->__Field(HX_("bodyOffset",d5,2b,5c,a7),::hx::paccDynamic)) )->x)) ));
HXLINE( 106)			 ::flixel::addons::ui::FlxUIText _hx_tmp6 = this->_bodyText;
HXDLIN( 106)			_hx_tmp6->set_y(( (Float)(::Std_obj::_hx_int(((this->_titleText->y + titleHeight) + ( ( ::flixel::math::FlxPoint)(this->style->__Field(HX_("bodyOffset",d5,2b,5c,a7),::hx::paccDynamic)) )->y))) ));
            		}
