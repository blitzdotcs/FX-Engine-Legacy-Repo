...
HXLINE( 215)				int _hx_tmp2 = (sx + ::Std_obj::_hx_int(this->labelOffsets->__get(_hx_tmp1).StaticCast<  ::flixel::math::FlxPoint >()->x));
...
HXLINE( 215)				this->stamp(icon,_hx_tmp2,(_hx_tmp3 + ::Std_obj::_hx_int(this->labelOffsets->__get(_hx_tmp4).StaticCast<  ::flixel::math::FlxPoint >()->y)));
            			}
            		}
            	}
