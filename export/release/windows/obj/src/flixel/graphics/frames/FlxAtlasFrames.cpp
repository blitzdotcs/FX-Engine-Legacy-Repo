...
HXLINE(  80)			int _g2 = 0;
HXDLIN(  80)			::Array< ::String > _g3 = ::Reflect_obj::fields( ::Dynamic(data->__Field(HX_("frames",a6,af,85,ac),::hx::paccDynamic)));
HXDLIN(  80)			while((_g2 < _g3->length)){
HXLINE(  80)				::String frameName = _g3->__get(_g2);
HXDLIN(  80)				_g2 = (_g2 + 1);
