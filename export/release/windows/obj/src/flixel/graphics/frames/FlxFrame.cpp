...
HXLINE( 108)		this->blitMatrix = ::Array_obj< Float >::__new(6);
HXLINE( 109)		if (::flixel::FlxG_obj::renderTile) {
HXLINE( 110)			this->tileMatrix = ::Array_obj< Float >::__new(6);
            		}
            	}
...
HXDLIN( 479)			_this2->set_x((_this2->x - rect->x));
HXDLIN( 479)			_this2->set_y((_this2->y - Y));
