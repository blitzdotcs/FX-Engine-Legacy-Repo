...
HXDLIN(  71)				::cpp::VirtualArray _g_args = ::cpp::VirtualArray_obj::__new(0);
...
HXDLIN(  72)			this2->__SetField(HX_("__tempIndex",3e,e8,54,22),0,::hx::paccDynamic);
HXDLIN(  72)			{
HXLINE(  72)				int _g_current1 = 0;
HXDLIN(  72)				::cpp::VirtualArray _g_args1 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(  72)				while((_g_current1 < _g_args1->get_length())){
HXLINE(  72)					_g_current1 = (_g_current1 + 1);
HXDLIN(  72)					 ::Dynamic item1 = _g_args1->__get((_g_current1 - 1));
HXDLIN(  72)					( ( ::openfl::_Vector::IntVector)(this2) )->insertAt(( (int)(this2->__Field(HX_("__tempIndex",3e,e8,54,22),::hx::paccDynamic)) ),( (int)(item1) ));
HXDLIN(  72)					::hx::FieldRef((this2).mPtr,HX_("__tempIndex",3e,e8,54,22))++;
            				}
            			}
HXDLIN(  72)			( ( ::openfl::_Vector::IntVector)(this2) )->splice(( (int)(this2->__Field(HX_("__tempIndex",3e,e8,54,22),::hx::paccDynamic)) ),deleteCount1);
            		}
HXLINE(  73)		{
HXLINE(  73)			::Dynamic this3 = this->uvtData;
HXDLIN(  73)			int deleteCount2 = this->uvtData->get_length();
HXDLIN(  73)			this3->__SetField(HX_("__tempIndex",3e,e8,54,22),0,::hx::paccDynamic);
HXDLIN(  73)			{
HXLINE(  73)				int _g_current2 = 0;
HXDLIN(  73)				::cpp::VirtualArray _g_args2 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(  73)				while((_g_current2 < _g_args2->get_length())){
HXLINE(  73)					_g_current2 = (_g_current2 + 1);
HXDLIN(  73)					 ::Dynamic item2 = _g_args2->__get((_g_current2 - 1));
HXDLIN(  73)					( ( ::openfl::_Vector::FloatVector)(this3) )->insertAt(( (int)(this3->__Field(HX_("__tempIndex",3e,e8,54,22),::hx::paccDynamic)) ),( (Float)(item2) ));
HXDLIN(  73)					::hx::FieldRef((this3).mPtr,HX_("__tempIndex",3e,e8,54,22))++;
            				}
            			}
HXDLIN(  73)			( ( ::openfl::_Vector::FloatVector)(this3) )->splice(( (int)(this3->__Field(HX_("__tempIndex",3e,e8,54,22),::hx::paccDynamic)) ),deleteCount2);
            		}
HXLINE(  74)		{
HXLINE(  74)			::Dynamic this4 = this->colors;
HXDLIN(  74)			int deleteCount3 = this->colors->get_length();
HXDLIN(  74)			this4->__SetField(HX_("__tempIndex",3e,e8,54,22),0,::hx::paccDynamic);
HXDLIN(  74)			{
HXLINE(  74)				int _g_current3 = 0;
HXDLIN(  74)				::cpp::VirtualArray _g_args3 = ::cpp::VirtualArray_obj::__new(0);
HXDLIN(  74)				while((_g_current3 < _g_args3->get_length())){
HXLINE(  74)					_g_current3 = (_g_current3 + 1);
HXDLIN(  74)					 ::Dynamic item3 = _g_args3->__get((_g_current3 - 1));
HXDLIN(  74)					( ( ::openfl::_Vector::IntVector)(this4) )->insertAt(( (int)(this4->__Field(HX_("__tempIndex",3e,e8,54,22),::hx::paccDynamic)) ),( (int)(item3) ));
HXDLIN(  74)					::hx::FieldRef((this4).mPtr,HX_("__tempIndex",3e,e8,54,22))++;
            				}
            			}
HXDLIN(  74)			( ( ::openfl::_Vector::IntVector)(this4) )->splice(( (int)(this4->__Field(HX_("__tempIndex",3e,e8,54,22),::hx::paccDynamic)) ),deleteCount3);
            		}
...
HXDLIN( 135)				::cpp::VirtualArray _g_args = ::cpp::VirtualArray_obj::__new(0);
