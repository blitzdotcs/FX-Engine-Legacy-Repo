...
HXDLIN( 100)		return  ::flixel::math::FlxPoint_obj::__alloc( HX_CTX ,x,y);
            	}
...
HXDLIN( 690)					_this1->set_x((_this1->x - b->x));
HXDLIN( 690)					_this1->set_y((_this1->y - b->y));
            				}
...
HXDLIN(  15)		_vector1 =  ::flixel::math::FlxPoint_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ));
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_5cc336e8df399df1_16_boot)
HXDLIN(  16)		_vector2 =  ::flixel::math::FlxPoint_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ));
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_5cc336e8df399df1_17_boot)
HXDLIN(  17)		_vector3 =  ::flixel::math::FlxPoint_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ));
            	}
}
