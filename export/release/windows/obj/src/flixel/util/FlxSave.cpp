...
HXLINE(  78)			this->_sharedObject = ::openfl::net::SharedObject_obj::getLocal(this->name,this->path,null());
            			...
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic _g = _hx_e;
HXLINE(  76)				if (::Std_obj::isOfType(::haxe::Exception_obj::caught(_g),::hx::ClassOf< ::openfl::errors::Error >())) {
...
HXLINE( 122)			result = this->_sharedObject->flush(null());
            			...
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
            				 ::Dynamic _g = _hx_e;
HXLINE( 120)				if (::Std_obj::isOfType(::haxe::Exception_obj::caught(_g),::hx::ClassOf< ::openfl::errors::Error >())) {
