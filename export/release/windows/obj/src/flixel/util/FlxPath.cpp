...
HXDLIN( 349)				_this1->set_x((_this1->x + X1));
HXDLIN( 349)				_this1->set_y((_this1->y + Y1));
            			}
...
HXLINE( 432)						 ::flixel::FlxObject fh2 = this->object;
HXDLIN( 432)						Float fh3 = fh2->y;
HXDLIN( 432)						fh2->set_y((fh3 - (this->object->get_height() * ((Float)0.5))));
            					}
            				}
            			}
            		}
