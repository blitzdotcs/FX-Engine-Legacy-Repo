...
HXLINE(1073)			int _hx_tmp = ::flixel::FlxG_obj::width;
HXDLIN(1073)			this->set_x(((( (Float)(_hx_tmp) ) - this->get_width()) / ( (Float)(2) )));
            		}
HXLINE(1075)		bool _hx_tmp1;
...
HXLINE(1075)				_hx_tmp1 = true;
            			...
            			break;
            			default:{
HXLINE(1075)				_hx_tmp1 = false;
            			}
            		}
HXDLIN(1075)		if (_hx_tmp1) {
HXLINE(1076)			int _hx_tmp = ::flixel::FlxG_obj::height;
HXDLIN(1076)			this->set_y(((( (Float)(_hx_tmp) ) - this->get_height()) / ( (Float)(2) )));
            		}
...
HXLINE(1189)			 ::flixel::math::FlxRect _this = this->_rect;
HXDLIN(1189)			_this->x = ( (Float)(::Math_obj::floor(_this->x)) );
HXDLIN(1189)			_this->y = ( (Float)(::Math_obj::floor(_this->y)) );
HXDLIN(1189)			_this->width = ( (Float)(::Math_obj::floor(_this->width)) );
HXDLIN(1189)			_this->height = ( (Float)(::Math_obj::floor(_this->height)) );
            		}
