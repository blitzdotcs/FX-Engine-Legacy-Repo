...
HXDLIN( 722)			_this1->set_x((_this1->x + this->origin->x));
HXDLIN( 722)			_this1->set_y((_this1->y + Y));
            		}
...
HXDLIN(1280)		if (::hx::IsInstanceNotEq( this->graphic,Value )) {
...
HXLINE(1282)			Value->set_useCount((Value->get_useCount() + 1));
            		}
HXLINE(1285)		bool _hx_tmp1;
HXDLIN(1285)		if (::hx::IsNotNull( oldGraphic )) {
HXLINE(1285)			_hx_tmp1 = ::hx::IsInstanceNotEq( oldGraphic,Value );
            		}
            		else {
HXLINE(1285)			_hx_tmp1 = false;
            		}
HXDLIN(1285)		if (_hx_tmp1) {
HXLINE(1287)			oldGraphic->set_useCount((oldGraphic->get_useCount() - 1));
            		}
