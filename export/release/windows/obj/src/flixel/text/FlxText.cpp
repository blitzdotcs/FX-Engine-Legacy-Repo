...
HXLINE( 332)		{
HXLINE( 332)			int _g3 = 0;
HXDLIN( 332)			while((_g3 < rules->length)){
HXLINE( 332)				 ::flixel::text::FlxTextFormatMarkerPair rule1 = rules->__get(_g3).StaticCast<  ::flixel::text::FlxTextFormatMarkerPair >();
HXDLIN( 332)				_g3 = (_g3 + 1);
HXLINE( 333)				input = ::StringTools_obj::replace(input,rule1->marker,HX_("",00,00,00,00));
            			}
            		}
HXLINE( 336)		{
HXLINE( 336)			int _g4 = 0;
HXDLIN( 336)			int _g5 = rangeStarts->length;
HXDLIN( 336)			while((_g4 < _g5)){
HXLINE( 336)				_g4 = (_g4 + 1);
HXDLIN( 336)				int i1 = (_g4 - 1);
...
HXLINE( 343)				{
HXLINE( 343)					int _g6 = 0;
HXDLIN( 343)					int _g7 = rangeStarts->length;
HXDLIN( 343)					while((_g6 < _g7)){
HXLINE( 343)						_g6 = (_g6 + 1);
HXDLIN( 343)						int j = (_g6 - 1);
...
HXLINE( 359)				{
HXLINE( 359)					int _g8 = 0;
HXDLIN( 359)					int _g9 = rangeStarts->length;
HXDLIN( 359)					while((_g8 < _g9)){
HXLINE( 359)						_g8 = (_g8 + 1);
HXDLIN( 359)						int j3 = (_g8 - 1);
...
HXLINE( 376)		{
HXLINE( 376)			int _g10 = 0;
HXDLIN( 376)			int _g11 = rangeStarts->length;
HXDLIN( 376)			while((_g10 < _g11)){
HXLINE( 376)				_g10 = (_g10 + 1);
HXDLIN( 376)				int i2 = (_g10 - 1);
...
HXLINE( 971)				{
HXLINE( 971)					int _g4 = 0;
HXDLIN( 971)					int _g5 = iterations;
HXDLIN( 971)					while((_g4 < _g5)){
HXLINE( 971)						_g4 = (_g4 + 1);
HXDLIN( 971)						int i2 = (_g4 - 1);
HXLINE( 973)						{
