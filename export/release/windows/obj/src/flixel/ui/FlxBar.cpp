...
HXLINE( 306)			HX_STACK_DO_THROW(HX_("FlxBar: max cannot be less than or equal to min",5b,e6,e7,51));
            		}
...
HXLINE( 358)				::String emptyKey6 = HX_("0x",48,2a,00,00);
HXDLIN( 358)				::String emptyKey7 = ::StringTools_obj::hex(((border >> 24) & 255),2);
HXDLIN( 358)				::String emptyKey8 = ((emptyKey6 + emptyKey7) + ::StringTools_obj::hex(((border >> 16) & 255),2));
HXDLIN( 358)				::String emptyKey9 = (emptyKey8 + ::StringTools_obj::hex(((border >> 8) & 255),2));
HXDLIN( 358)				emptyKey5 = (emptyKey5 + (HX_(",border: ",be,9e,76,9a) + (emptyKey9 + ::StringTools_obj::hex((border & 255),2))));
            			}
...
HXLINE( 411)				::String filledKey6 = HX_("0x",48,2a,00,00);
HXDLIN( 411)				::String filledKey7 = ::StringTools_obj::hex(((border >> 24) & 255),2);
HXDLIN( 411)				::String filledKey8 = ((filledKey6 + filledKey7) + ::StringTools_obj::hex(((border >> 16) & 255),2));
HXDLIN( 411)				::String filledKey9 = (filledKey8 + ::StringTools_obj::hex(((border >> 8) & 255),2));
HXDLIN( 411)				filledKey5 = (filledKey5 + (HX_(",border: ",be,9e,76,9a) + (filledKey9 + ::StringTools_obj::hex((border & 255),2))));
            			}
...
HXLINE( 494)				::String emptyKey5 = HX_("0x",48,2a,00,00);
HXDLIN( 494)				::String emptyKey6 = ::StringTools_obj::hex(((border >> 24) & 255),2);
HXDLIN( 494)				::String emptyKey7 = ((emptyKey5 + emptyKey6) + ::StringTools_obj::hex(((border >> 16) & 255),2));
HXDLIN( 494)				::String emptyKey8 = (emptyKey7 + ::StringTools_obj::hex(((border >> 8) & 255),2));
HXDLIN( 494)				emptyKey = (emptyKey + (HX_(",border: ",be,9e,76,9a) + (emptyKey8 + ::StringTools_obj::hex((border & 255),2))));
            			}
...
HXLINE( 559)				::String filledKey5 = HX_("0x",48,2a,00,00);
HXDLIN( 559)				::String filledKey6 = ::StringTools_obj::hex(((border >> 24) & 255),2);
HXDLIN( 559)				::String filledKey7 = ((filledKey5 + filledKey6) + ::StringTools_obj::hex(((border >> 16) & 255),2));
HXDLIN( 559)				::String filledKey8 = (filledKey7 + ::StringTools_obj::hex(((border >> 8) & 255),2));
HXDLIN( 559)				filledKey = (filledKey + (HX_(",border: ",be,9e,76,9a) + (filledKey8 + ::StringTools_obj::hex((border & 255),2))));
            			}
...
HXLINE( 856)					_hx_tmp2 = !(camera->exists);
            				}
            				else {
HXLINE( 856)					_hx_tmp2 = true;
            				}
HXDLIN( 856)				if (!(_hx_tmp2)) {
HXLINE( 856)					_hx_tmp1 = !(this->isOnScreen(camera));
            				}
            				else {
...
HXLINE( 873)				{
HXLINE( 873)					 ::flixel::math::FlxPoint _this1 = this->_point;
HXDLIN( 873)					Float Y = this->origin->y;
HXDLIN( 873)					_this1->set_x((_this1->x + this->origin->x));
HXDLIN( 873)					_this1->set_y((_this1->y + Y));
            				}
HXLINE( 874)				if (this->isPixelPerfectRender(camera)) {
HXLINE( 876)					 ::flixel::math::FlxPoint _this2 = this->_point;
HXDLIN( 876)					_this2->set_x(( (Float)(::Math_obj::floor(_this2->x)) ));
HXDLIN( 876)					_this2->set_y(( (Float)(::Math_obj::floor(_this2->y)) ));
            				}
