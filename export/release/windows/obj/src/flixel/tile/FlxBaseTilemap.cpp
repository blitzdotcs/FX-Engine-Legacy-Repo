...
HXLINE( 478)			::Array< int > base1 = this->_data;
HXDLIN( 478)			int Index2 = Index;
HXDLIN( 478)			base1[Index2] = (base1->__get(Index2) + 2);
            		}
...
HXLINE( 483)			::Array< int > base2 = this->_data;
HXDLIN( 483)			int Index3 = Index;
HXDLIN( 483)			base2[Index3] = (base2->__get(Index3) + 4);
            		}
...
HXLINE( 488)			::Array< int > base3 = this->_data;
HXDLIN( 488)			int Index4 = Index;
HXDLIN( 488)			base3[Index4] = (base3->__get(Index4) + 8);
            		}
...
HXDLIN( 495)			bool _hx_tmp7;
HXDLIN( 495)			if ((::hx::Mod(Index,this->widthInTiles) > 0)) {
HXLINE( 495)				int _hx_tmp8 = ::Std_obj::_hx_int(( (Float)((Index + this->widthInTiles)) ));
HXDLIN( 495)				_hx_tmp7 = (_hx_tmp8 < this->totalTiles);
            			}
            			else {
HXLINE( 495)				_hx_tmp7 = false;
            			}
HXDLIN( 495)			if (_hx_tmp7) {
HXLINE( 495)				_hx_tmp6 = (this->_data->__get(((Index + this->widthInTiles) - 1)) <= 0);
            			}
            			else {
...
HXDLIN( 500)			bool _hx_tmp10;
HXDLIN( 500)			if ((::hx::Mod(Index,this->widthInTiles) > 0)) {
HXLINE( 500)				_hx_tmp10 = ((Index - this->widthInTiles) >= 0);
            			}
            			else {
HXLINE( 500)				_hx_tmp10 = false;
            			}
HXDLIN( 500)			if (_hx_tmp10) {
HXLINE( 500)				_hx_tmp9 = (this->_data->__get(((Index - this->widthInTiles) - 1)) <= 0);
            			}
            			else {
HXLINE( 500)				_hx_tmp9 = false;
            			}
HXDLIN( 500)			if (_hx_tmp9) {
HXLINE( 502)				this->_data[Index] = 2;
            			}
HXLINE( 505)			bool _hx_tmp11;
HXDLIN( 505)			bool _hx_tmp12;
HXDLIN( 505)			if ((::hx::Mod(Index,this->widthInTiles) < (this->widthInTiles - 1))) {
HXLINE( 505)				_hx_tmp12 = ((Index - this->widthInTiles) >= 0);
            			}
            			else {
HXLINE( 505)				_hx_tmp12 = false;
            			}
HXDLIN( 505)			if (_hx_tmp12) {
HXLINE( 505)				_hx_tmp11 = (this->_data->__get(((Index - this->widthInTiles) + 1)) <= 0);
            			}
            			else {
HXLINE( 505)				_hx_tmp11 = false;
            			}
HXDLIN( 505)			if (_hx_tmp11) {
HXLINE( 507)				this->_data[Index] = 4;
            			}
HXLINE( 510)			bool _hx_tmp13;
HXDLIN( 510)			bool _hx_tmp14;
HXDLIN( 510)			if ((::hx::Mod(Index,this->widthInTiles) < (this->widthInTiles - 1))) {
HXLINE( 511)				int _hx_tmp15 = ::Std_obj::_hx_int(( (Float)((Index + this->widthInTiles)) ));
HXLINE( 510)				_hx_tmp14 = (_hx_tmp15 < this->totalTiles);
            			}
            			else {
HXLINE( 510)				_hx_tmp14 = false;
            			}
HXDLIN( 510)			if (_hx_tmp14) {
HXLINE( 510)				_hx_tmp13 = (this->_data->__get(((Index + this->widthInTiles) + 1)) <= 0);
            			}
            			else {
HXLINE( 510)				_hx_tmp13 = false;
            			}
HXDLIN( 510)			if (_hx_tmp13) {
HXLINE( 514)				this->_data[Index] = 8;
            			}
            		}
HXLINE( 518)		::Array< int > base4 = this->_data;
HXDLIN( 518)		int Index5 = Index;
HXDLIN( 518)		base4[Index5] = (base4->__get(Index5) + 1);
            	}
...
HXLINE( 547)			::Array< int > base1 = this->_data;
HXDLIN( 547)			int Index2 = Index;
HXDLIN( 547)			base1[Index2] = (base1->__get(Index2) + 2);
            		}
HXLINE( 548)		if (right) {
HXLINE( 549)			::Array< int > base2 = this->_data;
HXDLIN( 549)			int Index3 = Index;
HXDLIN( 549)			base2[Index3] = (base2->__get(Index3) + 4);
            		}
...
HXLINE( 551)			::Array< int > base3 = this->_data;
HXDLIN( 551)			int Index4 = Index;
HXDLIN( 551)			base3[Index4] = (base3->__get(Index4) + 8);
            		}
HXLINE( 552)		if (down) {
HXLINE( 553)			::Array< int > base4 = this->_data;
HXDLIN( 553)			int Index5 = Index;
HXDLIN( 553)			base4[Index5] = (base4->__get(Index5) + 16);
            		}
...
HXLINE( 555)			::Array< int > base5 = this->_data;
HXDLIN( 555)			int Index6 = Index;
HXDLIN( 555)			base5[Index6] = (base5->__get(Index6) + 32);
            		}
HXLINE( 556)		if (left) {
HXLINE( 557)			::Array< int > base6 = this->_data;
HXDLIN( 557)			int Index7 = Index;
HXDLIN( 557)			base6[Index7] = (base6->__get(Index7) + 64);
            		}
...
HXLINE( 559)			::Array< int > base7 = this->_data;
HXDLIN( 559)			int Index8 = Index;
HXDLIN( 559)			base7[Index8] = (base7->__get(Index8) + 128);
            		}
HXLINE( 561)		::Array< int > base8 = this->_data;
HXDLIN( 561)		int Index9 = Index;
HXDLIN( 561)		base8[Index9] = (base8->__get(Index9) - (::flixel::tile::FlxBaseTilemap_obj::offsetAutoTile->__get(this->_data->__get(Index)) - 1));
            	}
