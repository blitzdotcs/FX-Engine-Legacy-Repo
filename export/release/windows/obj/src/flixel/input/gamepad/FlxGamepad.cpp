...
HXDLIN( 773)		if (::hx::IsPointerNotEq( stick5->mode,::flixel::input::gamepad::FlxAnalogToDigitalMode_obj::ONLY_DIGITAL_dyn() )) {
HXLINE( 773)			_hx_tmp = ::hx::IsPointerEq( stick5->mode,::flixel::input::gamepad::FlxAnalogToDigitalMode_obj::BOTH_dyn() );
            		}
            		else {
...
HXLINE( 778)			bool _hx_tmp1 = ::hx::IsPointerEq( stick5->mode,::flixel::input::gamepad::FlxAnalogToDigitalMode_obj::ONLY_DIGITAL_dyn() );
            		}
            	}
