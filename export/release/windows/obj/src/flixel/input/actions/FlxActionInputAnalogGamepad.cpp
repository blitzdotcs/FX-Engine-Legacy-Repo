...
HXDLIN( 224)					this->updateValues(_hx_tmp,_this1->getYAxisRaw(_this1->mapping->getAnalogStick(19)));
            				...
            				break;
            				case (int)20: {
HXLINE( 227)					 ::flixel::input::gamepad::FlxGamepad _this2 = gamepad->analog->value->gamepad;
HXDLIN( 227)					Float _hx_tmp1 = _this2->getAnalogXAxisValue(_this2->mapping->getAnalogStick(20));
HXDLIN( 227)					 ::flixel::input::gamepad::FlxGamepad _this3 = gamepad->analog->value->gamepad;
HXDLIN( 227)					this->updateValues(_hx_tmp1,_this3->getYAxisRaw(_this3->mapping->getAnalogStick(20)));
            				}
            				break;
            				case (int)21: {
HXLINE( 242)					Float _hx_tmp2;
HXDLIN( 242)					 ::flixel::input::gamepad::lists::FlxGamepadButtonList _this4 = gamepad->pressed;
HXDLIN( 242)					int id = 13;
HXDLIN( 242)					 ::flixel::input::gamepad::FlxGamepad _this5 = _this4->gamepad;
HXDLIN( 242)					int Status = _this4->status;
HXDLIN( 242)					bool _hx_tmp3;
HXDLIN( 242)					switch((int)(id)){
            						case (int)-2: {
HXLINE( 242)							_hx_tmp3 = _this5->anyButton(Status);
            						}
            						break;
            						case (int)-1: {
HXLINE( 242)							_hx_tmp3 = !(_this5->anyButton(Status));
            						...
            						break;
            						default:{
HXLINE( 242)							int RawID = _this5->mapping->getRawID(id);
...
HXLINE( 242)								_hx_tmp3 = button->hasState(Status);
            							}
            							else {
...
HXLINE( 242)						_hx_tmp2 = ((Float)-1.0);
            					}
            					else {
HXLINE( 242)						 ::flixel::input::gamepad::lists::FlxGamepadButtonList _this6 = gamepad->pressed;
HXDLIN( 242)						int id1 = 14;
HXDLIN( 242)						 ::flixel::input::gamepad::FlxGamepad _this7 = _this6->gamepad;
HXDLIN( 242)						int Status1 = _this6->status;
HXDLIN( 242)						bool _hx_tmp4;
HXDLIN( 242)						switch((int)(id1)){
            							case (int)-2: {
HXLINE( 242)								_hx_tmp4 = _this7->anyButton(Status1);
            							}
            							break;
            							case (int)-1: {
HXLINE( 242)								_hx_tmp4 = !(_this7->anyButton(Status1));
            							...
            							break;
            							default:{
HXLINE( 242)								int RawID1 = _this7->mapping->getRawID(id1);
HXDLIN( 242)								 ::flixel::input::gamepad::FlxGamepadButton button1 = _this7->buttons->__get(RawID1).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN( 242)								if (::hx::IsNotNull( button1 )) {
HXLINE( 242)									_hx_tmp4 = button1->hasState(Status1);
            								}
            								else {
...
HXLINE( 242)							_hx_tmp2 = ((Float)0.0);
            						}
            					}
HXLINE( 243)					Float _hx_tmp5;
HXDLIN( 243)					 ::flixel::input::gamepad::lists::FlxGamepadButtonList _this8 = gamepad->pressed;
HXDLIN( 243)					int id2 = 11;
HXDLIN( 243)					 ::flixel::input::gamepad::FlxGamepad _this9 = _this8->gamepad;
HXDLIN( 243)					int Status2 = _this8->status;
HXDLIN( 243)					bool _hx_tmp6;
HXDLIN( 243)					switch((int)(id2)){
            						case (int)-2: {
HXLINE( 243)							_hx_tmp6 = _this9->anyButton(Status2);
            						}
            						break;
            						case (int)-1: {
HXLINE( 243)							_hx_tmp6 = !(_this9->anyButton(Status2));
            						...
            						break;
            						default:{
HXLINE( 243)							int RawID2 = _this9->mapping->getRawID(id2);
HXDLIN( 243)							 ::flixel::input::gamepad::FlxGamepadButton button2 = _this9->buttons->__get(RawID2).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN( 243)							if (::hx::IsNotNull( button2 )) {
HXLINE( 243)								_hx_tmp6 = button2->hasState(Status2);
            							}
            							else {
...
HXLINE( 243)						_hx_tmp5 = ((Float)-1.0);
            					}
            					else {
HXLINE( 243)						 ::flixel::input::gamepad::lists::FlxGamepadButtonList _this10 = gamepad->pressed;
HXDLIN( 243)						int id3 = 12;
HXDLIN( 243)						 ::flixel::input::gamepad::FlxGamepad _this11 = _this10->gamepad;
HXDLIN( 243)						int Status3 = _this10->status;
HXDLIN( 243)						bool _hx_tmp7;
HXDLIN( 243)						switch((int)(id3)){
            							case (int)-2: {
HXLINE( 243)								_hx_tmp7 = _this11->anyButton(Status3);
            							}
            							break;
            							case (int)-1: {
HXLINE( 243)								_hx_tmp7 = !(_this11->anyButton(Status3));
            							...
            							break;
            							default:{
HXLINE( 243)								int RawID3 = _this11->mapping->getRawID(id3);
HXDLIN( 243)								 ::flixel::input::gamepad::FlxGamepadButton button3 = _this11->buttons->__get(RawID3).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN( 243)								if (::hx::IsNotNull( button3 )) {
HXLINE( 243)									_hx_tmp7 = button3->hasState(Status3);
            								}
            								else {
...
HXLINE( 243)							_hx_tmp5 = ((Float)0.0);
            						}
            					}
HXLINE( 242)					this->updateValues(_hx_tmp2,_hx_tmp5);
            				}
            				break;
            				case (int)28: {
