...
HX_DEFINE_STACK_FRAME(_hx_pos_740854858cd8efa1_54_new,"flixel.input.actions.FlxActionDigital","new",0xd7b051c9,"flixel.input.actions.FlxActionDigital.new","flixel/input/actions/FlxAction.hx",54,0xb046b220)
HX_LOCAL_STACK_FRAME(_hx_pos_740854858cd8efa1_65_add,"flixel.input.actions.FlxActionDigital","add",0xd7a6738a,"flixel.input.actions.FlxActionDigital.add","flixel/input/actions/FlxAction.hx",65,0xb046b220)
HX_LOCAL_STACK_FRAME(_hx_pos_740854858cd8efa1_85_addInput,"flixel.input.actions.FlxActionDigital","addInput",0x37a3ac20,"flixel.input.actions.FlxActionDigital.addInput","flixel/input/actions/FlxAction.hx",85,0xb046b220)
HX_LOCAL_STACK_FRAME(_hx_pos_740854858cd8efa1_97_addGamepad,"flixel.input.actions.FlxActionDigital","addGamepad",0xde667a37,"flixel.input.actions.FlxActionDigital.addGamepad","flixel/input/actions/FlxAction.hx",97,0xb046b220)
HX_LOCAL_STACK_FRAME(_hx_pos_740854858cd8efa1_108_addKey,"flixel.input.actions.FlxActionDigital","addKey",0x53142035,"flixel.input.actions.FlxActionDigital.addKey","flixel/input/actions/FlxAction.hx",108,0xb046b220)
HX_LOCAL_STACK_FRAME(_hx_pos_740854858cd8efa1_119_addMouse,"flixel.input.actions.FlxActionDigital","addMouse",0x85eafe3b,"flixel.input.actions.FlxActionDigital.addMouse","flixel/input/actions/FlxAction.hx",119,0xb046b220)
HX_LOCAL_STACK_FRAME(_hx_pos_740854858cd8efa1_130_addMouseWheel,"flixel.input.actions.FlxActionDigital","addMouseWheel",0x63723060,"flixel.input.actions.FlxActionDigital.addMouseWheel","flixel/input/actions/FlxAction.hx",130,0xb046b220)
HX_LOCAL_STACK_FRAME(_hx_pos_740854858cd8efa1_149_destroy,"flixel.input.actions.FlxActionDigital","destroy",0xffca16e3,"flixel.input.actions.FlxActionDigital.destroy","flixel/input/actions/FlxAction.hx",149,0xb046b220)
HX_LOCAL_STACK_FRAME(_hx_pos_740854858cd8efa1_155_check,"flixel.input.actions.FlxActionDigital","check",0x0e450671,"flixel.input.actions.FlxActionDigital.check","flixel/input/actions/FlxAction.hx",155,0xb046b220)
namespace flixel{
namespace input{
namespace actions{
...
void FlxActionDigital_obj::__construct(::String __o_Name, ::Dynamic Callback){
            	...
            	HX_STACKFRAME(&_hx_pos_740854858cd8efa1_54_new)
HXLINE(  55)		super::__construct(::flixel::input::actions::FlxInputType_obj::DIGITAL_dyn(),Name);
HXLINE(  56)		this->callback = Callback;
            	}
...
bool FlxActionDigital_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::flixel::input::actions::FlxActionDigital FlxActionDigital_obj::add( ::flixel::input::actions::FlxActionInputDigital input){
            	HX_STACKFRAME(&_hx_pos_740854858cd8efa1_65_add)
HXLINE(  66)		this->addGenericInput(input);
...
HX_DEFINE_DYNAMIC_FUNC1(FlxActionDigital_obj,add,return )
 ...
 ::flixel::input::actions::FlxActionDigital FlxActionDigital_obj::addInput(::Dynamic Input,int Trigger){
            	HX_GC_STACKFRAME(&_hx_pos_740854858cd8efa1_85_addInput)
HXDLIN(  85)		return this->add( ::flixel::input::actions::FlxActionInputDigitalIFlxInput_obj::__alloc( HX_CTX ,Input,Trigger));
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(FlxActionDigital_obj,addInput,return )
 ...
 ::flixel::input::actions::FlxActionDigital FlxActionDigital_obj::addGamepad(int InputID,int Trigger,::hx::Null< int >  __o_GamepadID){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_740854858cd8efa1_97_addGamepad)
HXDLIN(  97)		return this->add( ::flixel::input::actions::FlxActionInputDigitalGamepad_obj::__alloc( HX_CTX ,InputID,Trigger,GamepadID));
            	}
...
HX_DEFINE_DYNAMIC_FUNC3(FlxActionDigital_obj,addGamepad,return )
 ...
 ::flixel::input::actions::FlxActionDigital FlxActionDigital_obj::addKey(int Key,int Trigger){
            	HX_GC_STACKFRAME(&_hx_pos_740854858cd8efa1_108_addKey)
HXDLIN( 108)		return this->add( ::flixel::input::actions::FlxActionInputDigitalKeyboard_obj::__alloc( HX_CTX ,Key,Trigger));
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(FlxActionDigital_obj,addKey,return )
 ...
 ::flixel::input::actions::FlxActionDigital FlxActionDigital_obj::addMouse(int ButtonID,int Trigger){
            	HX_GC_STACKFRAME(&_hx_pos_740854858cd8efa1_119_addMouse)
HXDLIN( 119)		return this->add( ::flixel::input::actions::FlxActionInputDigitalMouse_obj::__alloc( HX_CTX ,ButtonID,Trigger));
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(FlxActionDigital_obj,addMouse,return )
 ...
 ::flixel::input::actions::FlxActionDigital FlxActionDigital_obj::addMouseWheel(bool Positive,int Trigger){
            	HX_GC_STACKFRAME(&_hx_pos_740854858cd8efa1_130_addMouseWheel)
HXDLIN( 130)		return this->add( ::flixel::input::actions::FlxActionInputDigitalMouseWheel_obj::__alloc( HX_CTX ,Positive,Trigger));
            	}
...
void FlxActionDigital_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_740854858cd8efa1_149_destroy)
HXLINE( 150)		this->callback = null();
HXLINE( 151)		this->super::destroy();
            	}


bool FlxActionDigital_obj::check(){
            	HX_STACKFRAME(&_hx_pos_740854858cd8efa1_155_check)
HXLINE( 156)		bool val = this->super::check();
HXLINE( 157)		bool _hx_tmp;
HXDLIN( 157)		if (val) {
HXLINE( 157)			_hx_tmp = ::hx::IsNotNull( this->callback );
            		}
            		else {
HXLINE( 157)			_hx_tmp = false;
            		}
HXDLIN( 157)		if (_hx_tmp) {
HXLINE( 159)			this->callback(::hx::ObjectPtr<OBJ_>(this));
            		}
