...
HXLINE( 324)						returnVal = false;
            			...
            			break;
            			case (int)1: {
HXLINE( 327)				int state1 = this->yMoved->current;
HXDLIN( 327)				switch((int)(this->trigger)){
            					case (int)-1: {
HXLINE( 324)						returnVal = (state1 == -1);
            					}
            					break;
            					case (int)0: {
HXLINE( 327)						if ((state1 != 0)) {
HXLINE( 324)							returnVal = (state1 == -1);
            						}
            						else {
HXLINE( 324)							returnVal = true;
            					...
            					break;
            					case (int)1: {
HXLINE( 327)						if ((state1 != 1)) {
HXLINE( 324)							returnVal = (state1 == 2);
            						}
            						else {
HXLINE( 324)							returnVal = true;
            						}
...
HXLINE( 324)						returnVal = false;
            			...
            			break;
            			case (int)2: {
HXLINE( 328)				int state2 = this->xMoved->current;
HXDLIN( 328)				bool returnVal1;
HXDLIN( 328)				switch((int)(this->trigger)){
            					case (int)-1: {
HXLINE( 328)						returnVal1 = (state2 == -1);
            					}
            					break;
            					case (int)0: {
HXLINE( 328)						if ((state2 != 0)) {
HXLINE( 328)							returnVal1 = (state2 == -1);
            						}
            						else {
HXLINE( 328)							returnVal1 = true;
            					...
            					break;
            					case (int)1: {
HXLINE( 328)						if ((state2 != 1)) {
HXLINE( 328)							returnVal1 = (state2 == 2);
            						}
            						else {
HXLINE( 328)							returnVal1 = true;
            						}
...
HXLINE( 328)					int state3 = this->yMoved->current;
HXDLIN( 328)					switch((int)(this->trigger)){
            						case (int)-1: {
HXLINE( 324)							returnVal = (state3 == -1);
            						}
            						break;
            						case (int)0: {
HXLINE( 328)							if ((state3 != 0)) {
HXLINE( 324)								returnVal = (state3 == -1);
            							}
            							else {
HXLINE( 324)								returnVal = true;
            						...
            						break;
            						case (int)1: {
HXLINE( 328)							if ((state3 != 1)) {
HXLINE( 324)								returnVal = (state3 == 2);
            							}
            							else {
HXLINE( 324)								returnVal = true;
            							}
...
HXLINE( 332)				switch((int)(this->trigger)){
            					case (int)-1: {
HXLINE( 341)						bool returnVal2;
HXDLIN( 341)						if (this->checkAxis(true,-1)) {
HXLINE( 341)							returnVal2 = this->checkAxis(false,0);
            						}
            						else {
HXLINE( 341)							returnVal2 = false;
            						}
HXDLIN( 341)						if (!(returnVal2)) {
...
HXLINE( 324)							returnVal = true;
            					...
            					break;
            					case (int)2: {
HXLINE( 337)						bool returnVal3;
HXDLIN( 337)						bool returnVal4;
HXDLIN( 337)						if (this->checkAxis(true,2)) {
HXLINE( 337)							returnVal4 = this->checkAxis(false,2);
            						}
            						else {
HXLINE( 337)							returnVal4 = false;
            						}
HXDLIN( 337)						if (!(returnVal4)) {
HXLINE( 338)							if (this->checkAxis(true,2)) {
HXLINE( 337)								returnVal3 = this->checkAxis(false,0);
            							}
            							else {
HXLINE( 337)								returnVal3 = false;
            							}
            						}
            						else {
HXLINE( 337)							returnVal3 = true;
            						}
HXDLIN( 337)						if (!(returnVal3)) {
