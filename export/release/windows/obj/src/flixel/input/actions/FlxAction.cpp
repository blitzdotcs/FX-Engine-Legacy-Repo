...
HX_LOCAL_STACK_FRAME(_hx_pos_46dea4e2f301566f_384_getFirstSteamOrigin,"flixel.input.actions.FlxAction","getFirstSteamOrigin",0x6f5d528f,"flixel.input.actions.FlxAction.getFirstSteamOrigin","flixel/input/actions/FlxAction.hx",384,0xb046b220)
HX_LOCAL_STACK_FRAME(_hx_pos_46dea4e2f301566f_402_getSteamOrigins,"flixel.input.actions.FlxAction","getSteamOrigins",0x8a9d7ee6,"flixel.input.actions.FlxAction.getSteamOrigins","flixel/input/actions/FlxAction.hx",402,0xb046b220)
HX_LOCAL_STACK_FRAME(_hx_pos_46dea4e2f301566f_406_removeAll,"flixel.input.actions.FlxAction","removeAll",0x834d6510,"flixel.input.actions.FlxAction.removeAll","flixel/input/actions/FlxAction.hx",406,0xb046b220)
...
HX_LOCAL_STACK_FRAME(_hx_pos_46dea4e2f301566f_430_toString,"flixel.input.actions.FlxAction","toString",0x9d225e39,"flixel.input.actions.FlxAction.toString","flixel/input/actions/FlxAction.hx",430,0xb046b220)
...
HX_LOCAL_STACK_FRAME(_hx_pos_46dea4e2f301566f_479_update,"flixel.input.actions.FlxAction","update",0xb4f6a656,"flixel.input.actions.FlxAction.update","flixel/input/actions/FlxAction.hx",479,0xb046b220)
...
HX_LOCAL_STACK_FRAME(_hx_pos_46dea4e2f301566f_494_match,"flixel.input.actions.FlxAction","match",0x09157198,"flixel.input.actions.FlxAction.match","flixel/input/actions/FlxAction.hx",494,0xb046b220)
...
HXLINE( 350)		this->steamOriginsChanged = false;
...
int FlxAction_obj::getFirstSteamOrigin(){
            	HX_STACKFRAME(&_hx_pos_46dea4e2f301566f_384_getFirstSteamOrigin)
HXDLIN( 384)		return 0;
            	}
...
::Array< int > FlxAction_obj::getSteamOrigins(::Array< int > origins){
            	HX_STACKFRAME(&_hx_pos_46dea4e2f301566f_402_getSteamOrigins)
HXDLIN( 402)		return origins;
            	}
...
void FlxAction_obj::removeAll(::hx::Null< bool >  __o_Destroy){
            	...
            	HX_STACKFRAME(&_hx_pos_46dea4e2f301566f_406_removeAll)
HXLINE( 407)		int len = this->inputs->length;
HXLINE( 408)		{
HXLINE( 408)			int _g = 0;
HXDLIN( 408)			int _g1 = len;
HXDLIN( 408)			while((_g < _g1)){
HXLINE( 408)				_g = (_g + 1);
HXDLIN( 408)				int i = (_g - 1);
HXLINE( 410)				int j = ((len - i) - 1);
HXLINE( 411)				 ::flixel::input::actions::FlxActionInput input = this->inputs->__get(j).StaticCast<  ::flixel::input::actions::FlxActionInput >();
HXLINE( 412)				this->remove(input,Destroy);
HXLINE( 413)				this->inputs->removeRange(j,1);
            			}
            		}
            	}
...
::String FlxAction_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_46dea4e2f301566f_430_toString)
HXDLIN( 430)		::String _hx_tmp = ((HX_("FlxAction(",80,bd,59,96) + ::Std_obj::string(this->type)) + HX_(") name:",58,20,e0,0a));
HXDLIN( 430)		return (_hx_tmp + this->name);
            	}
...
void FlxAction_obj::update(){
            	HX_STACKFRAME(&_hx_pos_46dea4e2f301566f_479_update)
HXDLIN( 479)		this->check();
            	}
...
bool FlxAction_obj::match( ::flixel::input::actions::FlxAction other){
            	HX_STACKFRAME(&_hx_pos_46dea4e2f301566f_494_match)
HXDLIN( 494)		if ((this->name == other->name)) {
HXDLIN( 494)			return (this->steamHandle == other->steamHandle);
            		}
            		else {
