...
HXLINE( 245)							return true;
            					...
            					break;
            					case (int)1: {
HXLINE( 244)						 ::flixel::input::mouse::FlxMouseButton _this1 = ::flixel::FlxG_obj::mouse->_rightButton;
HXDLIN( 244)						bool _hx_tmp1;
HXDLIN( 244)						if ((_this1->current != 1)) {
HXLINE( 244)							_hx_tmp1 = (_this1->current == 2);
            						}
            						else {
...
HXLINE( 240)						return (::flixel::FlxG_obj::mouse->_middleButton->current == -1);
            					...
            					break;
            					case (int)0: {
HXLINE( 238)						 ::flixel::input::mouse::FlxMouseButton _this2 = ::flixel::FlxG_obj::mouse->_middleButton;
HXDLIN( 238)						bool _hx_tmp2;
HXDLIN( 238)						if ((_this2->current != 1)) {
HXLINE( 238)							_hx_tmp2 = (_this2->current == 2);
            						}
            						else {
...
HXLINE( 238)							return true;
            					...
            					break;
            					case (int)1: {
HXLINE( 237)						 ::flixel::input::mouse::FlxMouseButton _this3 = ::flixel::FlxG_obj::mouse->_middleButton;
HXDLIN( 237)						bool _hx_tmp3;
HXDLIN( 237)						if ((_this3->current != 1)) {
HXLINE( 237)							_hx_tmp3 = (_this3->current == 2);
            						}
            						else {
...
HXLINE( 233)						return (::flixel::FlxG_obj::mouse->_leftButton->current == -1);
            					...
            					break;
            					case (int)0: {
HXLINE( 231)						 ::flixel::input::mouse::FlxMouseButton _this4 = ::flixel::FlxG_obj::mouse->_leftButton;
HXDLIN( 231)						bool _hx_tmp4;
HXDLIN( 231)						if ((_this4->current != 1)) {
HXLINE( 231)							_hx_tmp4 = (_this4->current == 2);
            						}
            						else {
...
HXLINE( 231)							return true;
            					...
            					break;
            					case (int)1: {
HXLINE( 230)						 ::flixel::input::mouse::FlxMouseButton _this5 = ::flixel::FlxG_obj::mouse->_leftButton;
HXDLIN( 230)						bool _hx_tmp5;
HXDLIN( 230)						if ((_this5->current != 1)) {
HXLINE( 230)							_hx_tmp5 = (_this5->current == 2);
            						}
            						else {
HXLINE( 230)							_hx_tmp5 = true;
            						}
