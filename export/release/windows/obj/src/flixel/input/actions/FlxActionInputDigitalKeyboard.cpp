...
HX_DEFINE_STACK_FRAME(_hx_pos_2337e63586580f23_190_new,"flixel.input.actions.FlxActionInputDigitalKeyboard","new",0xe0efc6c8,"flixel.input.actions.FlxActionInputDigitalKeyboard.new","flixel/input/actions/FlxActionInputDigital.hx",190,0x47a4ecd2)
HX_LOCAL_STACK_FRAME(_hx_pos_2337e63586580f23_195_check,"flixel.input.actions.FlxActionInputDigitalKeyboard","check",0x7e0af930,"flixel.input.actions.FlxActionInputDigitalKeyboard.check","flixel/input/actions/FlxActionInputDigital.hx",195,0x47a4ecd2)
namespace flixel{
namespace input{
namespace actions{

void FlxActionInputDigitalKeyboard_obj::__construct(int Key,int Trigger){
            	HX_STACKFRAME(&_hx_pos_2337e63586580f23_190_new)
HXDLIN( 190)		super::__construct(::flixel::input::actions::FlxInputDevice_obj::KEYBOARD_dyn(),Key,Trigger,null());
            	}
...
bool FlxActionInputDigitalKeyboard_obj::check( ::flixel::input::actions::FlxAction Action){
            	HX_STACKFRAME(&_hx_pos_2337e63586580f23_195_check)
HXDLIN( 195)		switch((int)(this->trigger)){
            			case (int)-1: {
HXLINE( 201)				return ::flixel::FlxG_obj::keys->checkStatus(this->inputID,-1);
            			}
            			break;
            			case (int)0: {
HXLINE( 199)				if (!(::flixel::FlxG_obj::keys->checkStatus(this->inputID,0))) {
HXLINE( 199)					return ::flixel::FlxG_obj::keys->checkStatus(this->inputID,-1);
            				}
            				else {
HXLINE( 199)					return true;
            			...
            			break;
            			case (int)1: {
HXLINE( 198)				if (!(::flixel::FlxG_obj::keys->checkStatus(this->inputID,1))) {
HXLINE( 198)					return ::flixel::FlxG_obj::keys->checkStatus(this->inputID,2);
            				}
            				else {
HXLINE( 198)					return true;
            			...
            			break;
            			case (int)2: {
HXLINE( 200)				return ::flixel::FlxG_obj::keys->checkStatus(this->inputID,2);
            			}
            			break;
            			default:{
