...
HXLINE(  58)					pass = true;
            			...
            			break;
            			case (int)-2: {
HXLINE(  59)				 ::flixel::input::mouse::FlxMouseButton _this1 = ::flixel::FlxG_obj::mouse->_middleButton;
HXDLIN(  59)				if ((_this1->current != 1)) {
HXLINE(  59)					pass = (_this1->current == 2);
            				}
            				else {
HXLINE(  59)					pass = true;
            				}
            			...
            			break;
            			case (int)-1: {
HXLINE(  57)				 ::flixel::input::mouse::FlxMouseButton _this2 = ::flixel::FlxG_obj::mouse->_leftButton;
HXDLIN(  57)				if ((_this2->current != 1)) {
HXLINE(  57)					pass = (_this2->current == 2);
            				}
            				else {
HXLINE(  57)					pass = true;
            				}
