...
HX_LOCAL_STACK_FRAME(_hx_pos_ae8d48bb73fd7d46_390_rpad,"StringTools","rpad",0x27b4d7a5,"StringTools.rpad","C:\\HaxeToolkit\\haxe\\std/StringTools.hx",390,0xb9dbeb2d)
...
::String StringTools_obj::rpad(::String s,::String c,int l){
            	HX_GC_STACKFRAME(&_hx_pos_ae8d48bb73fd7d46_390_rpad)
HXLINE( 391)		if ((c.length <= 0)) {
HXLINE( 392)			return s;
            		}
HXLINE( 394)		 ::StringBuf buf =  ::StringBuf_obj::__alloc( HX_CTX );
HXLINE( 395)		{
HXLINE( 395)			if (::hx::IsNotNull( buf->charBuf )) {
HXLINE( 395)				buf->flush();
            			}
HXDLIN( 395)			if (::hx::IsNull( buf->b )) {
HXLINE( 395)				buf->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(s));
            			}
            			else {
HXLINE( 395)				::Array< ::String > buf1 = buf->b;
HXDLIN( 395)				buf1->push(::Std_obj::string(s));
            			}
            		}
HXLINE( 396)		while((buf->get_length() < l)){
HXLINE( 397)			if (::hx::IsNotNull( buf->charBuf )) {
HXLINE( 397)				buf->flush();
            			}
HXDLIN( 397)			if (::hx::IsNull( buf->b )) {
HXLINE( 397)				buf->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(c));
            			}
            			else {
HXLINE( 397)				::Array< ::String > buf1 = buf->b;
HXDLIN( 397)				buf1->push(::Std_obj::string(c));
            			}
            		}
HXLINE( 399)		return buf->toString();
            	}
