...
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_68_changePresence,"DiscordClient","changePresence",0xb0052162,"DiscordClient.changePresence","Discord.hx",68,0xa6c9e0b2)
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_10_boot,"DiscordClient","boot",0xc4d88309,"DiscordClient.boot","Discord.hx",10,0xa6c9e0b2)
...
HXLINE(  14)		::discord_rpc::DiscordRpc_obj::start( ::Dynamic(::hx::Anon_obj::Create(4)
            			...
            			->setFixed(2,HX_("clientID",e6,72,8f,15),HX_("1106308519872962581",c4,1f,0d,28))
...
HXDLIN(  39)		::discord_rpc::DiscordRpc_obj::presence( ::Dynamic(::hx::Anon_obj::Create(4)
            			...
            			->setFixed(1,HX_("details",c2,dc,56,ab),HX_("Chillin in the Menus",01,b9,2b,24))
            			->setFixed(2,HX_("largeImageKey",df,8f,e3,ae),HX_("icon",79,e7,b2,45))
            			->setFixed(3,HX_("largeImageText",6d,3e,2d,5e),HX_("FX Engine",f0,84,21,bb))));
            	}
...
HXLINE(  64)		::DiscordClient_obj::isInitialized = true;
            	}
...
void DiscordClient_obj::changePresence(::String details,::String state,::String smallImageKey, ::Dynamic hasStartTimestamp, ::Dynamic endTimestamp){
            	HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_68_changePresence)
HXLINE(  69)		Float startTimestamp;
HXDLIN(  69)		if (( (bool)(hasStartTimestamp) )) {
HXLINE(  69)			startTimestamp = ::Date_obj::now()->getTime();
            		}
            		else {
HXLINE(  69)			startTimestamp = ( (Float)(0) );
            		}
HXLINE(  71)		if (::hx::IsGreater( endTimestamp,0 )) {
HXLINE(  73)			endTimestamp = (startTimestamp + endTimestamp);
            		}
HXLINE(  83)		 ::Dynamic _hx_tmp = ::Std_obj::_hx_int((startTimestamp / ( (Float)(1000) )));
HXLINE(  76)		::discord_rpc::DiscordRpc_obj::presence( ::Dynamic(::hx::Anon_obj::Create(7)
            			...
            			->setFixed(6,HX_("largeImageText",6d,3e,2d,5e),HX_("FX Engine Version: 1.2.0",09,8b,7f,af))));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_10_boot)
