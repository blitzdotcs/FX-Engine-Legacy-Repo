...
HXLINE( 287)			if (_gthis->unfired->exists(id1->__get(0))) {
HXLINE( 289)				_gthis->unfired->remove(id1->__get(0));
HXLINE( 290)				_gthis->fired->push(id1->__get(0));
HXLINE( 291)				_gthis->numRemaining--;
HXLINE( 293)				if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 294)					if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 294)						::haxe::Log_obj::trace((((HX_("",00,00,00,00) + _gthis->logId) + HX_(": ",a6,32,00,00)) + ((((HX_("fired ",72,04,21,89) + id1->__get(0)) + HX_(", ",74,26,00,00)) + _gthis->numRemaining) + HX_(" remaining",d6,c2,10,c5))),::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),313,HX_("MultiCallback",3e,d1,b2,64),HX_("log",84,54,52,00)));
            					}
            				}
...
HXLINE( 304)					::haxe::Log_obj::trace((((HX_("",00,00,00,00) + _gthis->logId) + HX_(": ",a6,32,00,00)) + (HX_("already fired ",fa,e7,0c,57) + id1->__get(0))),::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),313,HX_("MultiCallback",3e,d1,b2,64),HX_("log",84,54,52,00)));
            				}
            			}
            		}
...
HXDLIN( 280)		::Array< ::String > id1 = ::Array_obj< ::String >::__new(1)->init(0,id);
HXDLIN( 280)		 ::MultiCallback _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 281)		id1[0] = (((HX_("",00,00,00,00) + this->length) + HX_(":",3a,00,00,00)) + id1->__get(0));
HXLINE( 282)		this->length++;
HXLINE( 283)		this->numRemaining++;
HXLINE( 284)		 ::Dynamic func = null();
HXLINE( 285)		func =  ::Dynamic(new _hx_Closure_0(id1,_gthis));
HXLINE( 306)		this->unfired->set(id1->__get(0),func);
