...
HX_DEFINE_STACK_FRAME(_hx_pos_e90bf299ab00f44e_139_new,"SongPositionOption","new",0xf73dda45,"SongPositionOption.new","Options.hx",139,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_e90bf299ab00f44e_144_press,"SongPositionOption","press",0xd57460a8,"SongPositionOption.press","Options.hx",144,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_e90bf299ab00f44e_152_updateDisplay,"SongPositionOption","updateDisplay",0x1eddc95e,"SongPositionOption.updateDisplay","Options.hx",152,0x9d9a0240)

void SongPositionOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_e90bf299ab00f44e_139_new)
...
bool SongPositionOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_e90bf299ab00f44e_144_press)
HXLINE( 145)		::flixel::FlxG_obj::save->data->__SetField(HX_("songPosition",9e,dd,3b,8d),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("songPosition",9e,dd,3b,8d),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 146)		this->display = this->updateDisplay();
HXLINE( 147)		return true;
            	}


::String SongPositionOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_e90bf299ab00f44e_152_updateDisplay)
HXDLIN( 152)		::String _hx_tmp;
HXDLIN( 152)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("songPosition",9e,dd,3b,8d),::hx::paccDynamic)) ))) {
HXDLIN( 152)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 152)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 152)		return (HX_("Song Position ",4c,83,da,f1) + _hx_tmp);
            	}
