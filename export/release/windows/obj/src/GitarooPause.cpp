...
HXDLIN(  32)				bf->set_x(((( (Float)(_hx_tmp2) ) - bf->get_width()) / ( (Float)(2) )));
            			}
...
HXDLIN(  32)				bf->set_y(((( (Float)(_hx_tmp4) ) - bf->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXLINE(  35)		 ::flixel::FlxSprite _hx_tmp5 = this->replayButton;
HXDLIN(  35)		::String library2 = null();
HXDLIN(  35)		::String _hx_tmp6 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("pauseAlt/pauseUI",4e,e1,5d,69)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library2);
HXDLIN(  35)		_hx_tmp5->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp6,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("pauseAlt/pauseUI",4e,e1,5d,69)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library2)));
...
HXLINE(  42)		 ::flixel::FlxSprite _hx_tmp7 = this->cancelButton;
HXDLIN(  42)		::String library3 = null();
HXDLIN(  42)		::String _hx_tmp8 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("pauseAlt/pauseUI",4e,e1,5d,69)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library3);
HXDLIN(  42)		_hx_tmp7->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp8,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("pauseAlt/pauseUI",4e,e1,5d,69)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library3)));
...
HXLINE(  66)				 ::flixel::FlxState nextState1 =  ::MainMenuState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN(  66)				if (::flixel::FlxG_obj::game->_state->switchTo(nextState1)) {
HXLINE(  66)					::flixel::FlxG_obj::game->_requestedState = nextState1;
            				}
            			}
            		}
