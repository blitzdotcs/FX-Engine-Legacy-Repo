...
HX_LOCAL_STACK_FRAME(_hx_pos_9bd24c9adde08dff_37_mapBPMChanges,"Conductor","mapBPMChanges",0x401caab9,"Conductor.mapBPMChanges","Conductor.hx",37,0xeb0fa157)
HX_LOCAL_STACK_FRAME(_hx_pos_9bd24c9adde08dff_64_changeBPM,"Conductor","changeBPM",0xeafb6fe8,"Conductor.changeBPM","Conductor.hx",64,0xeb0fa157)
...
void Conductor_obj::mapBPMChanges( ::Dynamic song){
            	HX_STACKFRAME(&_hx_pos_9bd24c9adde08dff_37_mapBPMChanges)
HXLINE(  38)		::Conductor_obj::bpmChangeMap = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  40)		int curBPM = ( (int)(song->__Field(HX_("bpm",df,be,4a,00),::hx::paccDynamic)) );
HXLINE(  41)		int totalSteps = 0;
HXLINE(  42)		Float totalPos = ( (Float)(0) );
HXLINE(  43)		{
HXLINE(  43)			int _g = 0;
HXDLIN(  43)			int _g1 = ( (::Array< ::Dynamic>)(song->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic)) )->length;
HXDLIN(  43)			while((_g < _g1)){
HXLINE(  43)				_g = (_g + 1);
HXDLIN(  43)				int i = (_g - 1);
HXLINE(  45)				bool _hx_tmp;
HXDLIN(  45)				if (( (bool)( ::Dynamic(song->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic))->__GetItem(i)->__Field(HX_("changeBPM",4f,4f,f8,1d),::hx::paccDynamic)) )) {
HXLINE(  45)					_hx_tmp = ::hx::IsNotEq(  ::Dynamic(song->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic))->__GetItem(i)->__Field(HX_("bpm",df,be,4a,00),::hx::paccDynamic),curBPM );
            				}
            				else {
HXLINE(  45)					_hx_tmp = false;
            				}
HXDLIN(  45)				if (_hx_tmp) {
HXLINE(  47)					curBPM = ( (int)( ::Dynamic(song->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic))->__GetItem(i)->__Field(HX_("bpm",df,be,4a,00),::hx::paccDynamic)) );
HXLINE(  48)					 ::Dynamic event =  ::Dynamic(::hx::Anon_obj::Create(3)
...
HXLINE(  53)					::Conductor_obj::bpmChangeMap->push(event);
            				}
HXLINE(  56)				int deltaSteps = ( (int)( ::Dynamic(song->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic))->__GetItem(i)->__Field(HX_("lengthInSteps",3c,ed,41,db),::hx::paccDynamic)) );
HXLINE(  57)				totalSteps = (totalSteps + deltaSteps);
HXLINE(  58)				totalPos = (totalPos + ((((( (Float)(60) ) / ( (Float)(curBPM) )) * ( (Float)(1000) )) / ( (Float)(4) )) * ( (Float)(deltaSteps) )));
            			}
            		}
HXLINE(  60)		 ::Dynamic _hx_tmp1 = ::haxe::Log_obj::trace;
HXDLIN(  60)		::String _hx_tmp2 = (HX_("new BPM map BUDDY ",ff,cc,e3,2e) + ::Std_obj::string(::Conductor_obj::bpmChangeMap));
HXDLIN(  60)		_hx_tmp1(_hx_tmp2,::hx::SourceInfo(HX_("source/Conductor.hx",4b,4e,2d,f0),60,HX_("Conductor",c7,77,a1,7b),HX_("mapBPMChanges",a0,c9,ba,4a)));
            	}
...
void Conductor_obj::changeBPM(int newBpm){
            	HX_STACKFRAME(&_hx_pos_9bd24c9adde08dff_64_changeBPM)
HXLINE(  65)		::Conductor_obj::bpm = newBpm;
HXLINE(  67)		::Conductor_obj::crochet = ((( (Float)(60) ) / ( (Float)(::Conductor_obj::bpm) )) * ( (Float)(1000) ));
HXLINE(  68)		::Conductor_obj::stepCrochet = (::Conductor_obj::crochet / ( (Float)(4) ));
            	}
