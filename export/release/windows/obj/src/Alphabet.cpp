...
HXDLIN( 165)			::String _hx_tmp3 = ::AlphaCharacter_obj::alphabet;
HXDLIN( 165)			if ((_hx_tmp3.indexOf(_gthis->splitWords->__get(loopNum->__get(0)).toLowerCase(),null()) == -1)) {
HXLINE( 165)				_hx_tmp2 = isNumber;
            			}
            			else {
HXLINE( 165)				_hx_tmp2 = true;
            			}
HXDLIN( 165)			if (!(_hx_tmp2)) {
HXLINE( 165)				_hx_tmp1 = isSymbol;
            			}
            			else {
...
HXLINE( 169)					_hx_tmp4 = !(_gthis->xPosResetted);
            				}
            				else {
...
HXDLIN( 172)					int _hx_tmp5 = 0;
HXDLIN( 172)					Float xPos2 = xPos1->__get(_hx_tmp5);
HXDLIN( 172)					xPos1[_hx_tmp5] = (xPos2 + (_gthis->lastSprite->get_width() + 3));
            				}
            				else {
HXLINE( 178)					_gthis->xPosResetted = false;
            				}
HXLINE( 181)				if (_gthis->lastWasSpace) {
HXLINE( 183)					::Array< Float > xPos3 = xPos;
HXDLIN( 183)					int _hx_tmp6 = 0;
HXDLIN( 183)					xPos3[_hx_tmp6] = (xPos3->__get(_hx_tmp6) + 20);
...
HXLINE( 216)					 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp7 = ::flixel::FlxG_obj::sound;
HXDLIN( 216)					::String library = null();
HXDLIN( 216)					_hx_tmp7->play(::Paths_obj::sound((daSound + ::flixel::FlxG_obj::random->_hx_int(1,4,null())),library),null(),null(),null(),null(),null());
            				}
...
HXDLIN( 224)			int _hx_tmp8 = 0;
HXDLIN( 224)			loopNum1[_hx_tmp8] = (loopNum1->__get(_hx_tmp8) + 1);
...
HXLINE( 242)			Float a2 = this->x;
HXDLIN( 242)			Float scrollX = (a2 + (lerpSpeed * (((this->groupIndex * ( (Float)(20) )) + 90) - a2)));
HXLINE( 243)			Float remappedY = ::flixel::math::FlxMath_obj::remapToRange(this->groupIndex,( (Float)(0) ),( (Float)(1) ),( (Float)(0) ),((Float)1.3));
HXLINE( 244)			Float a3 = this->y;
HXDLIN( 244)			Float scrollY = (a3 + (lerpSpeed * (((remappedY * ( (Float)(120) )) + (( (Float)(::flixel::FlxG_obj::height) ) * ((Float)0.48))) - a3)));
