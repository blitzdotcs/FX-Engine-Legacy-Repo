...
HXLINE( 579)						 ::lime::app::Promise_haxe_io_Bytes instance1 = instance->promise;
HXDLIN( 579)						instance1->error(instance->bytes->getString(0,instance->bytes->length,null()));
            					}
            					else {
...
HXDLIN( 588)				instance1->error(::lime::net::curl::CURL_obj::strerror(( (int)(state->__Field(HX_("result",dd,68,84,08),::hx::paccDynamic)) )));
            			}
