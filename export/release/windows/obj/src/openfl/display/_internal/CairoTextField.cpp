...
HX_LOCAL_STACK_FRAME(_hx_pos_a654946cfcca811d_448_renderDrawable,"openfl.display._internal.CairoTextField","renderDrawable",0x65cf17c1,"openfl.display._internal.CairoTextField.renderDrawable","openfl/display/_internal/CairoTextField.hx",448,0xd777675a)
HX_LOCAL_STACK_FRAME(_hx_pos_a654946cfcca811d_468_renderDrawableMask,"openfl.display._internal.CairoTextField","renderDrawableMask",0x842bf94d,"openfl.display._internal.CairoTextField.renderDrawableMask","openfl/display/_internal/CairoTextField.hx",468,0xd777675a)
...
HXLINE( 403)							int descent = ::Math_obj::floor((group1->ascent * ((Float)0.185)));
HXLINE( 404)							Float x = ((group1->offsetX + scrollX) - bounds->x);
HXLINE( 405)							Float y = ((::Math_obj::ceil((((group1->offsetY + scrollY) + group1->ascent) - bounds->y)) + descent) + ((Float)0.5));
HXLINE( 406)							cairo->moveTo(x,y);
HXLINE( 407)							cairo->lineTo((x + group1->width),y);
HXLINE( 408)							cairo->stroke();
HXLINE( 409)							cairo->closePath();
            						}
            					}
            				}
            				_hx_goto_2:;
...
HXDLIN( 414)			if ((textField->_hx___caretIndex > -1)) {
HXLINE( 414)				_hx_tmp1 = textEngine->selectable;
            			}
            			else {
HXLINE( 414)				_hx_tmp1 = false;
            			}
HXDLIN( 414)			if (_hx_tmp1) {
HXLINE( 414)				_hx_tmp = textField->_hx___showCursor;
            			}
            			else {
HXLINE( 414)				_hx_tmp = false;
            			}
HXDLIN( 414)			if (_hx_tmp) {
HXLINE( 416)				Float scrollX;
HXDLIN( 416)				if (useTextBounds1) {
HXLINE( 416)					scrollX = ( (Float)(0) );
            				}
            				else {
HXLINE( 416)					scrollX = cursorOffsetX;
            				}
HXDLIN( 416)				Float scrollX1 = (-(textField->get_scrollH()) + scrollX);
HXLINE( 417)				Float scrollY = ((Float)0.0);
HXLINE( 419)				{
HXLINE( 419)					int _g = 0;
HXDLIN( 419)					int _g1 = (textField->get_scrollV() - 1);
HXDLIN( 419)					while((_g < _g1)){
HXLINE( 419)						_g = (_g + 1);
HXDLIN( 419)						int i = (_g - 1);
HXLINE( 421)						scrollY = (scrollY + textEngine->lineHeights->get(i));
            					}
            				}
HXLINE( 424)				 ::Dynamic color = textField->get_defaultTextFormat()->color;
HXLINE( 425)				Float r = (( (Float)(::hx::UShr((( (int)(color) ) & 16711680),16)) ) / ( (Float)(255) ));
HXLINE( 426)				Float g = (( (Float)(::hx::UShr((( (int)(color) ) & 65280),8)) ) / ( (Float)(255) ));
HXLINE( 427)				Float b = (( (Float)((( (int)(color) ) & 255)) ) / ( (Float)(255) ));
HXLINE( 429)				cairo->setSourceRGB(r,g,b);
HXLINE( 431)				cairo->newPath();
HXLINE( 432)				cairo->moveTo((scrollX1 + ((Float)2.5)),(scrollY + ((Float)2.5)));
HXLINE( 433)				cairo->set_lineWidth(( (Float)(1) ));
HXLINE( 434)				cairo->lineTo((scrollX1 + ((Float)2.5)),((scrollY + ::openfl::text::_internal::TextEngine_obj::getFormatHeight(textField->get_defaultTextFormat())) - ( (Float)(1) )));
HXLINE( 435)				cairo->stroke();
HXLINE( 436)				cairo->closePath();
            			}
            		}
HXLINE( 439)		graphics->_hx___bitmap->image->dirty = true;
HXLINE( 440)		graphics->_hx___bitmap->image->version++;
HXLINE( 441)		textField->_hx___dirty = false;
HXLINE( 442)		graphics->_hx___softwareDirty = false;
HXLINE( 443)		graphics->set___dirty(false);
            	}
...
void CairoTextField_obj::renderDrawable( ::openfl::text::TextField textField, ::openfl::display::CairoRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_a654946cfcca811d_448_renderDrawable)
HXLINE( 450)		renderer->_hx___updateCacheBitmap(textField,textField->_hx___dirty);
HXLINE( 452)		bool _hx_tmp;
HXDLIN( 452)		if (::hx::IsNotNull( textField->_hx___cacheBitmap )) {
HXLINE( 452)			_hx_tmp = !(textField->_hx___isCacheBitmapRender);
            		}
            		else {
HXLINE( 452)			_hx_tmp = false;
            		}
HXDLIN( 452)		if (_hx_tmp) {
HXLINE( 454)			 ::openfl::display::Bitmap bitmap = textField->_hx___cacheBitmap;
HXDLIN( 454)			if (bitmap->_hx___renderable) {
HXLINE( 454)				Float alpha = renderer->_hx___getAlpha(bitmap->_hx___worldAlpha);
HXDLIN( 454)				bool _hx_tmp;
HXDLIN( 454)				bool _hx_tmp1;
HXDLIN( 454)				if ((alpha > 0)) {
HXLINE( 454)					_hx_tmp1 = ::hx::IsNotNull( bitmap->_hx___bitmapData );
            				}
            				else {
HXLINE( 454)					_hx_tmp1 = false;
            				}
HXDLIN( 454)				if (_hx_tmp1) {
HXLINE( 454)					_hx_tmp = bitmap->_hx___bitmapData->_hx___isValid;
            				}
            				else {
HXLINE( 454)					_hx_tmp = false;
            				}
HXDLIN( 454)				if (_hx_tmp) {
HXLINE( 454)					 ::lime::graphics::cairo::Cairo cairo = renderer->cairo;
HXDLIN( 454)					renderer->_hx___setBlendMode(bitmap->_hx___worldBlendMode);
HXDLIN( 454)					renderer->_hx___pushMaskObject(bitmap,null());
HXDLIN( 454)					renderer->applyMatrix(bitmap->_hx___renderTransform,cairo);
HXDLIN( 454)					 ::Dynamic surface = bitmap->_hx___bitmapData->getSurface();
HXDLIN( 454)					if (::hx::IsNotNull( surface )) {
HXLINE( 454)						 ::Dynamic pattern = ::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::createForSurface(surface);
HXDLIN( 454)						int _hx_tmp;
HXDLIN( 454)						bool _hx_tmp1;
HXDLIN( 454)						if (renderer->_hx___allowSmoothing) {
HXLINE( 454)							_hx_tmp1 = bitmap->smoothing;
            						}
            						else {
HXLINE( 454)							_hx_tmp1 = false;
            						}
...
HXLINE( 454)							_hx_tmp = 3;
            						}
HXDLIN( 454)						::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_filter(pattern,_hx_tmp);
HXDLIN( 454)						cairo->set_source(pattern);
HXDLIN( 454)						if ((alpha == 1)) {
HXLINE( 454)							cairo->paint();
            						}
            						else {
HXLINE( 454)							cairo->paintWithAlpha(alpha);
            						}
            					}
HXDLIN( 454)					renderer->_hx___popMaskObject(bitmap,null());
HXDLIN( 454)					renderer->_hx___setBlendMode(10);
            				}
            			}
            		}
            		else {
HXLINE( 458)			::openfl::display::_internal::CairoTextField_obj::render(textField,renderer,textField->_hx___worldTransform);
HXLINE( 459)			::openfl::display::_internal::CairoDisplayObject_obj::render(textField,renderer);
            		}
HXLINE( 462)		renderer->_hx___renderEvent(textField);
            	}
...
void CairoTextField_obj::renderDrawableMask( ::openfl::text::TextField textField, ::openfl::display::CairoRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_a654946cfcca811d_468_renderDrawableMask)
HXDLIN( 468)		if (::hx::IsNotNull( textField->_hx___graphics )) {
HXDLIN( 468)			::openfl::display::_internal::CairoGraphics_obj::renderMask(textField->_hx___graphics,renderer);
            		}
            	}
