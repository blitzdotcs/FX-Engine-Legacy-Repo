...
HXLINE(  97)				{
HXLINE(  97)					int _g = 0;
HXDLIN(  97)					while((_g < files->length)){
HXLINE(  97)						::String file = files->__get(_g);
HXDLIN(  97)						_g = (_g + 1);
HXLINE(  99)						if ((file.toLowerCase().indexOf(HX_(".ttf",78,3b,c0,1e),null()) != -1)) {
HXLINE(  99)							_allFonts->push(::openfl::text::Font_obj::fromFile((alternateFontsDirectory + file)));
            						}
            					}
            				}
            			}
