...
HX_LOCAL_STACK_FRAME(_hx_pos_495f89d9d0902be3_81_openURL,"MusicBeatState","openURL",0x8e8884cd,"MusicBeatState.openURL","MusicBeatState.hx",81,0xa1b2f108)
...
void MusicBeatState_obj::openURL(::String url){
            	HX_GC_STACKFRAME(&_hx_pos_495f89d9d0902be3_81_openURL)
HXDLIN(  81)		::String prefix = HX_("",00,00,00,00);
HXDLIN(  81)		if (!( ::EReg_obj::__alloc( HX_CTX ,HX_("^https?://",48,ee,dd,38),HX_("",00,00,00,00))->match(url))) {
HXDLIN(  81)			prefix = HX_("http://",52,75,cd,5a);
            		}
HXDLIN(  81)		::openfl::Lib_obj::getURL( ::openfl::net::URLRequest_obj::__alloc( HX_CTX ,(prefix + url)),HX_("_blank",95,26,d9,b0));
            	}


HX_DEFINE_DYNAMIC_FUNC1(MusicBeatState_obj,openURL,(void))
...
::hx::Val MusicBeatState_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		if (HX_FIELD_EQ(inName,"openURL") ) { return ::hx::Val( openURL_dyn() ); }
		break;
	case 8:
