...
HX_DEFINE_STACK_FRAME(_hx_pos_7b9d652bf7289928_26_new,"LoadingState","new",0x2bad3187,"LoadingState.new","LoadingState.hx",26,0x53ff9bc9)
...
HX_LOCAL_STACK_FRAME(_hx_pos_7b9d652bf7289928_67_create,"LoadingState","create",0x65cff835,"LoadingState.create","LoadingState.hx",67,0x53ff9bc9)
...
HX_LOCAL_STACK_FRAME(_hx_pos_7b9d652bf7289928_28_boot,"LoadingState","boot",0x03f7252b,"LoadingState.boot","LoadingState.hx",28,0x53ff9bc9)

void LoadingState_obj::__construct( ::flixel::FlxState target,bool stopMusic){
            	HX_STACKFRAME(&_hx_pos_7b9d652bf7289928_26_new)
HXLINE(  36)		this->danceLeft = false;
HXLINE(  31)		this->stopMusic = false;
HXLINE(  40)		super::__construct(null(),null());
HXLINE(  41)		this->target = target;
HXLINE(  42)		this->stopMusic = stopMusic;
            	}
...
HXLINE(  81)				introComplete();
            			...
            			HX_GC_STACKFRAME(&_hx_pos_7b9d652bf7289928_67_create)
HXLINE(  68)			_gthis->callbacks =  ::MultiCallback_obj::__alloc( HX_CTX ,_gthis->onLoad_dyn(),null());
HXLINE(  69)			 ::Dynamic introComplete = _gthis->callbacks->add(HX_("introComplete",45,d3,4c,b2));
HXLINE(  70)			 ::LoadingState _gthis1 = _gthis;
HXDLIN(  70)			_gthis1->checkLoadSong(::LoadingState_obj::getSongPath());
HXLINE(  71)			if (( (bool)(::PlayState_obj::SONG->__Field(HX_("needsVoices",be,05,e9,0d),::hx::paccDynamic)) )) {
HXLINE(  72)				 ::LoadingState _gthis2 = _gthis;
HXDLIN(  72)				_gthis2->checkLoadSong(::LoadingState_obj::getVocalPath());
            			}
HXLINE(  73)			_gthis->checkLibrary(HX_("shared",a5,5e,2b,1d));
HXLINE(  74)			if ((::PlayState_obj::storyWeek > 0)) {
HXLINE(  75)				_gthis->checkLibrary((HX_("week",f4,5f,f5,4e) + ::PlayState_obj::storyWeek));
            			}
            			else {
...
HXLINE(  47)		this->logo =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-150,-100,null());
HXLINE(  48)		 ::flixel::FlxSprite _hx_tmp = this->logo;
HXDLIN(  48)		::String library = null();
HXDLIN(  48)		::String _hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("logoBumpin",26,cb,02,ab)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN(  48)		_hx_tmp->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp1,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("logoBumpin",26,cb,02,ab)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE(  49)		this->logo->set_antialiasing(true);
HXLINE(  50)		this->logo->animation->addByPrefix(HX_("bump",f6,0f,20,41),HX_("logo bumpin",70,a1,0b,72),24,null(),null(),null());
HXLINE(  51)		this->logo->animation->play(HX_("bump",f6,0f,20,41),null(),null(),null());
HXLINE(  52)		this->logo->updateHitbox();
HXLINE(  56)		this->gfDance =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,(( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.4)),(( (Float)(::flixel::FlxG_obj::height) ) * ((Float)0.07)),null());
HXLINE(  57)		 ::flixel::FlxSprite _hx_tmp2 = this->gfDance;
HXDLIN(  57)		::String library1 = null();
HXDLIN(  57)		::String _hx_tmp3 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("gfDanceTitle",64,64,d2,7b)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1);
HXDLIN(  57)		_hx_tmp2->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp3,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("gfDanceTitle",64,64,d2,7b)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library1)));
HXLINE(  58)		this->gfDance->animation->addByIndices(HX_("danceLeft",da,cc,f9,df),HX_("gfDance",94,88,3a,eb),::Array_obj< int >::fromData( _hx_array_data_41ae6215_4,16),HX_("",00,00,00,00),24,false,null(),null());
HXLINE(  59)		this->gfDance->animation->addByIndices(HX_("danceRight",a9,7f,a6,91),HX_("gfDance",94,88,3a,eb),::Array_obj< int >::fromData( _hx_array_data_41ae6215_5,15),HX_("",00,00,00,00),24,false,null(),null());
HXLINE(  60)		this->gfDance->set_antialiasing(true);
HXLINE(  61)		this->add(this->gfDance);
HXLINE(  62)		this->add(this->logo);
HXLINE(  64)		::LoadingState_obj::initSongsManifest()->onComplete( ::Dynamic(new _hx_Closure_1(_gthis)));
            	}
...
HXLINE( 108)				HX_STACK_DO_THROW((HX_("Missing library: ",07,45,01,4f) + library));
            			}
...
{
{
            	HX_STACKFRAME(&_hx_pos_7b9d652bf7289928_28_boot)
HXDLIN(  28)		MIN_TIME = ((Float)1.0);
            	}
}
