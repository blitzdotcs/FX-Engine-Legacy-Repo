...
HXLINE( 131)				HX_STACK_DO_THROW(HX_("Unexpected null gamepad. id:0",5a,05,91,b2));
            			}
...
HXLINE( 144)			 ::flixel::input::gamepad::FlxGamepad gamepad1 = ::flixel::FlxG_obj::gamepads->_activeGamepads->__get(1).StaticCast<  ::flixel::input::gamepad::FlxGamepad >();
HXLINE( 145)			if (::hx::IsNull( gamepad1 )) {
HXLINE( 146)				HX_STACK_DO_THROW(HX_("Unexpected null gamepad. id:0",5a,05,91,b2));
            			}
