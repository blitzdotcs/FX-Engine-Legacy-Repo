...
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_95_onCrash,"Main","onCrash",0x46bec533,"Main.onCrash","Main.hx",95,0x087e5c05)
...
HXLINE(  87)		::openfl::Lib_obj::get_current()->get_loaderInfo()->uncaughtErrorEvents->addEventListener(HX_("uncaughtError",f3,98,8b,8b),this->onCrash_dyn(),null(),null(),null());
            	}
...
void Main_obj::onCrash( ::openfl::events::UncaughtErrorEvent e){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_95_onCrash)
HXLINE(  96)		::String errMsg = HX_("",00,00,00,00);
HXLINE(  98)		::Array< ::Dynamic> callStack = ::haxe::_CallStack::CallStack_Impl__obj::exceptionStack(true);
HXLINE(  99)		::String dateNow = ::Date_obj::now()->toString();
HXLINE( 101)		dateNow = ::StringTools_obj::replace(dateNow,HX_(" ",20,00,00,00),HX_("_",5f,00,00,00));
HXLINE( 102)		dateNow = ::StringTools_obj::replace(dateNow,HX_(":",3a,00,00,00),HX_("'",27,00,00,00));
HXLINE(  97)		::String path = (((HX_("./crash/",69,79,f9,62) + HX_("FX-Engine_",02,99,c2,e9)) + dateNow) + HX_(".txt",02,3f,c0,1e));
HXLINE( 106)		{
HXLINE( 106)			int _g = 0;
HXDLIN( 106)			while((_g < callStack->length)){
HXLINE( 106)				 ::haxe::StackItem stackItem = callStack->__get(_g).StaticCast<  ::haxe::StackItem >();
HXDLIN( 106)				_g = (_g + 1);
HXLINE( 108)				if ((stackItem->_hx_getIndex() == 2)) {
HXLINE( 110)					 ::haxe::StackItem s = stackItem->_hx_getObject(0).StaticCast<  ::haxe::StackItem >();
HXDLIN( 110)					::String file = stackItem->_hx_getString(1);
HXDLIN( 110)					int line = stackItem->_hx_getInt(2);
HXDLIN( 110)					 ::Dynamic column = stackItem->_hx_getObject(3);
HXLINE( 111)					errMsg = (errMsg + (((file + HX_(" (line ",a4,24,f7,a5)) + line) + HX_(")\n",c1,23,00,00)));
            				}
            				else {
HXLINE( 113)					::Sys_obj::println(stackItem);
            				}
            			}
            		}
HXLINE( 117)		errMsg = (errMsg + ((HX_("\nUncaught Error: ",ed,bf,e1,72) + ::Std_obj::string(e->error)) + HX_("\nPlease report this error to the GitHub page: https://github.com/TyDevX/FX-Engine\n\n> Crash Handler written by: sqirra-rng",b3,63,8e,33)));
HXLINE( 119)		if (!(::sys::FileSystem_obj::exists(HX_("./crash/",69,79,f9,62)))) {
HXLINE( 120)			::sys::FileSystem_obj::createDirectory(HX_("./crash/",69,79,f9,62));
            		}
HXLINE( 122)		::sys::io::File_obj::saveContent(path,(errMsg + HX_("\n",0a,00,00,00)));
HXLINE( 124)		::Sys_obj::println(errMsg);
HXLINE( 125)		::Sys_obj::println((HX_("Crash dump saved in ",cf,9c,69,5d) + ::haxe::io::Path_obj::normalize(path)));
HXLINE( 127)		::lime::app::Application_obj::current->_hx___window->alert(errMsg,HX_("Error!",79,f7,fc,85));
HXLINE( 128)		::DiscordClient_obj::shutdown();
HXLINE( 129)		::Sys_obj::exit(1);
            	}
