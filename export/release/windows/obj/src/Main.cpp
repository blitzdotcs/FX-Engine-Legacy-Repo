...
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_68_setupGame,"Main","setupGame",0x7f7688ba,"Main.setupGame","Main.hx",68,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_94_onCrash,"Main","onCrash",0x46bec533,"Main.onCrash","Main.hx",94,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_40_main,"Main","main",0xed0e206e,"Main.main","Main.hx",40,0x087e5c05)

void Main_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_26_new)
HXLINE(  34)		this->startFullscreen = false;
HXLINE(  33)		this->skipSplash = true;
HXLINE(  32)		this->framerate = 60;
HXLINE(  31)		this->zoom = ((Float)-1);
HXLINE(  30)		this->initialState = ::hx::ClassOf< ::TitleState >();
HXLINE(  29)		this->gameHeight = 720;
HXLINE(  28)		this->gameWidth = 1280;
...
void Main_obj::setupGame(){
            	HX_GC_STACKFRAME(&_hx_pos_e47a9afac0942eb9_68_setupGame)
...
HXLINE(  72)		if ((this->zoom == -1)) {
HXLINE(  74)			Float ratioX = (( (Float)(stageWidth) ) / ( (Float)(this->gameWidth) ));
HXLINE(  75)			Float ratioY = (( (Float)(stageHeight) ) / ( (Float)(this->gameHeight) ));
HXLINE(  76)			this->zoom = ::Math_obj::min(ratioX,ratioY);
HXLINE(  77)			this->gameWidth = ::Math_obj::ceil((( (Float)(stageWidth) ) / this->zoom));
HXLINE(  78)			this->gameHeight = ::Math_obj::ceil((( (Float)(stageHeight) ) / this->zoom));
            		}
HXLINE(  81)		this->initialState = ::hx::ClassOf< ::TitleState >();
HXLINE(  83)		this->addChild( ::flixel::FlxGame_obj::__alloc( HX_CTX ,this->gameWidth,this->gameHeight,this->initialState,this->zoom,this->framerate,this->framerate,this->skipSplash,this->startFullscreen));
HXLINE(  86)		::openfl::Lib_obj::get_current()->get_loaderInfo()->uncaughtErrorEvents->addEventListener(HX_("uncaughtError",f3,98,8b,8b),this->onCrash_dyn(),null(),null(),null());
            	}
...
void Main_obj::onCrash( ::openfl::events::UncaughtErrorEvent e){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_94_onCrash)
HXLINE(  95)		::String errMsg = HX_("",00,00,00,00);
HXLINE(  97)		::Array< ::Dynamic> callStack = ::haxe::_CallStack::CallStack_Impl__obj::exceptionStack(true);
HXLINE(  98)		::String dateNow = ::Date_obj::now()->toString();
HXLINE( 100)		dateNow = ::StringTools_obj::replace(dateNow,HX_(" ",20,00,00,00),HX_("_",5f,00,00,00));
HXLINE( 101)		dateNow = ::StringTools_obj::replace(dateNow,HX_(":",3a,00,00,00),HX_("'",27,00,00,00));
HXLINE(  96)		::String path = (((HX_("./crash/",69,79,f9,62) + HX_("FX-Engine_",02,99,c2,e9)) + dateNow) + HX_(".txt",02,3f,c0,1e));
HXLINE( 105)		{
HXLINE( 105)			int _g = 0;
HXDLIN( 105)			while((_g < callStack->length)){
HXLINE( 105)				 ::haxe::StackItem stackItem = callStack->__get(_g).StaticCast<  ::haxe::StackItem >();
HXDLIN( 105)				_g = (_g + 1);
HXLINE( 107)				if ((stackItem->_hx_getIndex() == 2)) {
HXLINE( 109)					 ::haxe::StackItem s = stackItem->_hx_getObject(0).StaticCast<  ::haxe::StackItem >();
HXDLIN( 109)					::String file = stackItem->_hx_getString(1);
HXDLIN( 109)					int line = stackItem->_hx_getInt(2);
HXDLIN( 109)					 ::Dynamic column = stackItem->_hx_getObject(3);
HXLINE( 110)					errMsg = (errMsg + (((file + HX_(" (line ",a4,24,f7,a5)) + line) + HX_(")\n",c1,23,00,00)));
            				}
            				else {
HXLINE( 112)					::Sys_obj::println(stackItem);
            				}
            			}
            		}
HXLINE( 116)		errMsg = (errMsg + ((HX_("\nUncaught Error: ",ed,bf,e1,72) + ::Std_obj::string(e->error)) + HX_("\nPlease report this error to the GitHub page: https://github.com/TyDevX/FX-Engine\n\n> Crash Handler written by: sqirra-rng",b3,63,8e,33)));
HXLINE( 118)		if (!(::sys::FileSystem_obj::exists(HX_("./crash/",69,79,f9,62)))) {
HXLINE( 119)			::sys::FileSystem_obj::createDirectory(HX_("./crash/",69,79,f9,62));
            		}
HXLINE( 121)		::sys::io::File_obj::saveContent(path,(errMsg + HX_("\n",0a,00,00,00)));
HXLINE( 123)		::Sys_obj::println(errMsg);
HXLINE( 124)		::Sys_obj::println((HX_("Crash dump saved in ",cf,9c,69,5d) + ::haxe::io::Path_obj::normalize(path)));
HXLINE( 126)		::lime::app::Application_obj::current->_hx___window->alert(errMsg,HX_("Error!",79,f7,fc,85));
HXLINE( 127)		::DiscordClient_obj::shutdown();
HXLINE( 128)		::Sys_obj::exit(1);
            	}
...
void Main_obj::main(){
            	HX_GC_STACKFRAME(&_hx_pos_e47a9afac0942eb9_40_main)
HXDLIN(  40)		 ::openfl::display::MovieClip _hx_tmp = ::openfl::Lib_obj::get_current();
HXDLIN(  40)		_hx_tmp->addChild( ::Main_obj::__alloc( HX_CTX ));
            	}
