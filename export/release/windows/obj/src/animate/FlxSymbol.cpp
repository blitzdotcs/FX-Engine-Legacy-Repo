...
HXLINE(  61)							int _g = 0;
HXDLIN(  61)							::Array< ::Dynamic> _g1 = ( (::Array< ::Dynamic>)(frame->__Field(HX_("E",45,00,00,00),::hx::paccDynamic)) );
HXDLIN(  61)							while((_g < _g1->length)){
HXLINE(  61)								 ::Dynamic element = _g1->__get(_g);
HXDLIN(  61)								_g = (_g + 1);
...
HXLINE( 103)									bool _hx_tmp = this->symbolAtlasShit->exists(( (::String)(nestedSymbol->__Field(HX_("SN",9b,48,00,00),::hx::paccDynamic)) ));
...
HXLINE( 154)						{
HXLINE( 154)							int _g = 0;
HXDLIN( 154)							::Array< ::Dynamic> _g1 = ( (::Array< ::Dynamic>)(layer->__Field(HX_("FR",4c,3d,00,00),::hx::paccDynamic)) );
HXDLIN( 154)							while((_g < _g1->length)){
HXLINE( 154)								 ::Dynamic frame = _g1->__get(_g);
HXDLIN( 154)								_g = (_g + 1);
HXLINE( 156)								{
HXLINE( 156)									int _g2 = 0;
HXDLIN( 156)									::Array< ::Dynamic> _g3 = ( (::Array< ::Dynamic>)(frame->__Field(HX_("E",45,00,00,00),::hx::paccDynamic)) );
HXDLIN( 156)									while((_g2 < _g3->length)){
HXLINE( 156)										 ::Dynamic element = _g3->__get(_g2);
...
HXLINE( 196)			 ::flixel::math::FlxPoint _this = this->_point;
HXDLIN( 196)			_this->set_x(( (Float)(::Math_obj::floor(_this->x)) ));
HXDLIN( 196)			_this->set_y(( (Float)(::Math_obj::floor(_this->y)) ));
            		}
