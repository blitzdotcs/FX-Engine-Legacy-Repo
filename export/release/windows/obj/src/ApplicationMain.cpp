...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("FX Engine",f0,84,21,bb),::ApplicationMain_obj::create_dyn());
...
HXLINE(  38)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("754",56,ea,29,00));
...
HXLINE(  42)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.tydev.fxengine",df,6a,83,fc));
HXLINE(  43)		app->meta->set(HX_("version",18,e7,f1,7c),HX_("0.2.7.1",40,93,0b,19));
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("FX Engine",f0,84,21,bb))
