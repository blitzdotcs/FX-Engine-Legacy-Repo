...
HXLINE( 164)					 ::flixel::FlxState nextState1 =  ::FreeplayState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 164)					if (::flixel::FlxG_obj::game->_state->switchTo(nextState1)) {
HXLINE( 164)						::flixel::FlxG_obj::game->_requestedState = nextState1;
            					}
            				}
...
HXLINE( 145)				{
HXLINE( 145)					 ::flixel::FlxState nextState2 = ( ( ::flixel::FlxState)(::Type_obj::createInstance(::Type_obj::getClass(::flixel::FlxG_obj::game->_state),::cpp::VirtualArray_obj::__new(0))) );
HXDLIN( 145)					if (::flixel::FlxG_obj::game->_state->switchTo(nextState2)) {
HXLINE( 145)						::flixel::FlxG_obj::game->_requestedState = nextState2;
            					}
            				}
HXLINE( 139)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("Restart Song",06,b6,fe,13)) ){
HXLINE( 158)				 ::flixel::FlxState nextState3 = ( ( ::flixel::FlxState)(::Type_obj::createInstance(::Type_obj::getClass(::flixel::FlxG_obj::game->_state),::cpp::VirtualArray_obj::__new(0))) );
HXDLIN( 158)				if (::flixel::FlxG_obj::game->_state->switchTo(nextState3)) {
HXLINE( 158)					::flixel::FlxG_obj::game->_requestedState = nextState3;
            				}
...
HXDLIN( 168)		bool _hx_tmp2 = _this->keyManager->checkStatusUnsafe(74,_this->status);
            	}
