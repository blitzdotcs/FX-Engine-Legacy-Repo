...
HXDLIN(  65)		 ::flixel::FlxSprite bg1 = bg->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("menuBG",24,65,6d,05)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library),null(),null(),null(),null(),null());
...
HXDLIN(  77)		this->magenta = _hx_tmp2->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("menuDesat",26,91,04,72)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1),null(),null(),null(),null(),null());
...
HXLINE( 102)				{
HXLINE( 102)					 ::flixel::util::FlxAxes axes = ::flixel::util::FlxAxes_obj::X_dyn();
HXDLIN( 102)					if (::hx::IsNull( axes )) {
HXLINE( 102)						axes = ::flixel::util::FlxAxes_obj::XY_dyn();
            					}
HXDLIN( 102)					bool _hx_tmp;
HXDLIN( 102)					switch((int)(axes->_hx_getIndex())){
            						case (int)0: case (int)2: {
...
HXDLIN( 102)						menuItem->set_x(((( (Float)(_hx_tmp) ) - menuItem->get_width()) / ( (Float)(2) )));
            					}
...
HXDLIN( 102)						menuItem->set_y(((( (Float)(_hx_tmp) ) - menuItem->get_height()) / ( (Float)(2) )));
            					}
            				}
...
HXDLIN( 229)				spr->set_x(((( (Float)(_hx_tmp) ) - spr->get_width()) / ( (Float)(2) )));
            			}
...
HXDLIN( 229)				spr->set_y(((( (Float)(_hx_tmp) ) - spr->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXLINE( 207)									 ::flixel::FlxState nextState =  ::OptionsMenu_obj::__alloc( HX_CTX ,null(),null());
...
HXDLIN( 171)					_hx_tmp->play(::Paths_obj::sound(HX_("confirmMenu",bf,8e,fe,3c),null()),null(),null(),null(),null(),null());
...
HXLINE( 218)			{
HXLINE( 218)				 ::flixel::FlxState nextState =  ::extrashit::Menu_obj::__alloc( HX_CTX ,null(),null());
